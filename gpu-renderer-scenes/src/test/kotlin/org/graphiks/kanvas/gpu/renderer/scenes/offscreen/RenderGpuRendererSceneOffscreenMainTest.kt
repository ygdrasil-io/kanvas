...
class RenderGpuRendererSceneOffscreenMainTest {
    ...
    fun `rect only command preparation rejects filter command families outside the faithful subset`() {
        ...
        assertContains(failure.message ?: "", "supports only clear, fill-rect, fill-rrect, stroke, linear-gradient-rect, radial-gradient-rect, sweep-gradient-rect, clip, path-fill-stencil, path-fill-gradient, convex-fan-mesh, bitmap-rect, save-layer, runtime-effect, custom-runtime-effect, mesh-ribbon, and text-run command families")
    ...
    private fun assertNotYetRenderedScene(root: Path, sceneId: String, unsupportedFamilies: List<String>) {
        ...
        assertContains(runJson, "supports only clear, fill-rect, fill-rrect, stroke, linear-gradient-rect, radial-gradient-rect, sweep-gradient-rect, clip, path-fill-stencil, path-fill-gradient, convex-fan-mesh, bitmap-rect, save-layer, runtime-effect, custom-runtime-effect, mesh-ribbon, and text-run command families")
        assertContains(diagnostics, "supports only clear, fill-rect, fill-rrect, stroke, linear-gradient-rect, radial-gradient-rect, sweep-gradient-rect, clip, path-fill-stencil, path-fill-gradient, convex-fan-mesh, bitmap-rect, save-layer, runtime-effect, custom-runtime-effect, mesh-ribbon, and text-run command families")
