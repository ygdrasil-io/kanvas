...
class ResourceSnapshotTest {
    ...
    fun `every color mask path image and blender effect variant retains semantic fields`() {
        ...
        val filters: List<EffectNode> = listOf(
            ...
            ImageFilterNode.Picture.of(SceneSnapshot.of(SceneExtent(1, 1), ColorSpace.SRGB, emptyList())),
    ...
    @Test
    fun `effect path identity retains raw float semantics and picture graphs consume the same budget`() {
