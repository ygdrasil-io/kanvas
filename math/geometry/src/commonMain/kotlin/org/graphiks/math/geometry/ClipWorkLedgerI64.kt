...
internal class ClipWorkLedgerI64(
    ...
    /** Charges all entries before reading any entry snapshot or mapping any geometry. */
    fun debitEntryCountBeforePreparationI64(entryCountI64: Long) {
        if (entryCountI64 < 0L) throw ClipPreparationAbort(ClipPreparationResourceLimitReason.HostSizeOverflow)
        ...
        requireStackI64(nextStackI64)
        requireFrameI64(nextFrameI64)
        stackUsageI64 = nextStackI64
    ...
    private fun requireStackI64(usageI64: ClipWorkUsageI64) {
        if (usageI64.clipEntryCountI64 > policyF64.limitsI32.maxClipEntryCountPerStackI32.toLong()) {
            throw ClipPreparationAbort(ClipPreparationResourceLimitReason.StackEntryCountLimit)
        }
        requireUsageI64(usageI64, policyF64.limitsI32.maxAttemptedEdgesPerStackI32, policyF64.limitsI32.maxEmittedVertexCountPerStackI32, policyF64.limitsI32.maxEmittedIndexCountPerStackI32, policyF64.limitsI64.maxSnapshotByteCountPerStackI64, ClipPreparationResourceLimitReason.StackAttemptedEdgeLimit, ClipPreparationResourceLimitReason.StackVertexLimit, ClipPreparationResourceLimitReason.StackIndexLimit, ClipPreparationResourceLimitReason.StackSnapshotByteLimit)
    }
    private fun requireFrameI64(usageI64: ClipWorkUsageI64) {
        if (usageI64.clipEntryCountI64 > policyF64.limitsI32.maxClipEntryCountPerFrameI32.toLong()) {
            throw ClipPreparationAbort(ClipPreparationResourceLimitReason.FrameEntryCountLimit)
        }
        requireUsageI64(usageI64, policyF64.limitsI32.maxAttemptedEdgesPerFrameI32, policyF64.limitsI32.maxEmittedVertexCountPerFrameI32, policyF64.limitsI32.maxEmittedIndexCountPerFrameI32, policyF64.limitsI64.maxSnapshotByteCountPerFrameI64, ClipPreparationResourceLimitReason.FrameAttemptedEdgeLimit, ClipPreparationResourceLimitReason.FrameVertexLimit, ClipPreparationResourceLimitReason.FrameIndexLimit, ClipPreparationResourceLimitReason.FrameSnapshotByteLimit)
    }
}
...
private fun addClipUsageI64(firstI64: ClipWorkUsageI64, secondI64: ClipWorkUsageI64): ClipWorkUsageI64 = try {
    ClipWorkUsageI64(
        checkedClipAddI64(firstI64.attemptedEdgeCountI64, secondI64.attemptedEdgeCountI64),
        checkedClipAddI64(firstI64.emittedVertexCountI64, secondI64.emittedVertexCountI64),
        checkedClipAddI64(firstI64.emittedIndexCountI64, secondI64.emittedIndexCountI64),
        checkedClipAddI64(firstI64.snapshotByteCountI64, secondI64.snapshotByteCountI64),
        checkedClipAddI64(firstI64.clipEntryCountI64, secondI64.clipEntryCountI64),
    )
