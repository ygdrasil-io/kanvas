...
) { init { listOf(maxAttemptedEdgesPerEntryI32, maxAttemptedEdgesPerStackI32, maxAttemptedEdgesPerFrameI32, maxEmittedVertexCountPerEntryI32, maxEmittedVertexCountPerStackI32, maxEmittedVertexCountPerFrameI32, maxEmittedIndexCountPerEntryI32, maxEmittedIndexCountPerStackI32, maxEmittedIndexCountPerFrameI32).forEach { require(it > 0) } } }
