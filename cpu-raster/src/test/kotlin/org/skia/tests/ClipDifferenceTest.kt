...
class ClipDifferenceTest {
    ...
    @Test
    fun `BlurredClippedCircleGM matches reference`() =
        runGm(BlurredClippedCircleGM(), "BlurredClippedCircleGM", 80.0)

    @Test
    fun `Skbug9319GM matches reference`() = runGm(Skbug9319GM(), "Skbug9319GM", 80.0)
}
