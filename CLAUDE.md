...
The old root-level migration plans were archived on 2026-05-24 because
their phase tracking no longer matches the implementation reliably.
Use [UPSTREAM_SYNC_STATUS.md](UPSTREAM_SYNC_STATUS.md) as the current
source of truth for upstream rapprochement work.
