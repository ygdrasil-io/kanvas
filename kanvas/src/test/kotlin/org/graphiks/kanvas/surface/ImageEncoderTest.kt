...
class ImageEncoderTest {
    ...
    @Test fun `toPng throws without encoder`() {
        val r = RenderResult(UByteArray(16){128u}, 2, 2, PixelFormat.RGBA8, org.graphiks.kanvas.color.ColorSpace.SRGB, Diagnostics(), RenderStats(0,0,0,0,0f))
    ...
    fun `BGRA result preserves bytes and layout through image and all encoders`() {
        ...
        val result = RenderResult(
            ...
            1,
            PixelFormat.BGRA8,
            org.graphiks.kanvas.color.ColorSpace.SRGB,
            Diagnostics(),
