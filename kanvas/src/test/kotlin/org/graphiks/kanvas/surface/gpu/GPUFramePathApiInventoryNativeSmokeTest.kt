...
class GPUFramePathApiInventoryNativeSmokeTest {
    ...
    fun `single diagonal butt miter stroke under integral device scissor matches CPU oracle natively`() {
        ...
        assertEquals(GPUClipStencilOperation.Invert, clipExecution.producer.frontPassOperation)
        assertEquals(GPUClipStencilOperation.Invert, clipExecution.producer.backPassOperation)
