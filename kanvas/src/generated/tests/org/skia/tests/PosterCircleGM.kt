 ...
 * ```
 */
public open class PosterCircleGM public constructor() : GM() {
  /**
   * C++ original:
   * ```cpp
   * static const int kAngleStep = 30
   * ```
   */
  private var fPosterImages: Array<SkSp<SkImage>> = TODO("Initialize fPosterImages")

  /**
   * C++ original:
   * ```cpp
   * static const int kNumAngles = 12
   * ```
   */
  ...
  public companion object {
    private val kAngleStep: Int = TODO("Initialize kAngleStep")

    private val kNumAngles: Int = TODO("Initialize kNumAngles")

    private val kStageWidth: Int = TODO("Initialize kStageWidth")

    private val kStageHeight: Int = TODO("Initialize kStageHeight")

    private val kRingRadius: Int = TODO("Initialize kRingRadius")

    private val kPosterSize: Int = TODO("Initialize kPosterSize")
  }
}
