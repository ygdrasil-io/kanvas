 ...
 * ```
 */
public open class ImageFromYUV public constructor(
  source: Source,
) : GM() {
  /**
   * C++ original:
   ...
   * ```
   */
  private var fSource: Source = TODO("Initialize fSource")
   ...
   * ```
   */
  private var fLazyYUVImage: Int = TODO("Initialize fLazyYUVImage")
   ...
   * ```
   */
  private var fYUVAImages: Array<SkSp<SkImage>> = TODO("Initialize fYUVAImages")
   ...
   * ```
   */
  private var fReferenceImage: SkSp<SkImage> = TODO("Initialize fReferenceImage")
   ...
   * ```
   */
  protected fun makeYUVAImage(context: GrDirectContext?, recorder: Recorder?): SkSp<SkImage> {
    TODO("Implement makeYUVAImage")
  }
   ...
   * ```
   */
  protected fun createReferenceImage(dContext: GrDirectContext?, recorder: Recorder?): SkSp<SkImage> {
    TODO("Implement createReferenceImage")
  }
   ...
   * ```
   */
  protected fun getYUVAImage(index: Int): SkImage {
    TODO("Implement getYUVAImage")
  }
  ...
  public companion object {
    ...
    private val kPad: SkScalar = TODO("Initialize kPad")
     ...
     * ```
     */
    protected fun createPlanes(name: String?): Int {
      TODO("Implement createPlanes")
    }
  }
}
