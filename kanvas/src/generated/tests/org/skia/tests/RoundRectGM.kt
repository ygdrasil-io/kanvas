 ...
 * ```
 */
public open class RoundRectGM public constructor() : GM() {
  /**
   * C++ original:
   * ```cpp
   * TArray<SkPaint> fPaints
   ...
   * ```
   */
  protected fun makePaints() {
    TODO("Implement makePaints")
  }
   ...
   * ```
   */
  protected fun makeMatrices() {
    TODO("Implement makeMatrices")
  }
