 ...
 * ```
 */
public open class ImageLightingGM public constructor() : GM() {
  /**
   * C++ original:
   * ```cpp
   * inline static constexpr int kStartAzimuth = 225
   ...
   * ```
   */
  private var fAzimuth: SkScalar = TODO("Initialize fAzimuth")
  ...
  public companion object {
    private val kStartAzimuth: Int = TODO("Initialize kStartAzimuth")
  }
}
