 ...
 * ```
 */
public data class SkFontMetrics public constructor(
  /**
   * C++ original:
   * ```cpp
   * uint32_t fFlags
   ...
   * ```
   */
  public var fUnderlineThickness: Int,
  /**
   * C++ original:
   * ```cpp
   ...
   * ```
   */
  public var fUnderlinePosition: Int,
  /**
   * C++ original:
   * ```cpp
   ...
   * ```
   */
  public var fStrikeoutThickness: Int,
  /**
   * C++ original:
   * ```cpp
   ...
   * ```
   */
  public var fStrikeoutPosition: Int,
) {
  /**
   * C++ original:
   * ```cpp
   ...
   * ```
   */
  public fun hasUnderlineThickness(thickness: SkScalar?): Boolean {
    TODO("Implement hasUnderlineThickness")
  }
   ...
   * ```
   */
  public fun hasUnderlinePosition(position: SkScalar?): Boolean {
    TODO("Implement hasUnderlinePosition")
  }
   ...
   * ```
   */
  public fun hasStrikeoutThickness(thickness: SkScalar?): Boolean {
    TODO("Implement hasStrikeoutThickness")
  }
   ...
   * ```
   */
  public fun hasStrikeoutPosition(position: SkScalar?): Boolean {
    TODO("Implement hasStrikeoutPosition")
  }
  ...
  public enum class FontMetricsFlags {
