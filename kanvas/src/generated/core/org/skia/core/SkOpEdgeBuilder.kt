 ...
 * ```
 */
public data class SkOpEdgeBuilder public constructor(
  /**
   * C++ original:
   * ```cpp
   * SkOpGlobalState* fGlobalState
   ...
   * ```
   */
  private var fPathPts: SkTDArray<SkPoint>,
  /**
   * C++ original:
   * ```cpp
   * SkTDArray<SkScalar> fWeights
   * ```
   */
  private var fWeights: SkTDArray<SkScalar>,
  /**
   * C++ original:
   * ```cpp
   * SkTDArray<uint8_t> fPathVerbs
   ...
   * ```
   */
  private var fContourBuilder: SkOpContourBuilder,
  /**
   * C++ original:
   * ```cpp
   * SkOpContourHead* fContoursHead
   * ```
   */
  private var fContoursHead: SkOpContourHead?,
  /**
   * C++ original:
   * ```cpp
   * SkPathOpsMask fXorMask[2]
   * ```
   */
  private var fXorMask: Array<SkPathOpsMask>,
  /**
   * C++ original:
   * ```cpp
   * int fSecondHalf
   ...
   * ```
   */
  private var fAllowOpenContours: Boolean,
  /**
   * C++ original:
   * ```cpp
   * bool fUnparseable
   * ```
   */
  private var fUnparseable: Boolean,
) {
  /**
   * C++ original:
   * ```cpp
   ...
   * ```
   */
  public fun addOperand(path: SkPath) {
    TODO("Implement addOperand")
  }
   ...
   * ```
   */
  public fun unparseable(): Boolean {
    TODO("Implement unparseable")
  }
   ...
   * ```
   */
  public fun xorMask(): SkPathOpsMask {
    TODO("Implement xorMask")
  }
