...
public typealias U32 = Vec4<UInt>

public typealias U8 = Vec4<UByte>

public typealias SkGlyphRectStorage = Vec4<SkScalar>
 ...
 * ```
 */
public data class Vec4<T> public constructor(
  /**
   * C++ original:
   * ```cpp
   * Vec<N/2,T> lo
...
public typealias Float4 = Vec4<Float>

public typealias Double4 = Vec4<Double>

public typealias Byte4 = Vec4<UByte>

public typealias Int4 = Vec4<Int>

public typealias Ushort4 = Vec4<UShort>

public typealias Uint4 = Vec4<UInt>

public typealias Long4 = Vec4<Long>

public typealias Half4 = Vec4<UShort>
