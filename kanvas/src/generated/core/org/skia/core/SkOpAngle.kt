 ...
 * ```
 */
public data class SkOpAngle public constructor(
  /**
   * C++ original:
   * ```cpp
   ...
   * ```
   */
  private var fOriginalCurvePart: SkDCurve,
  /**
   * C++ original:
   * ```cpp
   * SkDCurveSweep fPart
   * ```
   */
  private var fPart: SkDCurveSweep,
  /**
   * C++ original:
   * ```cpp
   * double fSide
   ...
   * ```
   */
  private var fTangentHalf: SkLineParameters,
  /**
   * C++ original:
   * ```cpp
   * SkOpAngle* fNext
   ...
   * ```
   */
  private var fLastMarked: SkOpSpanBase?,
  /**
   * C++ original:
   * ```cpp
   * SkOpSpanBase* fStart
   * ```
   */
  private var fStart: SkOpSpanBase?,
  /**
   * C++ original:
   * ```cpp
   * SkOpSpanBase* fEnd
   ...
   * ```
   */
  private var fComputedEnd: SkOpSpanBase?,
  /**
   * C++ original:
   * ```cpp
   * int fSectorMask
   ...
   * ```
   */
  private var fUnorderable: Boolean,
  /**
   * C++ original:
   * ```cpp
   * bool fComputeSector
   * ```
   */
  private var fComputeSector: Boolean,
  /**
   * C++ original:
   * ```cpp
   * bool fComputedSector
   * ```
   */
  private var fComputedSector: Boolean,
  /**
   * C++ original:
   * ```cpp
   * bool fCheckCoincidence
   * ```
   */
  private var fCheckCoincidence: Boolean,
  /**
   * C++ original:
   * ```cpp
   * bool fTangentsAmbiguous
   * ```
   */
  private var fTangentsAmbiguous: Boolean,
) {
  /**
   * C++ original:
   * ```cpp
   ...
   * ```
   */
  public fun debugSign(): Int {
    TODO("Implement debugSign")
  }
   ...
   * ```
   */
  public fun debugValidateNext() {
    TODO("Implement debugValidateNext")
  }
   ...
   * ```
   */
  public fun distEndRatio(dist: Double): Double {
    TODO("Implement distEndRatio")
  }
   ...
   * ```
   */
  public fun dumpOne(functionHeader: Boolean) {
    TODO("Implement dumpOne")
  }
   ...
   * ```
   */
  public fun dumpTo(fromSeg: SkOpSegment?, to: SkOpAngle?) {
    TODO("Implement dumpTo")
  }
   ...
   * ```
   */
  public fun insert(angle: SkOpAngle?): Boolean {
   ...
   * ```
   */
  public fun lastMarked(): SkOpSpanBase {
    TODO("Implement lastMarked")
  }
   ...
   * ```
   */
  public fun loopContains(angle: SkOpAngle?): Boolean {
    TODO("Implement loopContains")
  }
   ...
   * ```
   */
  public fun loopCount(): Int {
    TODO("Implement loopCount")
  }
   ...
   * ```
   */
  public fun `set`(start: SkOpSpanBase?, end: SkOpSpanBase?) {
    TODO("Implement set")
  }
   ...
   * ```
   */
  public fun setLastMarked(marked: SkOpSpanBase?) {
    TODO("Implement setLastMarked")
  }
   ...
   * ```
   */
  public fun tangentsAmbiguous(): Boolean {
    TODO("Implement tangentsAmbiguous")
  }
   ...
   * ```
   */
  public fun unorderable(): Boolean {
    TODO("Implement unorderable")
  }
   ...
   * ```
   */
  private fun after(test: SkOpAngle?): Boolean {
   ...
   * ```
   */
  private fun alignmentSameSide(test: SkOpAngle?, order: Int?) {
    TODO("Implement alignmentSameSide")
  }
   ...
   * ```
   */
  private fun checkCrossesZero(): Boolean {
    TODO("Implement checkCrossesZero")
  }
   ...
   * ```
   */
  private fun checkParallel(rh: SkOpAngle?): Boolean {
    TODO("Implement checkParallel")
  }
   ...
   * ```
   */
  private fun computeSector(): Boolean {
    TODO("Implement computeSector")
  }
   ...
   * ```
   */
  private fun convexHullOverlaps(rh: SkOpAngle?): Int {
   ...
   * ```
   */
  private fun endToSide(rh: SkOpAngle?, inside: Boolean?): Boolean {
    TODO("Implement endToSide")
  }
   ...
   * ```
   */
  private fun endsIntersect(rh: SkOpAngle?): Boolean {
   ...
   * ```
   */
  private fun findSector(
    verb: SkPathVerb,
    x: Double,
    y: Double,
  ): Int {
    TODO("Implement findSector")
  }
   ...
   * ```
   */
  private fun globalState(): SkOpGlobalState {
   ...
   * ```
   */
  private fun lineOnOneSide(
    origin: SkDPoint,
    line: SkDVector,
    test: SkOpAngle?,
    useOriginal: Boolean,
  ): Int {
    TODO("Implement lineOnOneSide")
  }
   ...
   * ```
   */
  private fun lineOnOneSide(test: SkOpAngle?, useOriginal: Boolean): Int {
    TODO("Implement lineOnOneSide")
  }
   ...
   * ```
   */
  private fun linesOnOriginalSide(test: SkOpAngle?): Int {
    TODO("Implement linesOnOriginalSide")
  }
   ...
   * ```
   */
  private fun merge(angle: SkOpAngle?): Boolean {
   ...
   * ```
   */
  private fun midToSide(rh: SkOpAngle?, inside: Boolean?): Boolean {
    TODO("Implement midToSide")
  }
   ...
   * ```
   */
  private fun oppositePlanes(rh: SkOpAngle?): Boolean {
    TODO("Implement oppositePlanes")
  }
   ...
   * ```
   */
  private fun orderable(rh: SkOpAngle?): Int {
   ...
   * ```
   */
  private fun setSector() {
    TODO("Implement setSector")
  }
   ...
   * ```
   */
  private fun tangentsDiverge(rh: SkOpAngle?, s0xt0: Double): Boolean {
    TODO("Implement tangentsDiverge")
  }
