...
import undefined.FindPredicate
 ...
 * ```
 */
public data class SkTMultiMap public constructor(
  /**
   * C++ original:
   * ```cpp
   * SkTDynamicHash<ValueList, Key> fHash
   * ```
   */
  private var fHash: SkTDynamicHash<undefined.ValueList, Key>,
  /**
   * C++ original:
   * ```cpp
   * int fCount
   ...
   * ```
   */
  public fun insert(key: Key, `value`: T?) {
   ...
   * ```
   */
  public fun remove(key: Key, `value`: T?) {
   ...
   * ```
   */
  public fun <FindPredicate> find(key: Key, f: FindPredicate): T {
    TODO("Implement find")
  }
   ...
   * ```
   */
  public fun <FindPredicate> findAndRemove(key: Key, f: FindPredicate): T {
    TODO("Implement findAndRemove")
  }
   ...
   * ```
   */
  public fun has(`value`: T?, key: Key): Boolean {
    TODO("Implement has")
  }
   ...
   * ```
   */
  public fun countForKey(key: Key): Int {
    TODO("Implement countForKey")
  }
  ...
  public data class ValueList<T> public constructor(
    public var fValue: T?,
    public var fNext: undefined.ValueList?,
    public var fCount: Int,
  ) {
    public companion object {
      public fun getKey(e: ValueList): Key {
