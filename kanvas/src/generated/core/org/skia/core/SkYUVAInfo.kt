 ...
 * ```
 */
public data class SkYUVAInfo public constructor(
  /**
   * C++ original:
   * ```cpp
   * static constexpr int kYUVAChannelCount = static_cast<int>(YUVAChannels::kLast + 1)
   ...
   * ```
   */
  private var fPlaneConfig: PlaneConfig,
  /**
   * C++ original:
   * ```cpp
   * SkISize fDimensions
   * ```
   */
  private var fSubsampling: Subsampling,
  /**
   * C++ original:
   * ```cpp
   * PlaneConfig fPlaneConfig = PlaneConfig::kUnknown
   * ```
   */
  private var fYUVColorSpace: Int,
  /**
   * C++ original:
   * ```cpp
   * Subsampling fSubsampling = Subsampling::kUnknown
   ...
   * ```
   */
  public fun assign(that: SkYUVAInfo) {
   ...
   * ```
   */
  public fun planeConfig(): PlaneConfig {
    TODO("Implement planeConfig")
  }
   ...
   * ```
   */
  public fun subsampling(): Subsampling {
  ...
  public fun planeSubsamplingFactors(planeIdx: Int): Pair<Int, Int> {
    TODO("Implement planeSubsamplingFactors")
  }
   ...
   * ```
   */
  public fun sitingX(): Siting {
    TODO("Implement sitingX")
  }
   ...
   * ```
   */
  public fun sitingY(): Siting {
    TODO("Implement sitingY")
  }
   ...
   * ```
   */
  public fun originMatrix(): Int {
    TODO("Implement originMatrix")
  }
   ...
   * ```
   */
  public fun inverseOriginMatrix(): Int {
    TODO("Implement inverseOriginMatrix")
  }
   ...
   * ```
   */
  public fun planeDimensions(planeDimensions: Array<SkISize>): Int {
    TODO("Implement planeDimensions")
  }
   ...
   * ```
   */
  public fun numChannelsInPlane(i: Int): Int {
    TODO("Implement numChannelsInPlane")
  }
   ...
   * ```
   */
  public fun toYUVALocations(channelFlags: UInt?): SkYUVAInfoYUVALocations {
   ...
   * ```
   */
  public fun makeSubsampling(subsampling: Subsampling): SkYUVAInfo {
    TODO("Implement makeSubsampling")
  }
   ...
   * ```
   */
  public fun makeDimensions(dimensions: SkISize): SkYUVAInfo {
  ...
  public enum class YUVAChannels {
    kY,
    kU,
    kV,
    kA,
  ...
  public enum class Siting {
    kCentered,
  }

  public companion object {
    public val kYUVAChannelCount: Int = TODO("Initialize kYUVAChannelCount")

    public val kMaxPlanes: Int = TODO("Initialize kMaxPlanes")
     ...
     * ```
     */
    public fun subsamplingFactors(subsampling: Subsampling): Pair<Int, Int> {
      TODO("Implement subsamplingFactors")
    }
     ...
     * ```
     */
    public fun numPlanes(planeConfig: PlaneConfig): Int {
      TODO("Implement numPlanes")
    }
     ...
     * ```
     */
    public fun numChannelsInPlane(config: PlaneConfig, i: Int): Int {
      TODO("Implement numChannelsInPlane")
    }
     ...
     * ```
     */
    public fun getYUVALocations(config: PlaneConfig, planeChannelFlags: UInt?): SkYUVAInfoYUVALocations {
      TODO("Implement getYUVALocations")
    }
     ...
     * ```
     */
    public fun hasAlpha(planeConfig: PlaneConfig): Boolean {
      TODO("Implement hasAlpha")
    }
  }
}
