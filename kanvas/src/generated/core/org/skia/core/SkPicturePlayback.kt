 ...
 * ```
 */
public class SkPicturePlayback public constructor(
  `data`: SkPictureData?,
) : SkNoncopyable() {
  /**
   * C++ original:
   ...
   * ```
   */
  private val fPictureData: SkPictureData? = TODO("Initialize fPictureData")
   ...
   * ```
   */
  private var fCurOffset: ULong = TODO("Initialize fCurOffset")
  ...
  public fun draw(
    canvas: SkCanvas?,
    callback: SkPicture.AbortCallback?,
    buffer: SkReadBuffer?,
  ) {
    TODO("Implement draw")
  }
   ...
   * ```
   */
  public fun curOpID(): ULong {
    TODO("Implement curOpID")
  }
   ...
   * ```
   */
  public fun resetOpID() {
    TODO("Implement resetOpID")
  }
  ...
  public data class AutoResetOpID public constructor(
    private var fPlayback: SkPicturePlayback?,
  )
}
