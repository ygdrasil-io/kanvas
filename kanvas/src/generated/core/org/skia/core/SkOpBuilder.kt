 ...
 * ```
 */
public data class SkOpBuilder public constructor(
  /**
   * C++ original:
   * ```cpp
   * skia_private::TArray<SkPath> fPathRefs
   ...
   * ```
   */
  public fun add(path: Int, op: SkPathOp) {
    TODO("Implement add")
  }
   ...
   * ```
   */
  public fun resolve(result: SkPath?): Boolean {
    TODO("Implement resolve")
  }
  ...
  public companion object {
     ...
     * ```
     */
    private fun fixWinding(path: SkPath?): Boolean {
      TODO("Implement fixWinding")
    }
     ...
     * ```
     */
    private fun reversePath(path: SkPath?) {
