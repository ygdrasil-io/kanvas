...
public typealias Fp88 = Vec8<UShort>
 ...
 * ```
 */
public data class Vec8<T> public constructor(
  /**
   * C++ original:
   * ```cpp
   * Vec<N/2,T> lo
...
public typealias Float8 = Vec8<Float>

public typealias Double8 = Vec8<Double>

public typealias Byte8 = Vec8<UByte>

public typealias Int8 = Vec8<Int>

public typealias Ushort8 = Vec8<UShort>

public typealias Uint8 = Vec8<UInt>

public typealias Long8 = Vec8<Long>

public typealias Half8 = Vec8<UShort>
