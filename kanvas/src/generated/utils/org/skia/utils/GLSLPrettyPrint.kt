 ...
 * ```
 */
public data class GLSLPrettyPrint public constructor(
  /**
   * C++ original:
   * ```cpp
   * bool fFreshline
   * ```
   */
  private var fFreshline: Boolean,
  /**
   * C++ original:
   * ```cpp
   * int fTabs
   ...
   * ```
   */
  private var fInParseUntilNewline: Boolean,
  /**
   * C++ original:
   * ```cpp
   * bool fInParseUntil
   * ```
   */
  private var fInParseUntil: Boolean,
  /**
   * C++ original:
   * ```cpp
   * const char* fInParseUntilToken
   * ```
   */
  private val fInParseUntilToken: String?,
) {
  /**
   * C++ original:
   * ```cpp
   ...
   * ```
   */
  public fun prettify(string: String): Int {
   ...
   * ```
   */
  private fun hasToken(token: String?): Boolean {
   ...
   * ```
   */
  private fun parseUntilNewline() {
    TODO("Implement parseUntilNewline")
  }
   ...
   * ```
   */
  private fun parseUntil(token: String?) {
   ...
   * ```
   */
  private fun tabString() {
    TODO("Implement tabString")
  }
   ...
   * ```
   */
  private fun undoNewlineAfter(c: Char) {
    TODO("Implement undoNewlineAfter")
  }
}
