...
import MTLPixelFormat as MTLPixelFormat_
import undefined.MTLPixelFormat as UndefinedMTLPixelFormat
 ...
 * ```
 */
public class MtlCaps public constructor(
   ...
   * ```
   */
  private var fFormatTable: Int = TODO("Initialize fFormatTable")
   ...
   * C++ original:
   * ```cpp
   * MTLPixelFormat fColorTypeToFormatTable
   * ```
   */
  private var fSupportedSampleCounts: Int = TODO("Initialize fSupportedSampleCounts")
   ...
   * ```
   */
  private var fGPUFamily: GPUFamily = TODO("Initialize fGPUFamily")
   ...
   * ```
   */
  private var fFamilyGroup: Int = TODO("Initialize fFamilyGroup")
   ...
   * ```
   */
  public override fun isSampleCountSupported(format: TextureFormat, requestedSampleCount: SampleCount): Boolean {
   ...
   * ```
   */
  public override fun getDepthStencilFormat(mask: SkEnumBitMask<DepthStencilFlags>): Int {
   ...
   * ```
   */
  public override fun getTextureInfoForSampledCopy(textureInfo: TextureInfo, mipmapped: Mipmapped): Int {
   ...
   * ```
   */
  public override fun getDefaultStorageTextureInfo(colorType: SkColorType): Int {
   ...
   * ```
   */
  public override fun makeGraphicsPipelineKey(pipelineDesc: GraphicsPipelineDesc, renderPassDesc: RenderPassDesc): Int {
   ...
   * ```
   */
  public override fun makeComputePipelineKey(pipelineDesc: ComputePipelineDesc): Int {
   ...
   * ```
   */
  public fun getRenderPassDescKey(renderPassDesc: RenderPassDesc): Int {
    TODO("Implement getRenderPassDescKey")
  }
   ...
   * ```
   */
  public fun isMac(): Boolean {
    TODO("Implement isMac")
  }
   ...
   * ```
   */
  public fun isApple(): Boolean {
    TODO("Implement isApple")
  }
   ...
   * ```
   */
  public fun isIntel(): Boolean {
    TODO("Implement isIntel")
  }
   ...
   * ```
   */
  public override fun isRenderable(info: TextureInfo): Boolean {
   ...
   * ```
   */
  public override fun isStorage(info: TextureInfo): Boolean {
   ...
   * ```
   */
  private fun initGPUFamily() {
    TODO("Implement initGPUFamily")
  }
   ...
   * ```
   */
  public override fun getColorTypeInfo(ct: SkColorType, textureInfo: TextureInfo): Int {
   ...
   * ```
   */
  public override fun onIsTexturable(info: TextureInfo): Boolean {
   ...
   * ```
   */
  private fun isTexturable(format: UndefinedMTLPixelFormat): Boolean {
   ...
   * ```
   */
  public override fun supportsWritePixels(texInfo: TextureInfo): Boolean {
   ...
   * ```
   */
  public override fun supportsReadPixels(texInfo: TextureInfo): Boolean {
   ...
   * ```
   */
  private fun getFormatInfo(pixelFormat: UndefinedMTLPixelFormat): FormatInfo {
   ...
   * ```
   */
  private fun setColorType(colorType: SkColorType, formats: initializer_list<UndefinedMTLPixelFormat>) {
  ...
  public data class FormatInfo public constructor(
    ...
    public fun colorTypeFlags(colorType: SkColorType): Int {
    ...
    public companion object {
      ...
      public val kAllFlags: Int = TODO("Initialize kAllFlags")
    }
  }

  public enum class GPUFamily {
    kApple,
    kMac,
    kMacIntel,
  }
  ...
  public companion object {
    private val kNumMtlFormats: Int = TODO("Initialize kNumMtlFormats")
     ...
     * ```
     */
    private fun getGPUFamily(gpuFamily: GPUFamily?, group: Int?): Boolean {
      TODO("Implement getGPUFamily")
    }
     ...
     * ```
     */
    private fun getFormatIndex(pixelFormat: MTLPixelFormat_): Int {
