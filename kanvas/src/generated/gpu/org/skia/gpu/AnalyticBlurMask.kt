 ...
 * ```
 */
public data class AnalyticBlurMask public constructor(
  /**
   * C++ original:
   * ```cpp
   * Rect fDrawBounds
   ...
   * ```
   */
  private var fDevToScaledShape: Int,
  /**
   * C++ original:
   * ```cpp
   * Rect fShapeData
   ...
   * ```
   */
  private var fShapeType: ShapeType,
  /**
   * C++ original:
   * ```cpp
   * sk_sp<TextureProxy> fProxy
   ...
   * ```
   */
  public fun deviceToScaledShape(): Int {
    TODO("Implement deviceToScaledShape")
  }
   ...
   * ```
   */
  public fun shapeData(): Int {
    TODO("Implement shapeData")
  }
   ...
   * ```
   */
  public fun shapeType(): ShapeType {
   ...
   * ```
   */
  public fun blurData(): Int {
    TODO("Implement blurData")
  }
