...
import kotlin.is_same
import org.skia.core.Float2
import org.skia.core.Float4
import org.skia.math.SkPoint
import undefined.JoinAttrib
import undefined.Traits
import wangs_formula.VectorXform
import ColorAttrib.kEnabled as ColorAttribKEnabled
import DepthAttrib.kEnabled as DepthAttribKEnabled
import FanPointAttrib.kEnabled as FanPointAttribKEnabled
import JoinAttrib.kEnabled as JoinAttribKEnabled
import SsboIndexAttrib.kEnabled as SsboIndexAttribKEnabled
import StrokeAttrib.kEnabled as StrokeAttribKEnabled

public typealias Writer = PatchWriter<DynamicInstancesPatchAllocator<FixedCountWedges>, Required<PatchAttribs.KFanPoint>, Required<PatchAttribs.KPaintDepth>, Required<PatchAttribs.KSsboIndex>, Optional<PatchAttribs.KExplicitCurveType>>
 ...
 * ```
 */
public data class PatchWriter<PatchAllocator, Traits> public constructor(
  /**
   * C++ original:
   * ```cpp
   *     template <PatchAttribs A> using  opt_attrib = has_trait<Optional<A>>;
   ...
   * ```
   */
  private var fApproxTransform: Int,
  /**
   * C++ original:
   * ```cpp
   * static constexpr bool kDiscardFlatCurves        = has_trait<DiscardFlatCurves>::value
   ...
   * ```
   */
  private var fTolerances: Int,
  /**
   * C++ original:
   * ```cpp
   * static constexpr bool kRequireWideColor
   * ```
   */
  private var fPatchAllocator: PatchAllocator,
  /**
   * C++ original:
   * ```cpp
   * static constexpr bool kOptionalWideColor
   * ```
   */
  private var fDeferredPatch: Int,
  /**
   * C++ original:
   * ```cpp
   ...
   * ```
   */
  public fun setShaderTransform(xform: VectorXform, maxScale: Float = TODO()) {
    TODO("Implement setShaderTransform")
  }
   ...
   * ```
   */
  public fun writeDeferredStrokePatch(param0: Int, param1: Int): Int {
    TODO("Implement writeDeferredStrokePatch")
  }
   ...
   * ```
   */
  public fun closeDeferredStrokePatch(param0: Int): Int {
    TODO("Implement closeDeferredStrokePatch")
  }
   ...
   * ```
   */
  public fun writeDeferredStrokePatch(): Int {
    TODO("Implement writeDeferredStrokePatch")
  }
   ...
   * ```
   */
  public fun updateJoinControlPointAttrib(param0: JoinAttribKEnabled): Int {
    TODO("Implement updateJoinControlPointAttrib")
  }
   ...
   * ```
   */
  public fun updateFanPointAttrib(param0: FanPointAttribKEnabled): Int {
    TODO("Implement updateFanPointAttrib")
  }
   ...
   * ```
   */
  public fun updateStrokeParamsAttrib(param0: StrokeAttribKEnabled): Int {
    TODO("Implement updateStrokeParamsAttrib")
  }
   ...
   * ```
   */
  public fun updateUniformStrokeParams(param0: StrokeAttribKEnabled): Int {
    TODO("Implement updateUniformStrokeParams")
  }
   ...
   * ```
   */
  public fun updateColorAttrib(param0: ColorAttribKEnabled): Int {
    TODO("Implement updateColorAttrib")
  }
   ...
   * ```
   */
  public fun updatePaintDepthAttrib(param0: DepthAttribKEnabled): Int {
    TODO("Implement updatePaintDepthAttrib")
  }
   ...
   * ```
   */
  public fun updateSsboIndexAttrib(param0: SsboIndexAttribKEnabled): Int {
    TODO("Implement updateSsboIndexAttrib")
  }
   ...
   * ```
   */
  public fun writeCubic(
    p0: Float2,
    p1: Float2,
    p2: Float2,
    p3: Float2,
  ): Int {
    TODO("Implement writeCubic")
  }
   ...
   * ```
   */
  public fun writeCubic(pts: Array<SkPoint>): Int {
    TODO("Implement writeCubic")
  }
   ...
   * ```
   */
  public fun writeConic(
    p0: Float2,
    p1: Float2,
    p2: Float2,
    w: Float,
  ): Int {
    TODO("Implement writeConic")
  }
   ...
   * ```
   */
  public fun writeConic(pts: Array<SkPoint>, w: Float): Int {
    TODO("Implement writeConic")
  }
   ...
   * ```
   */
  public fun writeQuadratic(
    p0: Float2,
    p1: Float2,
    p2: Float2,
  ): Int {
    TODO("Implement writeQuadratic")
  }
   ...
   * ```
   */
  public fun writeQuadratic(pts: Array<SkPoint>): Int {
    TODO("Implement writeQuadratic")
  }
   ...
   * ```
   */
  public fun writeLine(p0p1: Float4): Int {
   ...
   * ```
   */
  public fun writeLine(p0: Float2, p1: Float2): Int {
    TODO("Implement writeLine")
  }
   ...
   * ```
   */
  public fun writeLine(p0: SkPoint, p1: SkPoint): Int {
    TODO("Implement writeLine")
  }
   ...
   * ```
   */
  public fun writeTriangle(
    p0: Float2,
    p1: Float2,
    p2: Float2,
  ): Int {
    TODO("Implement writeTriangle")
  }
   ...
   * ```
   */
  public fun writeCircle(p: SkPoint): Int {
    TODO("Implement writeCircle")
  }
   ...
   * ```
   */
  public fun writeSquare(p: SkPoint, joinTo: SkPoint?): Int {
    TODO("Implement writeSquare")
  }
   ...
   * ```
   */
  public fun writeSquare(p: Float2, joinTo: Float2): Int {
    TODO("Implement writeSquare")
  }
   ...
   * ```
   */
  private fun emitPatchAttribs(
    vertexWriter: VertexWriter,
    join: JoinAttrib,
    explicitCurveType: Float,
  ): Int {
    TODO("Implement emitPatchAttribs")
  }

  public open class HasTrait<F> : disjunction(), is_same, F, Traits

  public companion object {
    private val kTrackJoinControlPoints: Boolean = TODO("Initialize kTrackJoinControlPoints")

    private val kAddTrianglesWhenChopping: Boolean = TODO("Initialize kAddTrianglesWhenChopping")

    private val kDiscardFlatCurves: Boolean = TODO("Initialize kDiscardFlatCurves")

    private val kReplicateLineEndPoints: Boolean = TODO("Initialize kReplicateLineEndPoints")

    private val kRequireWideColor: Boolean = TODO("Initialize kRequireWideColor")

    private val kOptionalWideColor: Boolean = TODO("Initialize kOptionalWideColor")

    private val kMaxStride: Int = TODO("Initialize kMaxStride")
  }
}
