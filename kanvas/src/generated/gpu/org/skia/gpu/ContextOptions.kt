 ...
 * ```
 */
public data class ContextOptions public constructor(
  /**
   * C++ original:
   * ```cpp
   * bool fDisableDriverCorrectnessWorkarounds = false
   * ```
   */
  public var fDisableDriverCorrectnessWorkarounds: Boolean,
  /**
   * C++ original:
   * ```cpp
   * skgpu::ShaderErrorHandler* fShaderErrorHandler = nullptr
   * ```
   */
  public var fShaderErrorHandler: ShaderErrorHandler?,
  /**
   * C++ original:
   * ```cpp
   * SampleCount fInternalMultisampleCount
   * ```
   */
  public var fInternalMultisampleCount: Int,
  /**
   * C++ original:
   * ```cpp
   * std::optional<SkISize> fInternalMSAATileSize
   * ```
   */
  public var fInternalMSAATileSize: Int,
  /**
   * C++ original:
   * ```cpp
   * float fMinimumPathSizeForMSAA = 0
   * ```
   */
  public var fMinimumPathSizeForMSAA: Float,
  /**
   * C++ original:
   * ```cpp
   * bool fClientWillExternallySynchronizeAllThreads = false
   * ```
   */
  public var fClientWillExternallySynchronizeAllThreads: Boolean,
  /**
   * C++ original:
   * ```cpp
   * size_t fGlyphCacheTextureMaximumBytes = 2048 * 1024 * 4
   * ```
   */
  public var fGlyphCacheTextureMaximumBytes: ULong,
  /**
   * C++ original:
   * ```cpp
   * float fMinDistanceFieldFontSize = 18
   * ```
   */
  public var fMinDistanceFieldFontSize: Float,
  /**
   * C++ original:
   * ```cpp
   * float fGlyphsAsPathsFontSize = 324
   * ```
   */
  public var fGlyphsAsPathsFontSize: Float,
  /**
   * C++ original:
   * ```cpp
   ...
   * ```
   */
  public var fMaxPathAtlasTextureSize: Int,
  /**
   * C++ original:
   * ```cpp
   * bool fAllowMultipleAtlasTextures = true
   * ```
   */
  public var fAllowMultipleAtlasTextures: Boolean,
  /**
   * C++ original:
   * ```cpp
   * bool fSupportBilerpFromGlyphAtlas = false
   * ```
   */
  public var fSupportBilerpFromGlyphAtlas: Boolean,
  /**
   * C++ original:
   * ```cpp
   * bool fRequireOrderedRecordings = false
   ...
   * ```
   */
  public var fSetBackendLabels: Boolean,
  /**
   * C++ original:
   * ```cpp
   * bool fSetBackendLabels = false
   * ```
   */
  public var fVulkanVMALargeHeapBlockSize: ULong?,
  /**
   * C++ original:
   * ```cpp
   * std::optional<uint64_t> fVulkanVMALargeHeapBlockSize
   * ```
   */
  public var fPipelineCallbackContext: ContextOptionsPipelineCallbackContext,
  /**
   * C++ original:
   * ```cpp
   * PipelineCallbackContext fPipelineCallbackContext = nullptr
   * ```
   */
  public var fPipelineCachingCallback: ContextOptionsPipelineCachingCallback,
  /**
   * C++ original:
   * ```cpp
   * PipelineCachingCallback fPipelineCachingCallback = nullptr
   * ```
   */
  public var fPipelineCallback: ContextOptionsPipelineCallback,
  /**
   * C++ original:
   * ```cpp
   * PipelineCallback fPipelineCallback = nullptr
   * ```
   */
  public var fUserDefinedKnownRuntimeEffects: Int,
  /**
   * C++ original:
   * ```cpp
   * SkSpan<sk_sp<SkRuntimeEffect>> fUserDefinedKnownRuntimeEffects
   * ```
   */
  public var fExecutor: SkExecutor?,
  /**
   * C++ original:
   * ```cpp
   * SkExecutor* fExecutor = nullptr
   * ```
   */
  public var fPersistentPipelineStorage: PersistentPipelineStorage?,
  /**
   * C++ original:
   * ```cpp
   * PersistentPipelineStorage* fPersistentPipelineStorage = nullptr
   * ```
   */
  public var fEnableCapture: Boolean,
  /**
   * C++ original:
   * ```cpp
   * bool fEnableCapture = false
   * ```
   */
  public var fOptionsPriv: ContextOptionsPriv?,
) {
  public enum class PipelineCacheOp {
    kAddingPipeline,
    kPipelineFound,
  }

  public companion object {
    public val kDefaultContextBudget: ULong = TODO("Initialize kDefaultContextBudget")
  }
}
