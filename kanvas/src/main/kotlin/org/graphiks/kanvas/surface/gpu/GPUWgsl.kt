...
private val DESTINATION_READ_BLEND_FORMULA_WGSL: String =
    GPUBlendFormulaLibrary.advancedBlendDispatcherWgsl()
...
internal val CLIP_COVERAGE_BLEND_WGSL: String = """
    ...
    ${GPUBlendFormulaLibrary.allModeBlendDispatcherWgsl()}
    ...
    fn fs_main(@builtin(position) coord: vec4f) -> @location(0) vec4f {
        ...
        ${GPUBlendFormulaLibrary.coverageResultWgsl(GPUBlendCoverageKind.Scalar)}
    }
""".trimIndent()
