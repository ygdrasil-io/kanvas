            ...
            fun executeCoreClipRoute(
                ...
                try {
                    rendered = when (op) {
                        ...
                        // Prepared vertices and meshes never continue through the legacy immediate
                        // route. A nested legacy composite carrying either is refused at preflight.
                        is DisplayOp.DrawVertices,
                        is DisplayOp.DrawMesh -> refuseCoreRoutePreflight(op, cmdId)
                    ...
                    is DisplayOp.DrawPicture -> {
                        ...
                        for (nestedOp in expanded) {
                            ...
                            when (nestedOp) {
                                ...
                                is DisplayOp.DrawVertices,
                                is DisplayOp.DrawMesh -> {
                                    // Refused by the core-route preflight before the legacy loop;
                                    // this branch only keeps the exhaustive safety net closed.
                                }
                                is DisplayOp.DrawText -> {
