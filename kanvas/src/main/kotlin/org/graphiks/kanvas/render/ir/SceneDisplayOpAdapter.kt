...
internal class FilterRestoreContext(private val table: CapturedFilterTableV1) {
    ...
    private fun node(id: CapturedFilterNodeIdI32): org.graphiks.kanvas.paint.ImageFilter = filters[id] ?: when (val value = table.nodeAt(id)) {
        ...
        is CapturedFilterNodeV1.DistantLitDiffuse -> org.graphiks.kanvas.paint.ImageFilter.DistantLitDiffuse(value.direction, value.lightColor, value.surfaceScale, value.kd, input(value.input))
        ...
        is CapturedFilterNodeV1.DistantLitSpecular -> org.graphiks.kanvas.paint.ImageFilter.DistantLitSpecular(value.direction, value.lightColor, value.surfaceScale, value.ks, value.shininess, input(value.input))
