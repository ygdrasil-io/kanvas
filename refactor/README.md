...
- [État W04 — geometry/coverage](waves/W04-geometry-coverage/status.md)
  ...
  `DeviceRect` W4d, canonise les paires RRect non positives, transporte le
  payload V/I/U par identité et réutilise/évince transactionnellement les slots
  physiques; les deux skips AA4 restent explicites.
