...
- [Plan W5f — color filters et interpolation, huit tâches séquentielles](plans/2026-09-14-w5f-color-filters-implementation-plan.md) — Task1–6 closes sur leurs tranches fonctionnelles bornées, reviews Sol et correction I1/R19 approuvées. Task6 HSL/OKLCH/working-space da32e3801 Approved, zéro Critical/Important :427assertions publiques fraîches passent sur les sources commitées, cinq compiles incrémentales réussies, pas de clean rebuild. Cinq commandes de tests native133 FAILED et suite combinée93/5refus staging conservées, antériorité non prouvée. Minor cast/warnings suivis. Task7 images/A8/Atlas suivante; tâches7–8 et review globale ouvertes, domaines numériques restreints explicites dans le status, pas de claim ISO global.
