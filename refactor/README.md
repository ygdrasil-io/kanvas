...
- [Plan W6a — autorité des layers](plans/2026-09-16-w6a-layer-authority-implementation-plan.md) — checkpoint public de convergence consigné dans le [status W06](waves/W06-layers-effects/status.md) : Picture13/schema7, restore/nesting/`initWithPrevious`, budgets et lanes W4/W5 ciblées sont couverts. Les assertions XML sont vertes après une correction bornée du diagnostic frame-wide W6a; les exits natifs133 restent `UNKNOWN`. Backdrop, filtres spatiaux, F16/HDR, device-loss, fonts/codecs et GMs restent exclus; aucune claim ISO/globale ou clôture avant revue/PR W6a.
...
| W6 | Layers et effets | W6a : checkpoint public/budgets et préservation W4/W5 documentés dans le [status](waves/W06-layers-effects/status.md); native133 `UNKNOWN`, exclusions backdrop/spatial/F16/device-loss explicites, aucune claim ISO/globale. W6b–W6e restent ouverts ([spec](specs/2026-09-16-w6-layers-effects-design.md)) |
