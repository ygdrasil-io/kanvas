...
- [Plan W6b — blur, masks et shadows](plans/2026-09-22-w6b-blur-masks-shadows-implementation-plan.md) — Tasks 1–6 ferment le périmètre W6b borné : table/replay Picture, X/Y image blur, mask blur/shader/table et `DropShadow` `COMPOSITE`/`SHADOW_ONLY` gelés par le plan. Les 70 assertions JUnit des sept shards W6b et les 39 assertions de préservation W6a passent; les sept compilations ciblées sortent 0. B/B−1, nested budget, refus sibling tardif et recovery Surface sont publics. Les exits natifs133 restent `UNKNOWN`; backdrop, filtered previous, F16/HDR, W6c/W6d, device-loss, fonts/codecs, GMs/dashboard/renders/baselines/scores, Skia global et `jpg-color-cube` restent exclus, sans claim ISO/global.
