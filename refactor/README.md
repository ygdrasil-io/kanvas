...
- [Plan W5f — color filters et interpolation, huit tâches séquentielles](plans/2026-09-14-w5f-color-filters-implementation-plan.md) — Task1–7 closes sur leurs tranches fonctionnelles bornées, reviews Sol et correction I1/R19 approuvées. Task7 images/A8/Atlas ccf2c9f83 Approved conformité+qualité, zéro finding actionnable :519 méthodes publiques fraîches passent sur les sources commitées, cinq compilations séparées incrémentales réussies (targets UP-TO-DATE, pas clean). Six commandes de tests restent FAILED/native133 ; suite combinée93/5refus staging conservée, antériorité non prouvée. Copies image originales prébudget/coûtsproof et warnings suivis ; admission générale filteredW4e complexclip/inverse non vérifiée, observation transmise à la review globale. Task8 convergence/Picture/budgets et review globale/PR empilée restent ouvertes, domaines restreints explicites dans le status, pas de claim ISO global.
