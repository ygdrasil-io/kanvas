...
| W5 | Material graph | Correctif global W5a à `39ff219` : DAG exécuté dans le fragment avec raw bindings/ABI V2, table frame-wide des lanes authentiques Rect/RRect/Path/Points/A8 Text/Vertices et Mesh sans programme, ordre/capture/récupération et bornes 512/513 vérifiés. 117 tests publics : 114 passés, 3 skips AA4 authentiques, aucune failure/error. Les deux re-reviews globales Task 8 restent en attente; pas de clôture implicite. MeshProgram et le gap legacy Rect+hard-RRect `uniform slab` restent hors promotion; W5b ensuite ([status](waves/W05-material-graph/status.md)) |
