...
| W5 | Material graph | W5a Solid/Opacity est complet : table material immuable, autorités exclusives `MaterialV1`/`LegacyColorV1`, Rect/RRect/Path/points/text/vertices publics et frame mixte avec ordre/mutation prouvés. Un gradient W5b refuse typé puis le runtime rend une frame W5a suivante. AA4 indisponible reste un skip authentique; W5b (gradients, images, filters, runtime effects et autres kinds) est la prochaine tranche ([status](waves/W05-material-graph/status.md)) |
