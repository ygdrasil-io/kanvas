...
| W6 | Layers et effets | W6a et W6b borné : layers, budgets, W4/W5, blur/masks/shadows, replay et recovery sont documentés dans le [status](waves/W06-layers-effects/status.md); native133 `UNKNOWN`, exclusions backdrop/filtered previous/F16/device-loss explicites, aucune claim ISO/globale. W6c–W6e restent ouverts ([spec](specs/2026-09-16-w6-layers-effects-design.md)) |
