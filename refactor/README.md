...
- [Plan W6a — autorité des layers](plans/2026-09-16-w6a-layer-authority-implementation-plan.md) — plan séquentiel approuvé pour `saveLayer`, restore, nesting et `initWithPrevious`, sous une autorité unique `render-ir → :math → :gpu-plan → :gpu-renderer`. Implémentation non commencée ; backdrop et filtres spatiaux restent réservés aux lots W6 suivants.
