...
| W6 | Layers et effets | W6a/W6b et W6c bornés : layers, budgets, W4/W5, blur/masks/shadows et les neuf familles spatiales (`Crop`, `Offset`, `Tile`, `ColorFilter`, `Compose`, `Merge`, `Blend`, `Dilate`, `Erode`) ont une custody publique ciblée dans le [status](waves/W06-layers-effects/status.md). Les assertions XML W6c et préservations ciblées passent, mais native133/134 reste `UNKNOWN`; W5b est `FROM-CACHE` sans nouvelle observation native. Backdrop/filtered previous/F16/device-loss et W6d restent exclus, sans claim ISO/globale. |
