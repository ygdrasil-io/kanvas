...
- [x] **Step 1: Écrire les tests RED JVM/JS du snapshot F64**
...
- [x] **Step 3: Implémenter le snapshot et le mapping F64 minimal**
...
- [x] **Step 4: Exécuter les preuves JVM et JS**
...
- [x] **Step 5: Self-review et commit Terra**
...
- [x] **Step 1: Écrire les tests RED de normalisation et classification**
...
- [x] **Step 2: Écrire les tests RED de limites, erreurs et immutabilité**
...
- [x] **Step 4: Implémenter la préparation transactionnelle**
...
- [x] **Step 5: Exécuter JVM/JS et la suite math existante**
...
- [x] **Step 6: Self-review et commit Terra**
...
- [x] **Step 1: Écrire les tests RED du format, de la ressource D24S8 et de la migration W3**
...
- [x] **Step 2: Écrire les tests RED des passes, de l'atomicité et des capabilities historiques**
...
- [x] **Step 4: Implémenter les types en préservant W3/W4a/W4b**
...
- [x] **Step 5: Implémenter la validation atomique dans `RenderGraph.of`**
...
- [x] **Step 6: Exécuter les tests gpu-plan complets**
...
- [x] **Step 7: Self-review et commit Terra**
...
- [x] **Step 1: Écrire les tests RED du résultat de sélection terminal pré-device**
...
- [x] **Step 2: Écrire les tests RED d'admission W4c**
...
- [x] **Step 3: Écrire les tests RED du budget exact**
...
- [x] **Step 5: Implémenter le selector atomique**
...
- [x] **Step 6: Implémenter budget et graph**
...
- [x] **Step 7: Exécuter gpu-plan complet**
...
- [x] **Step 8: Self-review et commit Terra**
...
- [x] **Step 1: Écrire les tests RED du capability adapter**
...
- [x] **Step 2: Écrire les tests RED du lowerer**
...
- [x] **Step 4: Implémenter le scratch sans géométrie renderer nouvelle**
...
- [x] **Step 5: Implémenter le lowerer et l'assembler**
...
- [x] **Step 6: Exécuter les tests ciblés et renderer planning**
...
- [x] **Step 1: Écrire les tests RED de preflight/materialization**
...
- [x] **Step 2: Écrire le test RED du lifetime pool jusqu'au readback**
...
- [x] **Step 4: Brancher le preflight scellé W4c**
...
- [x] **Step 5: Brancher le materializer et le cover reset**
...
- [x] **Step 6: Exécuter les tests ciblés puis les régressions path natives**
...
- [x] **Step 1: Écrire l'oracle line-only indépendant**
...
- [x] **Step 2: Écrire le certificat indépendant des courbes**
...
- [x] **Step 3: Écrire les tests Surface RED**
...
- [x] **Step 5: Activer W4c dans la chaîne et la gate**
...
- [x] **Step 6: Exécuter les tests Surface ciblés et les lanes précédentes**
...
- [x] **Step 1: Exécuter la vérification math/planner**
...
- [x] **Step 2: Exécuter la vérification renderer ciblée**
...
- [x] **Step 3: Exécuter la vérification Kanvas ciblée puis globale**
...
- [x] **Step 4: Vérifier explicitement le périmètre et les fichiers**
...
- [x] **Step 5: Mettre à jour uniquement les documents autoritaires**
...
- [x] **Step 6: Committer le suivi final**
