...
class Round6Test {
    ...
    @Test
    fun `OneBadArcGM matches reference`() = runGm(OneBadArcGM(), "OneBadArcGM", 70.0)

    @Test
    fun `Crbug888453GM matches reference`() = runGm(Crbug888453GM(), "Crbug888453GM", 80.0)

    @Test
    fun `Crbug1472747GM matches reference`() = runGm(Crbug1472747GM(), "Crbug1472747GM", 50.0)

    @Test
    fun `Bug40810065GM matches reference`() = runGm(Bug40810065GM(), "Bug40810065GM", 70.0)

    @Test
    fun `Bug12866GM matches reference`() = runGm(Bug12866GM(), "Bug12866GM", 50.0)

    @Test
    fun `Bug7792GM matches reference`() = runGm(Bug7792GM(), "Bug7792GM", 80.0)

    @Test
    fun `PathInvFillGM matches reference`() = runGm(PathInvFillGM(), "PathInvFillGM", 80.0)
    ...
    fun `CircularArcsFillGM matches reference`() =
        runGm(CircularArcsFillGM(), "CircularArcsFillGM", 50.0)

    @Test
    fun `CircularArcsHairlineGM matches reference`() =
        runGm(CircularArcsHairlineGM(), "CircularArcsHairlineGM", 80.0)

    @Test
    fun `ConvexLineOnlyPathsFillGM matches reference`() =
        runGm(ConvexLineOnlyPathsFillGM(), "ConvexLineOnlyPathsFillGM", 80.0)

    @Test
    fun `ConvexLineOnlyPathsStrokeAndFillGM matches reference`() =
        runGm(ConvexLineOnlyPathsStrokeAndFillGM(), "ConvexLineOnlyPathsStrokeAndFillGM", 70.0)
}
