...
public object SkNamedPrimaries {
    ...
    private data class TableEntry(
        ...
        val toXYZD50: org.graphiks.math.SkcmsMatrix3x3? = null,
    )
     ...
     */
    public fun getCicp(primaries: CicpId): org.graphiks.math.SkcmsMatrix3x3? {
     ...
     */
    public fun getCicpFromMatrix(m: org.graphiks.math.SkcmsMatrix3x3): CicpId? {
        for (entry in cicpTable) {
