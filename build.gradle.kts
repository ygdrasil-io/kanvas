...
tasks.register<Exec>("pipelineM91ImageFilterSlice") {
    group = "verification"
    description = "Generates and validates the M91 image-filter backlog slice without changing support claims."
    dependsOn("pipelineM89RegistryCloseout")
    commandLine("python3", "scripts/m91_image_filter_slice.py")
    inputs.file(layout.projectDirectory.file("scripts/m91_image_filter_slice.py"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m89-gm-registry/registry.json"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m89-gm-registry/closeout.json"))
    outputs.dir(layout.projectDirectory.dir("reports/wgsl-pipeline/m91-image-filter-slice"))
    outputs.upToDateWhen { false }
}
...
tasks.register<Exec>("pipelineM91ImageFilterOffsetReferenceProvenanceGate") {
    ...
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m91-image-filter-offset-evidence-intake/summary.json"))
    inputs.file(layout.projectDirectory.file("skia-integration-tests/src/test/resources/original-888/offsetimagefilter.png"))
    outputs.dir(layout.projectDirectory.dir("reports/wgsl-pipeline/m91-image-filter-offset-reference-provenance-gate"))
    outputs.upToDateWhen { false }
}
...
tasks.register<Exec>("pipelineM91ImageFilterOffsetRouteEvidenceGate") {
    ...
    dependsOn("pipelineM91ImageFilterOffsetReferenceProvenanceGate")
...
tasks.register<Exec>("pipelineM91ImageFilterOffsetRenderDiffPerfGate") {
    group = "verification"
    description = "Generates and validates M91-IF-3A OffsetImageFilterGM render/diff/performance gate without changing support claims."
    dependsOn("pipelineM91ImageFilterOffsetReferenceProvenanceGate", "pipelineM91ImageFilterOffsetRouteEvidenceGate")
    commandLine("python3", "scripts/m91_image_filter_offset_render_diff_perf_gate.py")
    inputs.file(layout.projectDirectory.file("scripts/m91_image_filter_offset_render_diff_perf_gate.py"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m91-image-filter-offset-evidence-intake/summary.json"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/scenes/artifacts/skia-gm-offsetimagefilter/reference-plan.json"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m91-image-filter-offset-reference-provenance-gate/summary.json"))
...
tasks.register<Exec>("pipelineM90PathAaEdgeBudgetProof") {
    ...
    dependsOn("pipelineM90PathAaSlice")
    commandLine("python3", "scripts/m90_path_aa_edge_budget_proof.py")
    inputs.file(layout.projectDirectory.file("scripts/m90_path_aa_edge_budget_proof.py"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m90-path-aa-slice/selection.json"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m89-gm-registry/registry.json"))
    inputs.dir(layout.projectDirectory.dir("reports/wgsl-pipeline/scenes/artifacts/path-aa-convexpaths-edge-budget"))
    inputs.dir(layout.projectDirectory.dir("reports/wgsl-pipeline/scenes/artifacts/path-aa-dashing-edge-budget"))
    outputs.dir(layout.projectDirectory.dir("reports/wgsl-pipeline/m90-path-aa-edge-budget-proof"))
    outputs.upToDateWhen { false }
}
...
tasks.register<Exec>("pipelineM90PathAaHairlinesEvidenceIntake") {
    group = "verification"
    description = "Generates and validates M90-PAA-3A HairlinesGM evidence intake without changing support claims."
    dependsOn("pipelineM90PathAaCandidateReadiness")
    commandLine("python3", "scripts/m90_path_aa_hairlines_evidence_intake.py")
    inputs.file(layout.projectDirectory.file("scripts/m90_path_aa_hairlines_evidence_intake.py"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m89-gm-registry/registry.json"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m90-path-aa-candidate-readiness/summary.json"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m90-path-aa-route-diagnostics/routes/skia-gm-hairlines/route-cpu.json"))
...
tasks.register<Exec>("pipelineM90PathAaStrokeRectEvidenceGate") {
    group = "verification"
    description = "Validates the M90-PAA-3B-REF StrokeRectGM row-specific evidence gate without changing support claims."
    commandLine("python3", "scripts/validate_m90_strokerect_evidence_gate.py")
    inputs.file(layout.projectDirectory.file("scripts/validate_m90_strokerect_evidence_gate.py"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/2026-06-08-m90-strokerect-evidence-gate.md"))
    ...
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m90-path-aa-strokerect-evidence-intake/summary.json"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m90-path-aa-route-diagnostics/routes/skia-gm-strokerect/route-cpu.json"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m90-path-aa-route-diagnostics/routes/skia-gm-strokerect/route-gpu.json"))
    outputs.upToDateWhen { false }
}
...
tasks.register<Exec>("pipelineM90PathAaThinStrokedRectsEvidenceGate") {
    group = "verification"
    description = "Validates the M90-PAA-3C-REF ThinStrokedRectsGM row-specific evidence gate without changing support claims."
    commandLine("python3", "scripts/validate_m90_thinstrokedrects_evidence_gate.py", "--check-worktree-scope")
    inputs.file(layout.projectDirectory.file("scripts/validate_m90_thinstrokedrects_evidence_gate.py"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/2026-06-08-m90-thinstrokedrects-evidence-gate.md"))
    ...
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m90-path-aa-thinstrokedrects-evidence-intake/summary.json"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m90-path-aa-route-diagnostics/routes/skia-gm-thinstrokedrects/route-cpu.json"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m90-path-aa-route-diagnostics/routes/skia-gm-thinstrokedrects/route-gpu.json"))
    outputs.upToDateWhen { false }
}

tasks.register<Exec>("pipelineM90PathAaStrokedLinesEvidenceIntake") {
    group = "verification"
    description = "Generates and validates M90-PAA-3D StrokedLinesGM evidence intake without changing support claims."
    dependsOn("pipelineM90PathAaCandidateReadiness")
    commandLine("python3", "scripts/m90_path_aa_strokedlines_evidence_intake.py")
    inputs.file(layout.projectDirectory.file("scripts/m90_path_aa_strokedlines_evidence_intake.py"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m89-gm-registry/registry.json"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m90-path-aa-candidate-readiness/summary.json"))
    ...
    inputs.file(layout.projectDirectory.file("cpu-raster/test-similarity-scores.properties"))
    inputs.file(layout.projectDirectory.file("kanvas-skia/test-similarity-scores.properties"))
    inputs.file(layout.projectDirectory.file("skia-integration-tests/src/test/kotlin/org/skia/tests/StrokedLinesTest.kt"))
    inputs.file(layout.projectDirectory.file("skia-integration-tests/src/main/kotlin/org/skia/tests/StrokedLinesGM.kt"))
    outputs.dir(layout.projectDirectory.dir("reports/wgsl-pipeline/m90-path-aa-strokedlines-evidence-intake"))
    outputs.upToDateWhen { false }
}
...
tasks.register<Exec>("pipelineM90PathAaStrokeRectsEvidenceIntake") {
    ...
    dependsOn("pipelineM90PathAaCandidateReadiness")
    commandLine("python3", "scripts/m90_path_aa_strokerects_evidence_intake.py")
    inputs.file(layout.projectDirectory.file("scripts/m90_path_aa_strokerects_evidence_intake.py"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m89-gm-registry/registry.json"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m90-path-aa-candidate-readiness/summary.json"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m90-path-aa-route-diagnostics/routes/skia-gm-strokerects/route-cpu.json"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m90-path-aa-route-diagnostics/routes/skia-gm-strokerects/route-gpu.json"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/scenes/generated/dash-hairline-stroke-gm-dashboard-visibility.json"))
    inputs.file(layout.projectDirectory.file("gpu-raster/test-similarity-scores-webgpu.properties"))
    inputs.file(layout.projectDirectory.file("skia-integration-tests/test-similarity-scores.properties"))
    inputs.file(layout.projectDirectory.file("cpu-raster/test-similarity-scores.properties"))
    inputs.file(layout.projectDirectory.file("kanvas-skia/test-similarity-scores.properties"))
    inputs.file(layout.projectDirectory.file("skia-integration-tests/src/test/kotlin/org/skia/tests/StrokeRectsTest.kt"))
    inputs.file(layout.projectDirectory.file("skia-integration-tests/src/main/kotlin/org/skia/tests/StrokeRectsGM.kt"))
    inputs.file(layout.projectDirectory.file("gpu-raster/src/test/kotlin/org/skia/gpu/webgpu/StrokeRectsWebGpuTest.kt"))
    inputs.file(layout.projectDirectory.file("gpu-raster/src/test/kotlin/org/skia/gpu/webgpu/crossbackend/StrokeRectsCrossBackendTest.kt"))
    outputs.dir(layout.projectDirectory.dir("reports/wgsl-pipeline/m90-path-aa-strokerects-evidence-intake"))
    outputs.upToDateWhen { false }
}

tasks.register<Exec>("pipelineM90PathAaStrokeRectsEvidenceGate") {
    group = "verification"
    description = "Validates the M90-PAA-3E-REF StrokeRectsGM row-specific evidence gate without changing support claims."
    commandLine("python3", "scripts/validate_m90_strokerects_evidence_gate.py", "--check-worktree-scope")
    inputs.file(layout.projectDirectory.file("scripts/validate_m90_strokerects_evidence_gate.py"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/2026-06-08-m90-strokerects-evidence-gate.md"))
    ...
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m90-path-aa-strokerects-evidence-intake/summary.json"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m90-path-aa-route-diagnostics/routes/skia-gm-strokerects/route-cpu.json"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m90-path-aa-route-diagnostics/routes/skia-gm-strokerects/route-gpu.json"))
    outputs.upToDateWhen { false }
}
...
tasks.register<Exec>("pipelineM90PathAaScaledStrokesEvidenceIntake") {
    ...
    dependsOn("pipelineM90PathAaCandidateReadiness")
    commandLine("python3", "scripts/m90_path_aa_scaledstrokes_evidence_intake.py")
    inputs.file(layout.projectDirectory.file("scripts/m90_path_aa_scaledstrokes_evidence_intake.py"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m89-gm-registry/registry.json"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m90-path-aa-candidate-readiness/summary.json"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m90-path-aa-route-diagnostics/routes/skia-gm-scaledstrokes/route-cpu.json"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m90-path-aa-route-diagnostics/routes/skia-gm-scaledstrokes/route-gpu.json"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/scenes/generated/dash-hairline-stroke-gm-dashboard-visibility.json"))
    inputs.file(layout.projectDirectory.file("gpu-raster/test-similarity-scores-webgpu.properties"))
    inputs.file(layout.projectDirectory.file("skia-integration-tests/test-similarity-scores.properties"))
    inputs.file(layout.projectDirectory.file("cpu-raster/test-similarity-scores.properties"))
    inputs.file(layout.projectDirectory.file("kanvas-skia/test-similarity-scores.properties"))
    inputs.file(layout.projectDirectory.file("skia-integration-tests/src/test/kotlin/org/skia/tests/ScaledStrokesTest.kt"))
    inputs.file(layout.projectDirectory.file("skia-integration-tests/src/main/kotlin/org/skia/tests/ScaledStrokesGM.kt"))
    inputs.file(layout.projectDirectory.file("gpu-raster/src/test/kotlin/org/skia/gpu/webgpu/ScaledStrokesWebGpuTest.kt"))
    inputs.file(layout.projectDirectory.file("gpu-raster/src/test/kotlin/org/skia/gpu/webgpu/crossbackend/ScaledStrokesCrossBackendTest.kt"))
    outputs.dir(layout.projectDirectory.dir("reports/wgsl-pipeline/m90-path-aa-scaledstrokes-evidence-intake"))
    outputs.upToDateWhen { false }
}

tasks.register<Exec>("pipelineM90PathAaScaledStrokesEvidenceGate") {
    group = "verification"
    description = "Validates the M90-PAA-3G-REF ScaledStrokesGM row-specific evidence gate without changing support claims."
    commandLine("python3", "scripts/validate_m90_scaledstrokes_evidence_gate.py", "--check-worktree-scope")
    inputs.file(layout.projectDirectory.file("scripts/validate_m90_scaledstrokes_evidence_gate.py"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/2026-06-08-m90-scaledstrokes-evidence-gate.md"))
    ...
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m90-path-aa-scaledstrokes-evidence-intake/summary.json"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m90-path-aa-route-diagnostics/routes/skia-gm-scaledstrokes/route-cpu.json"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m90-path-aa-route-diagnostics/routes/skia-gm-scaledstrokes/route-gpu.json"))
    outputs.upToDateWhen { false }
}

tasks.register<Exec>("pipelineM90PathAaDashingEvidenceIntake") {
    group = "verification"
    description = "Generates and validates M90-PAA-3H DashingGM evidence intake without changing support claims."
    dependsOn("pipelineM90PathAaCandidateReadiness")
    commandLine("python3", "scripts/m90_path_aa_dashing_evidence_intake.py")
    inputs.file(layout.projectDirectory.file("scripts/m90_path_aa_dashing_evidence_intake.py"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m89-gm-registry/registry.json"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m90-path-aa-candidate-readiness/summary.json"))
    ...
    inputs.file(layout.projectDirectory.file("cpu-raster/test-similarity-scores.properties"))
    inputs.file(layout.projectDirectory.file("kanvas-skia/test-similarity-scores.properties"))
    inputs.file(layout.projectDirectory.file("skia-integration-tests/src/test/kotlin/org/skia/tests/DashingTest.kt"))
    ...
    outputs.dir(layout.projectDirectory.dir("reports/wgsl-pipeline/m90-path-aa-dashing-evidence-intake"))
    outputs.upToDateWhen { false }
}
...
tasks.register<Exec>("pipelineM90PathAaDashCubicsEvidenceIntake") {
    ...
    dependsOn("pipelineM90PathAaCandidateReadiness")
    commandLine("python3", "scripts/m90_path_aa_dashcubics_evidence_intake.py")
    inputs.file(layout.projectDirectory.file("scripts/m90_path_aa_dashcubics_evidence_intake.py"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m89-gm-registry/registry.json"))
    inputs.file(layout.projectDirectory.file("reports/wgsl-pipeline/m90-path-aa-candidate-readiness/summary.json"))
    ...
    inputs.file(layout.projectDirectory.file("cpu-raster/test-similarity-scores.properties"))
    inputs.file(layout.projectDirectory.file("kanvas-skia/test-similarity-scores.properties"))
    inputs.file(layout.projectDirectory.file("skia-integration-tests/src/test/kotlin/org/skia/tests/DashCubicsTest.kt"))
    inputs.file(layout.projectDirectory.file("skia-integration-tests/src/main/kotlin/org/skia/tests/DashCubicsGM.kt"))
    inputs.file(layout.projectDirectory.file("gpu-raster/src/test/kotlin/org/skia/gpu/webgpu/crossbackend/DashCubicsCrossBackendTest.kt"))
    outputs.dir(layout.projectDirectory.dir("reports/wgsl-pipeline/m90-path-aa-dashcubics-evidence-intake"))
    outputs.upToDateWhen { false }
}
