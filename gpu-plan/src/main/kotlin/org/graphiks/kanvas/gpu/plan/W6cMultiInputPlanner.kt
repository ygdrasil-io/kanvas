...
internal object W6cMultiInputPlanner {
    internal fun bounds(inputs: List<W6bSourceGeometryV1>): FilterBoundsPlanV1 {
        ...
        val known = inputs.mapNotNull(W6bSourceGeometryV1::copyKnownContentDeviceI32).reduceOrNull(::union)
        val produced = inputs.mapNotNull(W6bSourceGeometryV1::copyProducedOutputDeviceI32).reduceOrNull(::union)
