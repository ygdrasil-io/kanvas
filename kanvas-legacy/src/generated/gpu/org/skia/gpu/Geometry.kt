 ...
 * ```
 */
public data class Geometry public constructor(
  private var fShape: Int,
  private var fSubRunData: Int,
  private var fVertices: Int,
  private var fEdgeAAQuad: Int,
  private var fCoverageMaskShape: Int,
  private var fAnalyticBlurMask: Int,
) {
