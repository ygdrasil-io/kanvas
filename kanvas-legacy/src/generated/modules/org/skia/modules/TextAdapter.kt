 ...
 * ```
 */
public class TextAdapter public constructor(
  fontmgr: SkSp<SkFontMgr>,
  customGlyphMapper: SkSp<CustomFont.GlyphCompMapper>,
  logger: SkSp<Logger>,
  factory: SkSp<Factory>,
  apg: AnchorPointGrouping,
   ...
   * ```
   */
  private var skSp: TextAdapter = TODO("Initialize skSp")
   ...
   * ```
   */
  private val fCustomGlyphMapper: Int = TODO("Initialize fCustomGlyphMapper")
   ...
   * ```
   */
  private val fAnchorPointGrouping: AnchorPointGrouping = TODO("Initialize fAnchorPointGrouping")
   ...
   * ```
   */
  private var fFragments: Int = TODO("Initialize fFragments")
   ...
   * ```
   */
  private var fMaps: Int = TODO("Initialize fMaps")
   ...
   * ```
   */
  private var fText: TextValueTracker = TODO("Initialize fText")

  /**
   * C++ original:
   * ```cpp
   * Vec2Value                 fGroupingAlignment
   * ```
   */
  private var fGroupingAlignment: Int = TODO("Initialize fGroupingAlignment")

  /**
   * C++ original:
   * ```cpp
   * float                     fTextShapingScale  = 1
   * ```
   */
  private var fTextShapingScale: Float = TODO("Initialize fTextShapingScale")
   ...
   * ```
   */
  private var fPathInfo: Int = TODO("Initialize fPathInfo")
   ...
   * ```
   */
  private var fHasBlurAnimator: Boolean = TODO("Initialize fHasBlurAnimator")
   ...
   * ```
   */
  public fun setText(txt: TextValue) {
   ...
   * ```
   */
  private fun addFragment(frag: Shaper.Fragment, container: Group?) {
   ...
   * ```
   */
  private fun buildDomainMaps(shapeResult: Shaper.Result) {
    TODO("Implement buildDomainMaps")
  }
   ...
   * ```
   */
  private fun pushPropsToFragment(
    props: TextAnimator.ResolvedProps,
    rec: FragmentRec,
    fragOffset: SkV2,
    groupingAlignment: SkV2,
    groupingSpan: TextAnimator.DomainSpan?,
  ) {
    TODO("Implement pushPropsToFragment")
  }
   ...
   * ```
   */
  private fun fragmentAnchorPoint(
    rec: FragmentRec,
    groupingAlignment: SkV2,
    groupingSpan: TextAnimator.DomainSpan?,
  ): Int {
    TODO("Implement fragmentAnchorPoint")
  }
   ...
   * ```
   */
  private fun shaperFlags(): Int {
    TODO("Implement shaperFlags")
  }
   ...
   * ```
   */
  private fun fragmentMatrix(
    props: TextAnimator.ResolvedProps,
    rec: FragmentRec,
    fragOffset: SkV2,
  ): Int {
    TODO("Implement fragmentMatrix")
  }
   ...
   * ```
   */
  public fun buildGlyphCompNodes(glyphs: Shaper.ShapedGlyphs): Int {
    TODO("Implement buildGlyphCompNodes")
  }

  public data class FragmentRec public constructor(
    public var fOrigin: Int,
    public val fGlyphs: Int?,
    public var fFillColorNode: Int,
    public var fStrokeColorNode: Int,
    public var fBlur: Int,
    public var fAdvance: Float,
    public var fAscent: Float,
  )

  public data class TextValueTracker public constructor(
    public var fCurrentValue: Int,
    private var fPrevValue: Int,
  ) {
  ...
  public enum class AnchorPointGrouping {
    kCharacter,
    kWord,
    kLine,
    kAll,
