 ...
 * ```
 */
public class GradientAdapter public constructor(
  gradient: SkSp<Gradient>,
  type: Type,
  stopCount: ULong,
  jgrad: ObjectValue,
  jstops: ObjectValue,
   ...
   * ```
   */
  private val fGradient: SkSp<Gradient> = TODO("Initialize fGradient")
   ...
   * ```
   */
  private val fStopCount: ULong = TODO("Initialize fStopCount")
   ...
   * ```
   */
  private var fStops: VectorValue = TODO("Initialize fStops")
   ...
   * ```
   */
  private var fHighlightLength: Float = TODO("Initialize fHighlightLength")
   ...
   * ```
   */
  private var fHighlightAngle: Float = TODO("Initialize fHighlightAngle")
   ...
   * ```
   */
  private fun <T> nextRec(rec: T?, endRec: T?): T {
    TODO("Implement nextRec")
  }
  ...
  public companion object {
     ...
     * ```
     */
    public fun make(jgrad: ObjectValue, abuilder: AnimationBuilder): SkSp<GradientAdapter> {
      TODO("Implement make")
    }
  }
}
