 ...
 * ```
 */
public data class TArraytrue<T> public constructor(
  /**
   * C++ original:
   * ```cpp
   ...
   * ```
   */
  public var skSpan: TArray<T, MEM_MOVE>,
  /**
   * C++ original:
   * ```cpp
   * static constexpr double kGrowing = 1.5
   ...
   * ```
   */
  private fun setDataFromBytes(allocation: SkSpan<Byte>) {
    TODO("Implement setDataFromBytes")
  }
   ...
   * ```
   */
  private fun setData(array: SkSpan<T>) {
   ...
   * ```
   */
  private fun unpoison() {
    TODO("Implement unpoison")
  }
   ...
   * ```
   */
  private fun changeSize(n: Int) {
    TODO("Implement changeSize")
  }

  public companion object {
    private val kGrowing: Double = TODO("Initialize kGrowing")

    private val kMinHeapAllocCount: Int = TODO("Initialize kMinHeapAllocCount")

    private val kMaxCapacity: Int = TODO("Initialize kMaxCapacity")
