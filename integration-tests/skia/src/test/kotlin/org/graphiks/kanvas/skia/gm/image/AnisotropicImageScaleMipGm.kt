...
/**
 * Port of Skia's `gm/anisotropic.cpp` — mip-map sampling variant.
 *
 * Same radiating-line image as the linear/aniso variants, drawn into a grid
 * of progressively squashed rects using bilinear mipmap sampling.
