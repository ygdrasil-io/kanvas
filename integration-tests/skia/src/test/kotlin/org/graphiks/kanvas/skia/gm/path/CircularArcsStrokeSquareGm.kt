...
/**
 * Port of Skia's `gm/circulararcs.cpp::CircularArcsStrokeSquareGM`.
 * 4-quadrant grid of stroked drawArc cells with kSquare_Cap.
...
class CircularArcsStrokeSquareGm : SkiaGm {
    ...
    override fun draw(canvas: GmCanvas, width: Int, height: Int) {
        drawGrid(canvas, 0f, 0f, useCenter = false, aa = false, style = PaintStyle.STROKE, strokeWidth = 15f, cap = StrokeCap.SQUARE)
        drawGrid(canvas, kW / 2f, 0f, useCenter = true, aa = false, style = PaintStyle.STROKE, strokeWidth = 15f, cap = StrokeCap.SQUARE)
        drawGrid(canvas, 0f, kH / 2f, useCenter = false, aa = true, style = PaintStyle.STROKE, strokeWidth = 15f, cap = StrokeCap.SQUARE)
        drawGrid(canvas, kW / 2f, kH / 2f, useCenter = true, aa = true, style = PaintStyle.STROKE, strokeWidth = 15f, cap = StrokeCap.SQUARE)
