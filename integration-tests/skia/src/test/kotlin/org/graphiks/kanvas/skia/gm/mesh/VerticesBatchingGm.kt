...
class VerticesBatchingGm : SkiaGm {
    ...
    private companion object {
        ...
        val MESH_TEX_COORDS = listOf(
            Point2F32(0f, 0f), Point2F32(K_SHADER_SIZE / 2f, 0f), Point2F32(K_SHADER_SIZE, 0f),
            Point2F32(0f, K_SHADER_SIZE / 2f), Point2F32(K_SHADER_SIZE / 2f, K_SHADER_SIZE / 2f), Point2F32(K_SHADER_SIZE, K_SHADER_SIZE / 2f),
            Point2F32(0f, K_SHADER_SIZE), Point2F32(K_SHADER_SIZE / 2f, K_SHADER_SIZE), Point2F32(K_SHADER_SIZE, K_SHADER_SIZE),
        )
    }
}
