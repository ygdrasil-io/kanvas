...
class GradientsColorSpaceManyStopsGm : SkiaGm {
    ...
    override fun draw(canvas: GmCanvas, width: Int, height: Int) {
        canvas.drawRect(
            ...
            Paint(color = ColorARGB.fromRGBA(0x80 / 255f, 0x80 / 255f, 0x80 / 255f, 1f))
        )
        ...
        for (i in 0 until stopCount) {
            ...
            stops.add(GradientStop(
                ...
                ColorARGB.fromRGBA(r / 255f, g / 255f, b / 255f, 1f)
            ))
        }
        
        val paint = Paint(shader = Shader.LinearGradient(
            start = Point2F32(0f, 0f), end = Point2F32(500f, 500f),
            stops = stops, tileMode = TileMode.CLAMP,
        ))
        canvas.drawRect(RectF32(0f, 0f, 500f, 500f), paint)
    }
}
