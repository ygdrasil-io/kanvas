 ...
 * ; close()) drawn into the PathCapsFillsGrid matrix : 3 cap/join
...
class CubicClosePathGm : SkiaGm {
    ...
    private val title = "Cubic Closed Drawn Into Rectangle Clips With " +
    ...
    override fun draw(canvas: GmCanvas, width: Int, height: Int) {
        // Draw title - for now skip as drawString is not available on GmCanvas
