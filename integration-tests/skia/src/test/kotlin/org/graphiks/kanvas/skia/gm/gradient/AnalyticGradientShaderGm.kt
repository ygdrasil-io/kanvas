...
class AnalyticGradientShaderGm : SkiaGm {
    ...
    private fun shadeRect(canvas: GmCanvas, shader: Shader, cellRow: Int, cellCol: Int) {
        ...
        canvas.drawRect(RectF32(0f, 0f, RECT_WIDTH.toFloat(), RECT_HEIGHT.toFloat()), paint)
        canvas.restore()
    }
    ...
    private companion object {
        ...
        val COLORS: List<ColorARGB> = listOf(
            ColorARGB.fromRGBA(0x44 / 255f, 0x44 / 255f, 0x44 / 255f, 1f),
            ...
            ColorARGB.fromRGBA(0xCC / 255f, 0xCC / 255f, 0xCC / 255f, 1f),
        )
    }
}
