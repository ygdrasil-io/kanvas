...
/**
 * Port of Skia's `gm/circulararcs.cpp::CircularArcsFillGM`.
 * 4-quadrant grid of filled drawArc cells.
...
class CircularArcsFillGm : SkiaGm {
    ...
    override fun draw(canvas: GmCanvas, width: Int, height: Int) {
        drawGrid(canvas, 0f, 0f, useCenter = false, aa = false, style = PaintStyle.FILL, strokeWidth = 15f)
        drawGrid(canvas, kW / 2f, 0f, useCenter = true, aa = false, style = PaintStyle.FILL, strokeWidth = 15f)
        drawGrid(canvas, 0f, kH / 2f, useCenter = false, aa = true, style = PaintStyle.FILL, strokeWidth = 15f)
        drawGrid(canvas, kW / 2f, kH / 2f, useCenter = true, aa = true, style = PaintStyle.FILL, strokeWidth = 15f)
