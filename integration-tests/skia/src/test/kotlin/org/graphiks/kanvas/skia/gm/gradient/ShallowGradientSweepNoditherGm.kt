...
/**
 * Port of Skia's `gm/shallowgradient.cpp` (sweep no-dither).
 * 800×800 sweep gradient 0xFF555555 → 0xFF444444, no dither.
 * @see https://github.com/google/skia/blob/main/gm/shallowgradient.cpp
 */
class ShallowGradientSweepNoditherGm : SkiaGm {
    override val name = "shallow_gradient_sweep_nodither"
