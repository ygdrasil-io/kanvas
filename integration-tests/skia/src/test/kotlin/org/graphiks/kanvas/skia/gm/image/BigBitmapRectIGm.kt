...
class BigBitmapRectIGm : SkiaGm {
    ...
    override fun draw(canvas: GmCanvas, width: Int, height: Int) {
        ...
        val srcR2 = RectF32.ofLTRB(4085.0f, 10.0f, 4087.0f, 12.0f)
        val dstR2 = RectF32.ofLTRB(10f, 410f, 30f, 430f)

        canvas.drawImageRect(img, RectF32.ofOriginSize(0f, 0f, srcR1.width(), srcR1.height()), dstR1, paint)
        canvas.drawImageRect(img, RectF32.ofOriginSize(srcR2.left, srcR2.top, srcR2.width(), srcR2.height()), dstR2, paint)
    }
}
