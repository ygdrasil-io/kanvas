...
/**
 * Port of Skia's `gm/shallowgradient.cpp` (radial dither).
 * 800×800 radial gradient 0xFF555555 → 0xFF444444 with dither enabled.
 * @see https://github.com/google/skia/blob/main/gm/shallowgradient.cpp
 */
class ShallowGradientRadialGm : SkiaGm {
    override val name = "shallow_gradient_radial"
