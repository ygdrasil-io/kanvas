...
class VeryLargeBitmapGm : SkiaGm {
    ...
    private fun showImage(canvas: GmCanvas, width: Int, height: Int, c1: ColorARGB, c2: ColorARGB) {
    ...
    private fun makeRasterImage(width: Int, height: Int, c1: ColorARGB, c2: ColorARGB): Image {
