 ...
 */
class ColorspaceGm : SkiaGm {
    override val name = "colorspace"
    ...
    override fun draw(canvas: GmCanvas, width0: Int, height0: Int) {
        canvas.drawString("colorspace: not color-managed (sRGB default)", 10f, 20f, font, Paint())

        val w = 128f
        val h = 128f
        val paint = Paint(color = ColorARGB.fromPackedUInt(0xFF4080FFu))
