...
/**
 * Port of Skia's `gm/anisotropic.cpp` — linear sampling variant.
 *
 * Stress-test for image scaling under a linear filter. A 256x256 synthetic
 * source image (100 thin radial lines on white background) is sampled into a
 * grid of progressively-squashed rects.
 * @see https://github.com/google/skia/blob/main/gm/anisotropic.cpp
 */
class AnisotropicImageScaleLinearGm : SkiaGm {
    override val name = "anisotropic_image_scale_linear"
