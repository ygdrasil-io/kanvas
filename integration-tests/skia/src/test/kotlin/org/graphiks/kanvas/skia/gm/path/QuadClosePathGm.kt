 ...
 * Closed quad path (moveTo(25, 10) ; quadTo(50, 20, 75, 10) ; close())
 * drawn into the PathCapsFillsGrid matrix: 3 cap/join combos x 4 fill
 * rules (incl. kInverse*) x 3 paint styles (fill / stroke / strokeAndFill).
