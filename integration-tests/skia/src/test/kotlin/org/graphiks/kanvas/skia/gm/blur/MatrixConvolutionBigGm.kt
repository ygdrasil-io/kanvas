...
class MatrixConvolutionBigGm : SkiaGm {
    ...
    override fun draw(canvas: GmCanvas, width: Int, height: Int) {
        ...
        canvas.drawRect(RectF32(30f, 30f, 470f, 130f), Paint(color = ColorARGB.fromRGBA(0.2f, 0.4f, 0.8f, 1f)))
        canvas.drawRect(RectF32(30f, 160f, 470f, 270f), Paint(color = ColorARGB.fromRGBA(0.8f, 0.3f, 0.1f, 1f)))
    }
}
