 ...
 * 800×800 two-point conical gradient 0xFF555555 → 0xFF444444 with dither enabled.
 * @see https://github.com/google/skia/blob/main/gm/shallowgradient.cpp
 */
class ShallowGradientConicalGm : SkiaGm {
    override val name = "shallow_gradient_conical"
