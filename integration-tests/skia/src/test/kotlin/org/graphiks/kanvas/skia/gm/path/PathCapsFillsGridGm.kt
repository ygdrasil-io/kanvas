...
/**
 * Port of Skia's `gm/linepaths.cpp`, `gm/cubicpaths.cpp`, `gm/quadpaths.cpp`.
 *
 * Shared grid layout for path caps and fills testing.
 *
 * @see https://github.com/google/skia/blob/main/gm/linepaths.cpp
 */
class PathCapsFillsGridGm : SkiaGm {
    override val name = "pathcapsfillsgrid"
