...
/**
 * Port of Skia's `gm/path_stroke_with_zero_length.cpp::zero_length_paths_bw` (522 × 398).
 *
 * Tests rendering of zero-length stroked paths with every combination of
 * 3 stroke caps × 6 stroke widths × 10 path verbs, without AA.
 ...
 */
class ZeroLengthPathsBwGm : SkiaGm {
    override val name = "zero_length_paths_bw"
