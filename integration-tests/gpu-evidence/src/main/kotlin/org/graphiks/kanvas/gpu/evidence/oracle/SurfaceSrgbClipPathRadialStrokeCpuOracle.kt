...
/**
 * Independent device-space oracle for one opaque butt/miter radial stroke clipped by a
 * single winding triangle. The contract is intentionally limited to a two-point segment.
 */
class SurfaceSrgbClipPathRadialStrokeCpuOracle(
