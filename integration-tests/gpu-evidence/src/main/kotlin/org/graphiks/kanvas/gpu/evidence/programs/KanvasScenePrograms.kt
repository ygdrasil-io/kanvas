...
object KanvasScenePrograms {
    ...
    /** The reversed horizontal radius-two round-cap route under an integral translation. */
    fun translatedReverseHorizontalRoundCapStroke() = KanvasSurfaceProgram(ROUTE_ID, record = {
        save()
        translate(3f, 2f)
        drawPath(
            Path {
    ...
    /** The reversed horizontal radius-two round-cap route under an integral device scissor. */
    fun scissoredReverseHorizontalRoundCapStroke() = KanvasSurfaceProgram(ROUTE_ID, record = {
        save()
    ...
    /** The scale-two round-cap route under an integral affine translation. */
    fun uniformlyScaledTranslatedRoundCapStroke() = KanvasSurfaceProgram(ROUTE_ID, record = {
        save()
        translate(4f, 6f)
        scale(2f, 2f)
        drawPath(
    ...
    /** The scale-two round-cap route for a vertical integral-grid segment. */
    fun uniformlyScaledVerticalRoundCapStroke() = KanvasSurfaceProgram(ROUTE_ID, record = {
        save()
        scale(2f, 2f)
        drawPath(
            Path {
    ...
    /** The scale-two round-cap route for a translated vertical integral-grid segment. */
    fun uniformlyScaledTranslatedVerticalRoundCapStroke() = KanvasSurfaceProgram(ROUTE_ID, record = {
        save()
        translate(4f, 6f)
        scale(2f, 2f)
        drawPath(
    ...
    /** The scale-two round-cap route for a translated reversed horizontal integral-grid segment. */
    fun uniformlyScaledTranslatedReverseRoundCapStroke() = KanvasSurfaceProgram(ROUTE_ID, record = {
        save()
        translate(4f, 6f)
        scale(2f, 2f)
        drawPath(
