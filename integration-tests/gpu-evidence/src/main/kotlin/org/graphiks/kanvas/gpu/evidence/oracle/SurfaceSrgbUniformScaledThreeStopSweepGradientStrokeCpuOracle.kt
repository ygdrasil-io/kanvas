...
/** Independent device-space oracle for a uniformly scaled three-stop full sweep stroke. */
class SurfaceSrgbUniformScaledThreeStopSweepGradientStrokeCpuOracle(
    ...
    override fun render(width: Int, height: Int): ByteArray {
        ...
        for (y in 0 until height) for (x in 0 until width) {
            ...
            val t = ((atan2(y + .5 - deviceCenter.y, x + .5 - deviceCenter.x) * 180.0 / PI + 360.0) % 360.0) / 360.0
