...
/** Independent pixel-center oracle for a solid path stroke intersected with a device scissor. */
class SurfaceSrgbSolidStrokeScissorCpuOracle(
    ...
    init {
        ...
        require(strokeWidth > 0.0 && lengthSquared > 0.0) { "stroke must be positive and non-degenerate" }
