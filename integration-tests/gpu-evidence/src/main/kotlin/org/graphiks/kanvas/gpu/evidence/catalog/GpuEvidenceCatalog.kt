...
object GpuEvidenceCatalog {
    val renderCases: List<EvidenceCase> = listOf(
        ...
        uniformlyScaledTranslatedRoundCapStroke(),
        uniformlyScaledVerticalRoundCapStroke(),
        ...
        verticalDashedButtMiterStroke(),
        reverseHorizontalDashedButtMiterStroke(),
        reverseVerticalDashedButtMiterStroke(),
        phaseShiftedVerticalDashedButtMiterStroke(),
        scissoredVerticalDashedButtMiterStroke(),
        translatedVerticalDashedButtMiterStroke(),
        uniformlyScaledHorizontalDashedButtMiterStroke(),
        uniformlyScaledVerticalDashedButtMiterStroke(),
        uniformlyScaledTranslatedHorizontalDashedButtMiterStroke(),
        uniformlyScaledTranslatedVerticalDashedButtMiterStroke(),
        quarterTurnHorizontalDashedButtMiterStroke(),
        halfTurnVerticalDashedButtMiterStroke(),
        scissoredHorizontalDashedButtMiterStroke(),
        translatedHorizontalDashedButtMiterStroke(),
        phaseShiftedHorizontalDashedButtMiterStroke(),
        scissoredPhaseShiftedHorizontalDashedButtMiterStroke(),
...
sweepGradientTwoStopStrokeRect(),
        ...
        clipPathLocalRadialMatrixSquareStroke(),
        ...
        clipPathSweepSquareStrokeWindingDifference(),
        ...
        clipPathRightAngleDiagonalButtStrokeWinding(),
        clipPathRightAngleDiagonalSquareStrokeWinding(),
    ...
    private fun threeStopSweepStrokeUnderWindingRefusal() = surfaceRefusal(
        id = "three-stop-sweep-stroke-winding-refusal",
        title = "Three-stop sweep stroke under winding clip refusal",
        description = "Public Kanvas Surface refuses a non-AA butt/miter path stroke using a three-stop CLAMP sweep gradient under a winding path clip; the bounded native sweep mapping currently admits two stops only.",
    ...
    private fun quarterTurnRoundCapStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("quarter-turn-round-cap-stroke"),
            "Pixel-exact quarter-turn round-cap path stroke",
            ...
            32,
            1L,
            setOf("path-stroke", "round-cap", "quarter-turn", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-round-cap-stroke-vertical", 2),
            ComparisonPolicy(0, 100.0, 1, "Independent pixel-center disk oracle for the integral-grid vertical result of the quarter-turn contract."),
            emptySet(),
        ),
        KanvasScenePrograms.quarterTurnRoundCapStroke(),
        SurfaceSrgbRoundCapVerticalStrokeCpuOracle(
            startY = 8.0,
            endY = 20.0,
            centerX = 12.0,
    ...
    private fun halfTurnRoundCapStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("half-turn-round-cap-stroke"),
            "Pixel-exact half-turn round-cap path stroke",
            "Public Kanvas Surface non-AA radius-two vertical round-cap path rotated exactly 180 degrees onto the integral device grid.",
            32,
            32,
            1L,
            setOf("path-stroke", "round-cap", "half-turn", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-round-cap-stroke-vertical", 2),
            ComparisonPolicy(0, 100.0, 1, "Independent pixel-center disk oracle for the integral-grid vertical result of the half-turn contract."),
            emptySet(),
        ),
    ...
    private fun reverseVerticalRoundCapStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("reverse-vertical-round-cap-stroke"),
            "Pixel-exact reverse vertical round-cap path stroke",
            "Public Kanvas Surface non-AA integral-grid vertical radius-two round-cap path with its source contour recorded from bottom to top.",
            32,
            32,
            1L,
            setOf("path-stroke", "round-cap", "vertical", "reverse", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-round-cap-stroke-vertical", 2),
            ComparisonPolicy(0, 100.0, 1, "Independent pixel-center disk oracle for the direction-invariant integral-grid vertical contract."),
            emptySet(),
        ),
        KanvasScenePrograms.reverseVerticalRoundCapStroke(),
        SurfaceSrgbRoundCapVerticalStrokeCpuOracle(
            startY = 6.0,
            endY = 26.0,
            centerX = 16.0,
    ...
    private fun reverseHorizontalRoundCapStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("reverse-horizontal-round-cap-stroke"),
            "Pixel-exact reverse horizontal round-cap path stroke",
            "Public Kanvas Surface non-AA integral-grid horizontal radius-two round-cap path with its source contour recorded from right to left.",
            32,
            32,
            1L,
            setOf("path-stroke", "round-cap", "horizontal", "reverse", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-round-cap-stroke", 2),
            ComparisonPolicy(0, 100.0, 1, "Independent pixel-center disk oracle for the direction-invariant integral-grid horizontal contract."),
            emptySet(),
        ),
        KanvasScenePrograms.reverseHorizontalRoundCapStroke(),
    ...
    private fun translatedReverseHorizontalRoundCapStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("translated-reverse-horizontal-round-cap-stroke"),
            "Pixel-exact translated reverse horizontal round-cap path stroke",
            "Public Kanvas Surface non-AA integral-grid horizontal radius-two round-cap path translated by an integral device offset and recorded from right to left.",
            32,
            32,
            1L,
            setOf("path-stroke", "round-cap", "horizontal", "reverse", "translated", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-round-cap-stroke", 2),
            ComparisonPolicy(0, 100.0, 1, "Independent pixel-center disk oracle for the direction-invariant translated integral-grid horizontal contract."),
            emptySet(),
        ),
        KanvasScenePrograms.translatedReverseHorizontalRoundCapStroke(),
        SurfaceSrgbRoundCapStrokeCpuOracle(
            startX = 9.0,
            endX = 29.0,
            centerY = 18.0,
    ...
    private fun scissoredReverseHorizontalRoundCapStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("scissored-reverse-horizontal-round-cap-stroke"),
            "Pixel-exact scissored reverse horizontal round-cap path stroke",
            "Public Kanvas Surface non-AA integral-grid horizontal radius-two round-cap path recorded from right to left and intersected with an integral device scissor.",
            32,
            32,
            1L,
            setOf("path-stroke", "round-cap", "horizontal", "reverse", "scissor", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-round-cap-stroke-scissor", 2),
            ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent reverse horizontal round-cap union intersected with the integral device scissor."),
            emptySet(),
        ),
        KanvasScenePrograms.scissoredReverseHorizontalRoundCapStroke(),
    ...
    private fun translatedScissoredReverseHorizontalRoundCapStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("translated-scissored-reverse-horizontal-round-cap-stroke"),
            "Pixel-exact translated scissored reverse horizontal round-cap path stroke",
            "Public Kanvas Surface non-AA integral-grid horizontal radius-two round-cap path recorded from right to left, translated by an integral offset, and intersected with an integral device scissor.",
            32,
            32,
            1L,
            setOf("path-stroke", "round-cap", "horizontal", "reverse", "translation", "scissor", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-round-cap-stroke-translated-scissor", 2),
            ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent translated reverse horizontal round-cap union intersected with the integral device scissor."),
            emptySet(),
        ),
        KanvasScenePrograms.translatedScissoredReverseHorizontalRoundCapStroke(),
        SurfaceSrgbRoundCapStrokeScissorCpuOracle(
            startX = 9.0,
            endX = 29.0,
            centerY = 18.0,
    ...
    private fun translatedScissoredReverseVerticalRoundCapStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("translated-scissored-reverse-vertical-round-cap-stroke"),
            "Pixel-exact translated scissored reverse vertical round-cap path stroke",
            "Public Kanvas Surface non-AA integral-grid vertical radius-two round-cap path recorded from bottom to top, translated by an integral offset, and intersected with an integral device scissor.",
            32,
            32,
            1L,
            setOf("path-stroke", "round-cap", "vertical", "reverse", "translation", "scissor", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-round-cap-stroke-vertical-scissor", 2),
            ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent translated reverse vertical round-cap union intersected with the integral device scissor."),
            emptySet(),
        ),
        KanvasScenePrograms.translatedScissoredReverseVerticalRoundCapStroke(),
        SurfaceSrgbRoundCapVerticalStrokeScissorCpuOracle(
            startY = 9.0,
            endY = 29.0,
            centerX = 18.0,
    ...
    private fun uniformlyScaledTranslatedRoundCapStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("uniformly-scaled-translated-round-cap-stroke"),
            "Uniformly scaled translated round-cap path stroke",
            "Public Kanvas Surface non-AA horizontal round-cap path stroke at width four under scale two and an integral affine translation.",
            64,
            64,
            1L,
            setOf("path-stroke", "round-cap", "horizontal", "uniform-scale", "translation", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-round-cap-stroke-uniform-scale-translate", 2),
            ComparisonPolicy(0, 100.0, 1, "Independent pixel-center disk oracle for the integral device radius-four result after scale and translation."),
            emptySet(),
        ),
        KanvasScenePrograms.uniformlyScaledTranslatedRoundCapStroke(),
        SurfaceSrgbRoundCapStrokeCpuOracle(
            startX = 20.0,
            endX = 52.0,
            centerY = 38.0,
    ...
    private fun uniformlyScaledVerticalRoundCapStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("uniformly-scaled-vertical-round-cap-stroke"),
            "Uniformly scaled vertical round-cap path stroke",
            "Public Kanvas Surface non-AA vertical round-cap path stroke at width four under a bounded positive uniform scale of two.",
            64,
            64,
            1L,
            setOf("path-stroke", "round-cap", "vertical", "uniform-scale", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-round-cap-stroke-uniform-scale-vertical", 2),
            ComparisonPolicy(0, 100.0, 1, "Independent pixel-center disk oracle for the integral device radius-four vertical result of the promoted scale-two contract."),
            emptySet(),
        ),
        KanvasScenePrograms.uniformlyScaledVerticalRoundCapStroke(),
        SurfaceSrgbRoundCapVerticalStrokeCpuOracle(
            startY = 16.0,
            endY = 48.0,
            centerX = 32.0,
    ...
    private fun uniformlyScaledTranslatedVerticalRoundCapStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("uniformly-scaled-translated-vertical-round-cap-stroke"),
            "Uniformly scaled translated vertical round-cap path stroke",
            "Public Kanvas Surface non-AA vertical round-cap path stroke at width four under scale two and an integral affine translation.",
            64,
            64,
            1L,
            setOf("path-stroke", "round-cap", "vertical", "uniform-scale", "translation", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-round-cap-stroke-uniform-scale-translate-vertical", 2),
            ComparisonPolicy(0, 100.0, 1, "Independent pixel-center disk oracle for the integral device radius-four vertical result after scale and translation."),
            emptySet(),
        ),
        KanvasScenePrograms.uniformlyScaledTranslatedVerticalRoundCapStroke(),
        SurfaceSrgbRoundCapVerticalStrokeCpuOracle(
            startY = 22.0,
            endY = 54.0,
            centerX = 36.0,
    ...
    private fun uniformlyScaledReverseRoundCapStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("uniformly-scaled-reverse-round-cap-stroke"),
            "Uniformly scaled reverse round-cap path stroke",
            "Public Kanvas Surface non-AA reversed horizontal round-cap path stroke at width four under a bounded positive uniform scale of two.",
            64,
            64,
            1L,
            setOf("path-stroke", "round-cap", "horizontal", "reverse", "uniform-scale", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-round-cap-stroke-uniform-scale", 2),
            ComparisonPolicy(0, 100.0, 1, "Independent pixel-center disk oracle for the direction-invariant integral device radius-four result of the promoted scale-two contract."),
            emptySet(),
        ),
        KanvasScenePrograms.uniformlyScaledReverseRoundCapStroke(),
        SurfaceSrgbRoundCapStrokeCpuOracle(
            startX = 16.0,
            endX = 48.0,
            centerY = 32.0,
    ...
    private fun uniformlyScaledTranslatedReverseRoundCapStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("uniformly-scaled-translated-reverse-round-cap-stroke"),
            "Uniformly scaled translated reverse round-cap path stroke",
            "Public Kanvas Surface non-AA reversed horizontal round-cap path stroke at width four under scale two and an integral affine translation.",
            64,
            64,
            1L,
            setOf("path-stroke", "round-cap", "horizontal", "reverse", "uniform-scale", "translation", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-round-cap-stroke-uniform-scale-translate", 2),
            ComparisonPolicy(0, 100.0, 1, "Independent pixel-center disk oracle for the direction-invariant integral device radius-four result after scale and translation."),
            emptySet(),
        ),
        KanvasScenePrograms.uniformlyScaledTranslatedReverseRoundCapStroke(),
        SurfaceSrgbRoundCapStrokeCpuOracle(
            startX = 20.0,
            endX = 52.0,
            centerY = 38.0,
    ...
    private fun horizontalHairline(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("horizontal-hairline"),
            "Horizontal hairline",
            "Public Kanvas Surface zero-width non-AA horizontal hairline on an integral device row.",
            32,
            32,
            1L,
            setOf("path-hairline", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-hairline-direct-device-quad", 2),
            ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent one-pixel device-row hairline coverage oracle."),
            emptySet(),
        ),
        KanvasScenePrograms.horizontalHairline(),
        SurfaceSrgbHairlineCpuOracle(
            startX = 4.0,
            endX = 28.0,
            centerY = 16.0,
    ...
    private fun horizontalSquareMiterStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("horizontal-square-miter-stroke"),
            "Horizontal square miter stroke",
            "Public Kanvas Surface non-AA horizontal width-four square-cap miter stroke on integral device coordinates.",
            32,
            32,
            1L,
            setOf("path-stroke", "square-cap", "horizontal", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-solid-stroke", 2),
            ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent pixel-center stroke oracle with square cap extension."),
            emptySet(),
        ),
        KanvasScenePrograms.horizontalSquareMiterStroke(),
        SurfaceSrgbSolidStrokeCpuOracle(
            strokeStartX = 8.0,
            strokeStartY = 16.0,
            strokeEndX = 24.0,
    ...
    private fun diagonalSquareMiterStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("diagonal-square-miter-stroke"),
            "Diagonal square miter stroke",
            "Public Kanvas Surface non-AA diagonal width-four square-cap miter stroke with fractional endpoints.",
            32,
            32,
            1L,
            setOf("path-stroke", "square-cap", "diagonal", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-solid-stroke", 2),
            ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent pixel-center stroke oracle with tangent-aligned cap extension."),
            emptySet(),
        ),
        KanvasScenePrograms.diagonalSquareMiterStroke(),
        SurfaceSrgbSolidStrokeCpuOracle(
            strokeStartX = 5.25,
            strokeStartY = 8.25,
            strokeEndX = 21.25,
    ...
    private fun scaledButtMiterStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("scaled-butt-miter-stroke"),
            "Scaled butt miter stroke",
            "Public Kanvas Surface non-AA horizontal width-four butt-cap miter stroke produced by a uniform 2x device transform.",
            32,
            32,
            1L,
            setOf("path-stroke", "butt-cap", "uniform-scale", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-solid-stroke", 2),
            ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent transformed device-space stroke oracle."),
            emptySet(),
        ),
        KanvasScenePrograms.scaledButtMiterStroke(),
        SurfaceSrgbSolidStrokeCpuOracle(
            strokeStartX = 8.0,
            strokeStartY = 16.0,
            strokeEndX = 28.0,
    ...
    private fun scaledTranslatedButtMiterStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("scaled-translated-butt-miter-stroke"),
            "Scaled translated butt miter stroke",
            "Public Kanvas Surface non-AA horizontal width-four butt-cap miter stroke produced by a uniform 2x scale and integral translation.",
            32,
            32,
            1L,
            setOf("path-stroke", "butt-cap", "uniform-scale", "translation", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-solid-stroke", 2),
            ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent translated device-space stroke oracle."),
            emptySet(),
        ),
        KanvasScenePrograms.scaledTranslatedButtMiterStroke(),
        SurfaceSrgbSolidStrokeCpuOracle(
            strokeStartX = 10.0,
            strokeStartY = 19.0,
            strokeEndX = 30.0,
    ...
    private fun scaledTranslatedDiagonalButtMiterStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("scaled-translated-diagonal-butt-miter-stroke"),
            "Scaled translated diagonal butt miter stroke",
            "Public Kanvas Surface non-AA diagonal width-four butt-cap miter stroke under a uniform 2x scale and integral translation.",
            32,
            32,
            1L,
            setOf("path-stroke", "butt-cap", "diagonal", "uniform-scale", "translation", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-solid-stroke", 2),
            ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent transformed finite-segment oracle."),
            emptySet(),
        ),
        KanvasScenePrograms.scaledTranslatedDiagonalButtMiterStroke(),
        SurfaceSrgbSolidStrokeCpuOracle(
            strokeStartX = 10.25,
            strokeStartY = 11.25,
            strokeEndX = 26.25,
    ...
    private fun horizontalButtMiterStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("horizontal-butt-miter-stroke"),
            "Horizontal butt miter stroke",
            "Public Kanvas Surface non-AA horizontal width-four butt-cap miter stroke on integral device coordinates.",
            32,
            32,
            1L,
            setOf("path-stroke", "butt-cap", "horizontal", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-solid-stroke", 2),
            ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent finite-segment pixel-center oracle."),
            emptySet(),
        ),
        KanvasScenePrograms.horizontalButtMiterStroke(),
        SurfaceSrgbSolidStrokeCpuOracle(
            strokeStartX = 4.0,
            strokeStartY = 16.0,
            strokeEndX = 28.0,
    ...
    private fun verticalDashedButtMiterStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("vertical-dashed-butt-miter-stroke"),
            "Vertical dashed butt miter stroke",
            "Public Kanvas Surface non-AA vertical width-four butt-cap miter stroke with the bounded repeating 8-on/4-off dash route.",
            32,
            32,
            1L,
            setOf("path-stroke", "path-effect", "dash", "butt-cap", "vertical", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-dashed-stroke-vertical", 1),
            ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent pixel-center vertical dashed-stroke oracle."),
            emptySet(),
        ),
        KanvasScenePrograms.verticalDashedButtMiterStroke(),
        SurfaceSrgbDashedStrokeCpuOracle(
            strokeStartX = 16.0,
            strokeStartY = 4.0,
            strokeEndX = 16.0,
    ...
    private fun reverseHorizontalDashedButtMiterStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("reverse-horizontal-dashed-butt-miter-stroke"),
            "Reverse horizontal dashed butt miter stroke",
            "Public Kanvas Surface non-AA horizontal width-four butt-cap miter stroke traversed from right to left with the bounded repeating 8-on/4-off dash route.",
            32,
            32,
            1L,
            setOf("path-stroke", "path-effect", "dash", "butt-cap", "horizontal", "reverse-direction", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-dashed-stroke-reverse-horizontal", 1),
            ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent pixel-center oracle evaluated along the source path direction."),
            emptySet(),
        ),
        KanvasScenePrograms.reverseHorizontalDashedButtMiterStroke(),
        SurfaceSrgbDashedStrokeCpuOracle(
            strokeStartX = 28.0,
            strokeStartY = 16.0,
            strokeEndX = 4.0,
    ...
    private fun reverseVerticalDashedButtMiterStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("reverse-vertical-dashed-butt-miter-stroke"),
            "Reverse vertical dashed butt miter stroke",
            "Public Kanvas Surface non-AA vertical width-four butt-cap miter stroke traversed from bottom to top with the bounded repeating 8-on/4-off dash route.",
            32,
            32,
            1L,
            setOf("path-stroke", "path-effect", "dash", "butt-cap", "vertical", "reverse-direction", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-dashed-stroke-reverse-vertical", 1),
            ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent pixel-center oracle evaluated along the reverse vertical source path direction."),
            emptySet(),
        ),
        KanvasScenePrograms.reverseVerticalDashedButtMiterStroke(),
        SurfaceSrgbDashedStrokeCpuOracle(
            strokeStartX = 16.0,
            strokeStartY = 28.0,
            strokeEndX = 16.0,
    ...
    private fun phaseShiftedVerticalDashedButtMiterStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("phase-shifted-vertical-dashed-butt-miter-stroke"),
            "Phase-shifted vertical dashed butt miter stroke",
            "Public Kanvas Surface non-AA vertical width-four butt-cap miter stroke with the admitted four-pixel phase of the bounded repeating 8-on/4-off dash route.",
            32,
            32,
            1L,
            setOf("path-stroke", "path-effect", "dash", "dash-phase", "butt-cap", "vertical", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-dashed-stroke-phase-four-vertical", 1),
            ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent phase-aware vertical dashed-stroke oracle."),
            emptySet(),
        ),
        KanvasScenePrograms.phaseShiftedVerticalDashedButtMiterStroke(),
        SurfaceSrgbDashedStrokeCpuOracle(
            strokeStartX = 16.0,
            strokeStartY = 4.0,
            strokeEndX = 16.0,
    ...
    private fun scissoredVerticalDashedButtMiterStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("scissored-vertical-dashed-butt-miter-stroke"),
            "Scissored vertical dashed butt miter stroke",
            "Public Kanvas Surface non-AA vertical width-four butt-cap miter stroke with the bounded repeating 8-on/4-off dash route clipped by an integral device scissor.",
            32,
            32,
            1L,
            setOf("path-stroke", "path-effect", "dash", "butt-cap", "vertical", "scissor", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-dashed-stroke-vertical-scissor", 1),
            ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent vertical dashed-stroke oracle intersected with the integral device scissor."),
            emptySet(),
        ),
        KanvasScenePrograms.scissoredVerticalDashedButtMiterStroke(),
        SurfaceSrgbDashedStrokeCpuOracle(
            strokeStartX = 16.0,
            strokeStartY = 4.0,
            strokeEndX = 16.0,
    ...
    private fun translatedVerticalDashedButtMiterStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("translated-vertical-dashed-butt-miter-stroke"),
            "Translated vertical dashed butt miter stroke",
            "Public Kanvas Surface non-AA vertical width-four butt-cap miter stroke with the bounded repeating 8-on/4-off dash route under integral translation (3,2).",
            32,
            32,
            1L,
            setOf("path-stroke", "path-effect", "dash", "butt-cap", "vertical", "translate", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-dashed-stroke-translated-vertical", 1),
            ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent translated vertical dashed-stroke oracle."),
            emptySet(),
        ),
        KanvasScenePrograms.translatedVerticalDashedButtMiterStroke(),
        SurfaceSrgbDashedStrokeCpuOracle(
            strokeStartX = 19.0,
            strokeStartY = 6.0,
            strokeEndX = 19.0,
    ...
    private fun uniformlyScaledHorizontalDashedButtMiterStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("uniformly-scaled-horizontal-dashed-butt-miter-stroke"),
            "Uniformly scaled horizontal dashed butt miter stroke",
            "Public Kanvas Surface non-AA horizontal width-four butt-cap miter stroke with the bounded repeating 8-on/4-off dash route under positive uniform scale 2.",
            32,
            32,
            1L,
            setOf("path-stroke", "path-effect", "dash", "butt-cap", "horizontal", "uniform-scale", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-dashed-stroke-uniform-scale", 1),
            ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent device-space uniformly scaled dashed-stroke oracle."),
            emptySet(),
        ),
        KanvasScenePrograms.uniformlyScaledHorizontalDashedButtMiterStroke(),
        SurfaceSrgbDashedStrokeCpuOracle(
            strokeStartX = 8.0,
            strokeStartY = 16.0,
            strokeEndX = 28.0,
            strokeEndY = 16.0,
            strokeWidth = 8.0,
            dashIntervals = listOf(16.0, 8.0),
            dashPhase = 0.0,
            color = intArrayOf(255, 0, 0, 255),
        ),
    )

    private fun uniformlyScaledVerticalDashedButtMiterStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("uniformly-scaled-vertical-dashed-butt-miter-stroke"),
            "Uniformly scaled vertical dashed butt miter stroke",
            "Public Kanvas Surface non-AA vertical width-four butt-cap miter stroke with the bounded repeating 8-on/4-off dash route under positive uniform scale 2.",
            32,
            32,
            1L,
            setOf("path-stroke", "path-effect", "dash", "butt-cap", "vertical", "uniform-scale", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-dashed-stroke-uniform-scale-vertical", 1),
            ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent device-space uniformly scaled vertical dashed-stroke oracle."),
            emptySet(),
        ),
        KanvasScenePrograms.uniformlyScaledVerticalDashedButtMiterStroke(),
        SurfaceSrgbDashedStrokeCpuOracle(
            strokeStartX = 16.0,
            strokeStartY = 8.0,
            strokeEndX = 16.0,
    ...
    private fun uniformlyScaledTranslatedHorizontalDashedButtMiterStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("uniformly-scaled-translated-horizontal-dashed-butt-miter-stroke"),
            "Uniformly scaled translated horizontal dashed butt miter stroke",
            "Public Kanvas Surface non-AA horizontal width-four butt-cap miter stroke with the bounded repeating 8-on/4-off dash route under scale 2 and integral translation (2,4).",
            32,
            32,
            1L,
            setOf("path-stroke", "path-effect", "dash", "butt-cap", "horizontal", "uniform-scale", "translate", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-dashed-stroke-uniform-scale-translate", 1),
            ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent device-space scale-plus-translation dashed-stroke oracle."),
            emptySet(),
        ),
        KanvasScenePrograms.uniformlyScaledTranslatedHorizontalDashedButtMiterStroke(),
        SurfaceSrgbDashedStrokeCpuOracle(
            strokeStartX = 10.0,
            strokeStartY = 12.0,
            strokeEndX = 30.0,
    ...
    private fun uniformlyScaledTranslatedVerticalDashedButtMiterStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("uniformly-scaled-translated-vertical-dashed-butt-miter-stroke"),
            "Uniformly scaled translated vertical dashed butt miter stroke",
            "Public Kanvas Surface non-AA vertical width-four butt-cap miter stroke with the bounded repeating 8-on/4-off dash route under scale 2 and integral translation (2,4).",
            32,
            32,
            1L,
            setOf("path-stroke", "path-effect", "dash", "butt-cap", "vertical", "uniform-scale", "translate", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-dashed-stroke-uniform-scale-translate-vertical", 1),
            ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent device-space scale-plus-translation vertical dashed-stroke oracle."),
            emptySet(),
        ),
        KanvasScenePrograms.uniformlyScaledTranslatedVerticalDashedButtMiterStroke(),
        SurfaceSrgbDashedStrokeCpuOracle(
            strokeStartX = 18.0,
            strokeStartY = 10.0,
            strokeEndX = 18.0,
    ...
    private fun quarterTurnHorizontalDashedButtMiterStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("quarter-turn-horizontal-dashed-butt-miter-stroke"),
            "Quarter-turn horizontal dashed butt miter stroke",
            "Public Kanvas Surface non-AA horizontal width-four butt-cap miter stroke with the bounded repeating 8-on/4-off dash route after an exact clockwise quarter-turn and integral translation.",
            32,
            32,
            1L,
            setOf("path-stroke", "path-effect", "dash", "butt-cap", "vertical", "right-angle-rotation", "quarter-turn", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-dashed-stroke-quarter-turn", 1),
            ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent device-space quarter-turn dashed-stroke oracle."),
            emptySet(),
        ),
        KanvasScenePrograms.quarterTurnHorizontalDashedButtMiterStroke(),
        SurfaceSrgbDashedStrokeCpuOracle(
            strokeStartX = 12.0,
            strokeStartY = 8.0,
            strokeEndX = 12.0,
    ...
    private fun halfTurnVerticalDashedButtMiterStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("half-turn-vertical-dashed-butt-miter-stroke"),
            "Half-turn vertical dashed butt miter stroke",
            "Public Kanvas Surface non-AA vertical width-four butt-cap miter stroke with the bounded repeating 8-on/4-off dash route after an exact half-turn and integral translation.",
            32,
            32,
            1L,
            setOf("path-stroke", "path-effect", "dash", "butt-cap", "vertical", "right-angle-rotation", "half-turn", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-dashed-stroke-half-turn", 1),
            ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent device-space half-turn dashed-stroke oracle evaluated along the transformed path direction."),
            emptySet(),
        ),
        KanvasScenePrograms.halfTurnVerticalDashedButtMiterStroke(),
        SurfaceSrgbDashedStrokeCpuOracle(
            strokeStartX = 24.0,
            strokeStartY = 28.0,
            strokeEndX = 24.0,
    ...
    private fun scissoredHorizontalDashedButtMiterStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("scissored-horizontal-dashed-butt-miter-stroke"),
            "Scissored horizontal dashed butt miter stroke",
            "Public Kanvas Surface non-AA bounded repeating 8-on/4-off dash stroke clipped by an integral device scissor.",
            32,
            32,
            1L,
            setOf("path-stroke", "path-effect", "dash", "butt-cap", "scissor", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-dashed-stroke-scissor", 1),
            ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent dashed-stroke oracle intersected with the integral device scissor."),
            emptySet(),
        ),
        KanvasScenePrograms.scissoredHorizontalDashedButtMiterStroke(),
        SurfaceSrgbDashedStrokeCpuOracle(
            strokeStartX = 4.0,
            strokeStartY = 16.0,
            strokeEndX = 28.0,
    ...
    private fun phaseShiftedHorizontalDashedButtMiterStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("phase-shifted-horizontal-dashed-butt-miter-stroke"),
            "Phase-shifted horizontal dashed butt miter stroke",
            "Public Kanvas Surface non-AA bounded repeating 8-on/4-off dash stroke with the admitted four-pixel phase shift.",
            32,
            32,
            1L,
            setOf("path-stroke", "path-effect", "dash", "dash-phase", "butt-cap", "horizontal", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-dashed-stroke-phase-four", 1),
            ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent phase-aware dashed-stroke oracle."),
            emptySet(),
        ),
        KanvasScenePrograms.phaseShiftedHorizontalDashedButtMiterStroke(),
        SurfaceSrgbDashedStrokeCpuOracle(
            strokeStartX = 4.0,
            strokeStartY = 16.0,
            strokeEndX = 28.0,
    ...
    private fun scissoredPhaseShiftedHorizontalDashedButtMiterStroke(): EvidenceCase = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("scissored-phase-shifted-horizontal-dashed-butt-miter-stroke"),
            "Scissored phase-shifted horizontal dashed butt miter stroke",
            "Public Kanvas Surface non-AA bounded repeating 8-on/4-off dash stroke with phase four, clipped by an integral device scissor.",
            32,
            32,
            1L,
            setOf("path-stroke", "path-effect", "dash", "dash-phase", "butt-cap", "horizontal", "scissor", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-dashed-stroke-phase-four-scissor", 1),
            ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent phase-aware dashed-stroke oracle intersected with the integral device scissor."),
            emptySet(),
        ),
        KanvasScenePrograms.scissoredPhaseShiftedHorizontalDashedButtMiterStroke(),
        SurfaceSrgbDashedStrokeCpuOracle(
            strokeStartX = 4.0,
            strokeStartY = 16.0,
            strokeEndX = 28.0,
    ...
    private fun clipPathLocalRadialMatrixSquareStroke() = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("clip-path-local-radial-matrix-square-stroke"),
            "Local-matrix radial square stroke inside hard path clip",
            "Public Kanvas Surface hard non-AA Winding triangle clip with one opaque two-stop clamp radial square-cap miter path stroke and a bounded translated shader local matrix.",
            64,
            64,
            1L,
            setOf("clip-path", "radial-gradient", "stroke", "hard-clip", "shader-local-matrix", "square-cap", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-clip-path-radial-local-matrix-square-stroke-device-space", 1),
            ComparisonPolicy(1, 100.0, 1, "Independent device-space clip, square stroke coverage, translated local-matrix radial sampling and linear-light interpolation."),
            emptySet(),
        ),
        KanvasScenePrograms.clipPathLocalRadialMatrixSquareStroke(),
        SurfaceSrgbClipPathRadialStrokeCpuOracle(
            background = intArrayOf(13, 20, 33, 255),
            points = listOf(
                SurfaceSrgbClipPathRadialStrokeCpuOracle.Point(7.25, 6.25),
    ...
    private fun clipPathSweepSquareStrokeWindingDifference() = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("clip-path-sweep-square-stroke-winding-difference"),
            "Winding Difference sweep square stroke",
            "Public Kanvas Surface hard non-AA Winding Difference triangle clip around one opaque full-turn two-stop sweep square-cap miter stroke.",
            64,
            64,
            1L,
            setOf("clip-path", "sweep-gradient", "stroke", "winding", "difference", "hard-clip", "square-cap", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-clip-path-sweep-winding-difference-device-space", 1),
            ComparisonPolicy(1, 100.0, 1, "Independent pixel-center exterior of a Winding Difference triangle, square stroke distance and full-turn linear-light sweep interpolation."),
            emptySet(),
        ),
        KanvasScenePrograms.clipPathSweepSquareStrokeWindingDifference(),
        SurfaceSrgbClipPathSweepStrokeCpuOracle(
            background = intArrayOf(13, 20, 33, 255),
            points = listOf(
                SurfaceSrgbClipPathSweepStrokeCpuOracle.Point(7.25, 6.25),
    ...
    private fun clipPathLinearGradientButtStrokeInverseWinding() = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("clip-path-linear-gradient-butt-stroke-inverse-winding"),
            "Inverse Winding clip with a linear-gradient butt stroke",
            "Public Kanvas Surface hard non-AA inverse-Winding triangle clip around one opaque two-stop clamp linear-gradient butt-cap miter stroke.",
            64,
            64,
            1L,
            setOf("clip-path", "linear-gradient", "stroke", "inverse-winding", "hard-clip", "butt-cap", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-clip-path-linear-gradient-inverse-winding-butt-stroke-device-space", 1),
            ComparisonPolicy(0, 100.0, 1, "Exact opaque RGBA8 output from independent inverse Winding triangle, butt stroke coverage and clamp linear-gradient interpolation."),
            emptySet(),
        ),
        KanvasScenePrograms.clipPathLinearGradientButtStrokeInverseWinding(),
        SurfaceSrgbClipPathLinearGradientStrokeCpuOracle(
            background = intArrayOf(13, 20, 33, 255),
            points = listOf(
                SurfaceSrgbClipPathLinearGradientStrokeCpuOracle.Point(7.25, 6.25),
    ...
    private fun clipPathLinearGradientRightAngleButtStrokeWinding() = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("clip-path-linear-gradient-right-angle-butt-stroke-winding"),
            "Right-angle Winding clip with a linear-gradient butt stroke",
            "Public Kanvas Surface hard non-AA Winding triangle clip around one opaque two-stop clamp linear-gradient butt-cap miter stroke rotated by 90 degrees.",
            64,
            64,
            1L,
            setOf("clip-path", "linear-gradient", "stroke", "winding", "hard-clip", "butt-cap", "right-angle-rotation", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-clip-path-linear-gradient-right-angle-winding-butt-stroke-device-space", 1),
            ComparisonPolicy(0, 100.0, 1, "Exact opaque RGBA8 output from independent right-angle device-space Winding triangle, butt stroke coverage and vertical clamp linear-gradient interpolation."),
            emptySet(),
        ),
        KanvasScenePrograms.clipPathLinearGradientRightAngleButtStrokeWinding(),
        SurfaceSrgbClipPathLinearGradientStrokeCpuOracle(
            background = intArrayOf(13, 20, 33, 255),
            points = listOf(
                SurfaceSrgbClipPathLinearGradientStrokeCpuOracle.Point(27.75, 4.25),
                SurfaceSrgbClipPathLinearGradientStrokeCpuOracle.Point(27.75, 27.25),
                SurfaceSrgbClipPathLinearGradientStrokeCpuOracle.Point(4.75, 4.25),
            ),
            strokeStart = SurfaceSrgbClipPathLinearGradientStrokeCpuOracle.Point(23.75, 8.25),
            strokeEnd = SurfaceSrgbClipPathLinearGradientStrokeCpuOracle.Point(17.75, 20.25),
            strokeWidth = 4.0,
            gradientStart = SurfaceSrgbClipPathLinearGradientStrokeCpuOracle.Point(0.0, 0.0),
    ...
    private fun clipPathLinearGradientRightAngleSquareStrokeWinding() = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("clip-path-linear-gradient-right-angle-square-stroke-winding"),
            "Right-angle Winding clip with a linear-gradient square stroke",
            "Public Kanvas Surface hard non-AA Winding triangle clip around one opaque two-stop clamp linear-gradient square-cap miter stroke rotated by 90 degrees.",
            64,
            64,
            1L,
            setOf("clip-path", "linear-gradient", "stroke", "winding", "hard-clip", "square-cap", "right-angle-rotation", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-clip-path-linear-gradient-right-angle-winding-square-stroke-device-space", 1),
            ComparisonPolicy(0, 100.0, 1, "Exact opaque RGBA8 output from independent right-angle device-space Winding triangle, square stroke coverage and vertical clamp linear-gradient interpolation."),
            emptySet(),
        ),
        KanvasScenePrograms.clipPathLinearGradientRightAngleSquareStrokeWinding(),
        SurfaceSrgbClipPathLinearGradientStrokeCpuOracle(
            background = intArrayOf(13, 20, 33, 255),
            points = listOf(
                SurfaceSrgbClipPathLinearGradientStrokeCpuOracle.Point(27.75, 4.25),
    ...
    private fun clipPathDiagonalSquareStrokeWinding() = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("clip-path-diagonal-square-stroke-winding"),
            "Winding clip with a diagonal square stroke",
            "Public Kanvas Surface hard non-AA Winding triangle clip around one opaque width-four diagonal square-cap miter stroke.",
            64,
            64,
            1L,
            setOf("clip-path", "stroke", "winding", "hard-clip", "square-cap", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-clip-path-diagonal-square-stroke-device-space", 1),
            ComparisonPolicy(0, 100.0, 1, "Exact opaque RGBA8 output from independent device-space Winding triangle and square stroke coverage."),
            emptySet(),
        ),
        KanvasScenePrograms.clipPathDiagonalSquareStrokeWinding(),
        SurfaceSrgbClipPathSolidStrokeCpuOracle(
            background = intArrayOf(13, 20, 33, 255),
            points = listOf(
                SurfaceSrgbClipPathSolidStrokeCpuOracle.Point(7.25, 6.25),
                SurfaceSrgbClipPathSolidStrokeCpuOracle.Point(30.25, 6.25),
                SurfaceSrgbClipPathSolidStrokeCpuOracle.Point(7.25, 29.25),
            ),
            strokeStart = SurfaceSrgbClipPathSolidStrokeCpuOracle.Point(5.25, 8.25),
            strokeEnd = SurfaceSrgbClipPathSolidStrokeCpuOracle.Point(21.25, 20.25),
            strokeWidth = 4.0,
            color = intArrayOf(255, 0, 0, 255),
            squareCaps = true,
        ),
    ...
    private fun clipPathTranslatedRadialSquareStrokeWinding() = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("clip-path-translated-radial-square-stroke-winding"),
            "Scaled translated Winding clip with a radial square stroke",
            "Public Kanvas Surface hard non-AA Winding triangle clip around one opaque two-stop clamp radial square-cap miter stroke under a uniform scale and translation.",
            64,
            64,
            1L,
            setOf("clip-path", "radial-gradient", "stroke", "winding", "hard-clip", "square-cap", "uniform-scale", "translation", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-clip-path-translated-radial-square-stroke-device-space", 1),
            ComparisonPolicy(1, 100.0, 1, "Independent transformed device-space Winding triangle, square stroke coverage and linear-light radial interpolation."),
            emptySet(),
        ),
        KanvasScenePrograms.clipPathTranslatedRadialSquareStrokeWinding(),
        SurfaceSrgbClipPathRadialStrokeCpuOracle(
            background = intArrayOf(13, 20, 33, 255),
            points = listOf(
                SurfaceSrgbClipPathRadialStrokeCpuOracle.Point(2.25, 2.25),
                SurfaceSrgbClipPathRadialStrokeCpuOracle.Point(31.25, 2.25),
                SurfaceSrgbClipPathRadialStrokeCpuOracle.Point(2.25, 31.25),
            ),
            strokeStart = SurfaceSrgbClipPathRadialStrokeCpuOracle.Point(8.5625, 9.3125),
            strokeEnd = SurfaceSrgbClipPathRadialStrokeCpuOracle.Point(28.5625, 24.3125),
            strokeWidth = 5.0,
            center = SurfaceSrgbClipPathRadialStrokeCpuOracle.Point(22.0, 19.0),
            radius = 20.0,
            startColor = intArrayOf(255, 0, 0, 255),
            endColor = intArrayOf(0, 0, 255, 255),
            squareCaps = true,
    ...
    private fun clipPathRightAngleDiagonalButtStrokeWinding() = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("clip-path-right-angle-diagonal-butt-stroke-winding"),
            "Right-angle Winding clip with a diagonal butt stroke",
            "Public Kanvas Surface hard non-AA Winding triangle clip around one opaque width-four diagonal butt-cap miter stroke rotated by 90 degrees around a bounded pivot.",
            64,
            64,
            1L,
            setOf("clip-path", "stroke", "winding", "hard-clip", "butt-cap", "right-angle-rotation", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-clip-path-right-angle-diagonal-butt-stroke-device-space", 1),
            ComparisonPolicy(0, 100.0, 1, "Exact opaque RGBA8 output from independent right-angle device-space Winding triangle and butt stroke coverage."),
            emptySet(),
        ),
        KanvasScenePrograms.clipPathRightAngleDiagonalButtStrokeWinding(),
        SurfaceSrgbClipPathSolidStrokeCpuOracle(
            background = intArrayOf(13, 20, 33, 255),
            points = listOf(
                SurfaceSrgbClipPathSolidStrokeCpuOracle.Point(27.75, 4.25),
                SurfaceSrgbClipPathSolidStrokeCpuOracle.Point(27.75, 27.25),
                SurfaceSrgbClipPathSolidStrokeCpuOracle.Point(4.75, 4.25),
            ),
            strokeStart = SurfaceSrgbClipPathSolidStrokeCpuOracle.Point(23.75, 8.25),
            strokeEnd = SurfaceSrgbClipPathSolidStrokeCpuOracle.Point(17.75, 20.25),
            strokeWidth = 4.0,
            color = intArrayOf(255, 0, 0, 255),
        ),
    )

    private fun clipPathRightAngleDiagonalSquareStrokeWinding() = EvidenceCase(
        EvidenceSceneDescriptor(
            EvidenceSceneId("clip-path-right-angle-diagonal-square-stroke-winding"),
            "Right-angle Winding clip with a diagonal square stroke",
            "Public Kanvas Surface hard non-AA Winding triangle clip around one opaque width-four diagonal square-cap miter stroke rotated by 90 degrees around a bounded pivot.",
            64,
            64,
            1L,
            setOf("clip-path", "stroke", "winding", "hard-clip", "square-cap", "right-angle-rotation", "kanvas-surface"),
            EvidenceExpectation.ShouldRender,
            OraclePolicy.GeneratedCpu("surface-srgb-clip-path-right-angle-diagonal-square-stroke-device-space", 1),
            ComparisonPolicy(0, 100.0, 1, "Exact opaque RGBA8 output from independent right-angle device-space Winding triangle and square stroke coverage."),
            emptySet(),
        ),
        KanvasScenePrograms.clipPathRightAngleDiagonalSquareStrokeWinding(),
        SurfaceSrgbClipPathSolidStrokeCpuOracle(
            background = intArrayOf(13, 20, 33, 255),
            points = listOf(
                SurfaceSrgbClipPathSolidStrokeCpuOracle.Point(27.75, 4.25),
