...
class GpuEvidenceCatalogOracleTest {
    ...
    @Test
    fun `diagonal square miter stroke extends along the tangent`() {
        val pixels = oracle("diagonal-square-miter-stroke", 32, 32)

        assertPixel(pixels, 32, 32, 4, 7, intArrayOf(255, 0, 0, 255))
        assertPixel(pixels, 32, 32, 22, 21, intArrayOf(255, 0, 0, 255))
        assertPixel(pixels, 32, 32, 2, 7, intArrayOf(0, 0, 0, 0))
        assertPixel(pixels, 32, 32, 23, 22, intArrayOf(0, 0, 0, 0))
    }

    @Test
    fun `scaled butt miter stroke preserves the transformed device rectangle`() {
        val pixels = oracle("scaled-butt-miter-stroke", 32, 32)

        assertPixel(pixels, 32, 32, 8, 14, intArrayOf(255, 0, 0, 255))
        assertPixel(pixels, 32, 32, 27, 17, intArrayOf(255, 0, 0, 255))
        assertPixel(pixels, 32, 32, 8, 13, intArrayOf(0, 0, 0, 0))
        assertPixel(pixels, 32, 32, 28, 14, intArrayOf(0, 0, 0, 0))
    }

    @Test
    fun `scaled translated butt miter stroke rebases the device rectangle`() {
        val pixels = oracle("scaled-translated-butt-miter-stroke", 32, 32)

        assertPixel(pixels, 32, 32, 10, 17, intArrayOf(255, 0, 0, 255))
        assertPixel(pixels, 32, 32, 29, 20, intArrayOf(255, 0, 0, 255))
        assertPixel(pixels, 32, 32, 10, 16, intArrayOf(0, 0, 0, 0))
        assertPixel(pixels, 32, 32, 30, 19, intArrayOf(0, 0, 0, 0))
    }

    @Test
    fun `scaled translated diagonal butt miter stroke preserves transformed coverage`() {
        val pixels = oracle("scaled-translated-diagonal-butt-miter-stroke", 32, 32)

        assertPixel(pixels, 32, 32, 10, 11, intArrayOf(255, 0, 0, 255))
        assertPixel(pixels, 32, 32, 25, 20, intArrayOf(255, 0, 0, 255))
        assertPixel(pixels, 32, 32, 9, 11, intArrayOf(0, 0, 0, 0))
        assertPixel(pixels, 32, 32, 27, 21, intArrayOf(0, 0, 0, 0))
    }

    @Test
    fun `scaled translated diagonal square miter stroke extends along transformed tangent`() {
        val pixels = oracle("scaled-translated-diagonal-square-miter-stroke", 32, 32)

        assertPixel(pixels, 32, 32, 9, 10, intArrayOf(255, 0, 0, 255))
        assertPixel(pixels, 32, 32, 27, 21, intArrayOf(255, 0, 0, 255))
        assertPixel(pixels, 32, 32, 7, 10, intArrayOf(0, 0, 0, 0))
        assertPixel(pixels, 32, 32, 29, 22, intArrayOf(0, 0, 0, 0))
    }

    @Test
    fun `horizontal butt miter stroke keeps finite endpoints`() {
        val pixels = oracle("horizontal-butt-miter-stroke", 32, 32)

        assertPixel(pixels, 32, 32, 4, 14, intArrayOf(255, 0, 0, 255))
        assertPixel(pixels, 32, 32, 27, 17, intArrayOf(255, 0, 0, 255))
        assertPixel(pixels, 32, 32, 3, 16, intArrayOf(0, 0, 0, 0))
        assertPixel(pixels, 32, 32, 28, 16, intArrayOf(0, 0, 0, 0))
    }
