...
class GpuEvidenceCatalogTest {
    ...
    fun `catalog separates one hundred public surface renders from nine refusals`() {
        ...
        assertEquals(
            List(101) { "kanvas.surface.render" },
            GpuEvidenceCatalog.renderCases.map { assertIs<KanvasSurfaceProgram>(it.program).routeId },
        )
        assertEquals(101, GpuEvidenceCatalog.renderCases.size)
        assertEquals(110, GpuEvidenceCatalog.cases.size)
