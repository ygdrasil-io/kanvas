...
class GpuEvidenceCatalogTest {
    ...
    @Test
    fun `catalog separates one hundred twelve public surface renders from nine refusals`() {
        ...
        assertEquals(
            List(112) { "kanvas.surface.render" },
            GpuEvidenceCatalog.renderCases.map { assertIs<KanvasSurfaceProgram>(it.program).routeId },
        )
        assertEquals(112, GpuEvidenceCatalog.renderCases.size)
        assertEquals(121, GpuEvidenceCatalog.cases.size)
