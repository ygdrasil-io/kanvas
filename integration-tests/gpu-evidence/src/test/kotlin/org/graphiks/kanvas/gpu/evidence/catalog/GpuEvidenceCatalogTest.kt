...
class GpuEvidenceCatalogTest {
    ...
    @Test
    fun `catalog separates one hundred eleven public surface renders from nine refusals`() {
        ...
        assertEquals(
            List(111) { "kanvas.surface.render" },
            GpuEvidenceCatalog.renderCases.map { assertIs<KanvasSurfaceProgram>(it.program).routeId },
        )
        assertEquals(111, GpuEvidenceCatalog.renderCases.size)
        assertEquals(120, GpuEvidenceCatalog.cases.size)
