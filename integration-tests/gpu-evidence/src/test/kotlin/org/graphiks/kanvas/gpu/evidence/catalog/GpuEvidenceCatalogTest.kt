...
class GpuEvidenceCatalogTest {
    ...
    @Test
    fun `catalog separates one hundred thirteen public surface renders from nine refusals`() {
        ...
        assertEquals(
            List(113) { "kanvas.surface.render" },
            GpuEvidenceCatalog.renderCases.map { assertIs<KanvasSurfaceProgram>(it.program).routeId },
        )
        assertEquals(113, GpuEvidenceCatalog.renderCases.size)
        assertEquals(122, GpuEvidenceCatalog.cases.size)
