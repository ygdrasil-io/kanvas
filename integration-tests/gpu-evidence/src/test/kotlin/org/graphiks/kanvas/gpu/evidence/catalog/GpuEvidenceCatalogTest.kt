...
class GpuEvidenceCatalogTest {
    ...
    fun `catalog separates one hundred seventy-five public surface renders from seventeen refusals`() {
        ...
        assertEquals(
            listOf(
                ...
                "translated-scissored-reverse-horizontal-round-cap-stroke",
                "translated-reverse-vertical-round-cap-stroke",
                "translated-scissored-reverse-vertical-round-cap-stroke",
                "uniformly-scaled-round-cap-stroke",
                "uniformly-scaled-translated-round-cap-stroke",
                "uniformly-scaled-vertical-round-cap-stroke",
                ...
                "clip-path-local-radial-matrix-square-stroke",
                "clip-path-right-angle-radial-square-stroke",
                "clip-path-sweep-square-stroke",
                "clip-path-local-sweep-matrix-stroke",
                "clip-path-sweep-square-stroke-even-odd-hole",
                ...
                "clip-path-sweep-butt-stroke-inverse-winding",
                "clip-path-sweep-square-stroke-right-angle-winding",
                "clip-path-sweep-butt-stroke-winding",
                "clip-path-linear-gradient-square-stroke-winding",
                "clip-path-linear-gradient-butt-stroke-winding",
                "clip-path-linear-gradient-scaled-translated-butt-stroke-winding",
                "clip-path-linear-gradient-butt-stroke-winding-difference",
                "clip-path-linear-gradient-butt-stroke-even-odd-hole",
                "clip-path-linear-gradient-butt-stroke-inverse-winding",
                "clip-path-linear-gradient-right-angle-butt-stroke-winding",
                "clip-path-linear-gradient-right-angle-square-stroke-winding",
                ...
                "clip-path-right-angle-diagonal-butt-stroke-winding",
                "clip-path-right-angle-diagonal-square-stroke-winding",
        ...
        assertEquals(
            List(188) { "kanvas.surface.render" },
            GpuEvidenceCatalog.renderCases.map { assertIs<KanvasSurfaceProgram>(it.program).routeId },
        )
        assertEquals(188, GpuEvidenceCatalog.renderCases.size)
        assertEquals(205, GpuEvidenceCatalog.cases.size)
    ...
    fun `catalog locks exact product routes policies and oracle identities`() {
        ...
        assertEquals(
            mapOf(
                ...
                "translated-scissored-reverse-horizontal-round-cap-stroke" to OraclePolicy.GeneratedCpu("surface-srgb-round-cap-stroke-translated-scissor", 2),
                "translated-reverse-vertical-round-cap-stroke" to OraclePolicy.GeneratedCpu("surface-srgb-round-cap-stroke-vertical", 2),
                "translated-scissored-reverse-vertical-round-cap-stroke" to OraclePolicy.GeneratedCpu("surface-srgb-round-cap-stroke-vertical-scissor", 2),
                "uniformly-scaled-round-cap-stroke" to OraclePolicy.GeneratedCpu("surface-srgb-round-cap-stroke-uniform-scale", 2),
                "uniformly-scaled-translated-round-cap-stroke" to OraclePolicy.GeneratedCpu("surface-srgb-round-cap-stroke-uniform-scale-translate", 2),
                "uniformly-scaled-vertical-round-cap-stroke" to OraclePolicy.GeneratedCpu("surface-srgb-round-cap-stroke-uniform-scale-vertical", 2),
                ...
                "diagonal-butt-miter-stroke" to OraclePolicy.GeneratedCpu("surface-srgb-solid-stroke", 2),
                "diagonal-square-miter-stroke" to OraclePolicy.GeneratedCpu("surface-srgb-solid-stroke", 2),
                "scaled-butt-miter-stroke" to OraclePolicy.GeneratedCpu("surface-srgb-solid-stroke", 2),
                "scaled-translated-butt-miter-stroke" to OraclePolicy.GeneratedCpu("surface-srgb-solid-stroke", 2),
                "scaled-translated-diagonal-butt-miter-stroke" to OraclePolicy.GeneratedCpu("surface-srgb-solid-stroke", 2),
                "scaled-translated-diagonal-square-miter-stroke" to OraclePolicy.GeneratedCpu("surface-srgb-solid-stroke", 2),
                "horizontal-butt-miter-stroke" to OraclePolicy.GeneratedCpu("surface-srgb-solid-stroke", 2),
                ...
                "horizontal-dashed-butt-miter-stroke" to OraclePolicy.GeneratedCpu("surface-srgb-dashed-stroke", 1),
                "vertical-dashed-butt-miter-stroke" to OraclePolicy.GeneratedCpu("surface-srgb-dashed-stroke-vertical", 1),
                "reverse-horizontal-dashed-butt-miter-stroke" to OraclePolicy.GeneratedCpu("surface-srgb-dashed-stroke-reverse-horizontal", 1),
                "reverse-vertical-dashed-butt-miter-stroke" to OraclePolicy.GeneratedCpu("surface-srgb-dashed-stroke-reverse-vertical", 1),
                "phase-shifted-vertical-dashed-butt-miter-stroke" to OraclePolicy.GeneratedCpu("surface-srgb-dashed-stroke-phase-four-vertical", 1),
                "scissored-vertical-dashed-butt-miter-stroke" to OraclePolicy.GeneratedCpu("surface-srgb-dashed-stroke-vertical-scissor", 1),
                "translated-vertical-dashed-butt-miter-stroke" to OraclePolicy.GeneratedCpu("surface-srgb-dashed-stroke-translated-vertical", 1),
                ...
                "scissored-phase-shifted-horizontal-dashed-butt-miter-stroke" to OraclePolicy.GeneratedCpu("surface-srgb-dashed-stroke-phase-four-scissor", 1),
                ...
                "clip-path-local-radial-matrix-square-stroke" to OraclePolicy.GeneratedCpu("surface-srgb-clip-path-radial-local-matrix-square-stroke-device-space", 1),
                ...
                "clip-path-sweep-square-stroke" to OraclePolicy.GeneratedCpu("surface-srgb-clip-path-sweep-stroke-device-space", 1),
                "clip-path-local-sweep-matrix-stroke" to OraclePolicy.GeneratedCpu("surface-srgb-clip-path-sweep-stroke-device-space", 1),
                "clip-path-sweep-square-stroke-even-odd-hole" to OraclePolicy.GeneratedCpu("surface-srgb-clip-path-sweep-even-odd-hole-stroke-device-space", 1),
                ...
                "clip-path-sweep-butt-stroke-inverse-winding" to OraclePolicy.GeneratedCpu("surface-srgb-clip-path-sweep-inverse-winding-butt-stroke-device-space", 1),
                "clip-path-sweep-square-stroke-right-angle-winding" to OraclePolicy.GeneratedCpu("surface-srgb-clip-path-sweep-right-angle-winding-device-space", 1),
                "clip-path-sweep-butt-stroke-winding" to OraclePolicy.GeneratedCpu("surface-srgb-clip-path-sweep-winding-butt-stroke-device-space", 1),
                "clip-path-linear-gradient-square-stroke-winding" to OraclePolicy.GeneratedCpu("surface-srgb-clip-path-linear-gradient-winding-square-stroke-device-space", 1),
                "clip-path-linear-gradient-butt-stroke-winding" to OraclePolicy.GeneratedCpu("surface-srgb-clip-path-linear-gradient-winding-butt-stroke-device-space", 1),
                "clip-path-linear-gradient-scaled-translated-butt-stroke-winding" to OraclePolicy.GeneratedCpu("surface-srgb-clip-path-linear-gradient-scaled-translated-winding-butt-stroke-device-space", 1),
                "clip-path-linear-gradient-butt-stroke-winding-difference" to OraclePolicy.GeneratedCpu("surface-srgb-clip-path-linear-gradient-winding-difference-butt-stroke-device-space", 1),
                "clip-path-linear-gradient-butt-stroke-even-odd-hole" to OraclePolicy.GeneratedCpu("surface-srgb-clip-path-linear-gradient-even-odd-hole-butt-stroke-device-space", 1),
                "clip-path-linear-gradient-butt-stroke-inverse-winding" to OraclePolicy.GeneratedCpu("surface-srgb-clip-path-linear-gradient-inverse-winding-butt-stroke-device-space", 1),
                "clip-path-linear-gradient-right-angle-butt-stroke-winding" to OraclePolicy.GeneratedCpu("surface-srgb-clip-path-linear-gradient-right-angle-winding-butt-stroke-device-space", 1),
                "clip-path-linear-gradient-right-angle-square-stroke-winding" to OraclePolicy.GeneratedCpu("surface-srgb-clip-path-linear-gradient-right-angle-winding-square-stroke-device-space", 1),
                ...
                "clip-path-right-angle-diagonal-butt-stroke-winding" to OraclePolicy.GeneratedCpu("surface-srgb-clip-path-right-angle-diagonal-butt-stroke-device-space", 1),
                "clip-path-right-angle-diagonal-square-stroke-winding" to OraclePolicy.GeneratedCpu("surface-srgb-clip-path-right-angle-diagonal-square-stroke-device-space", 1),
        ...
        assertEquals(
            mapOf(
                ...
                "translated-scissored-reverse-horizontal-round-cap-stroke" to ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent translated reverse horizontal round-cap union intersected with the integral device scissor."),
                "translated-reverse-vertical-round-cap-stroke" to ComparisonPolicy(0, 100.0, 1, "Independent pixel-center disk oracle for the direction-invariant translated integral-grid vertical contract."),
                "translated-scissored-reverse-vertical-round-cap-stroke" to ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent translated reverse vertical round-cap union intersected with the integral device scissor."),
                "uniformly-scaled-round-cap-stroke" to ComparisonPolicy(0, 100.0, 1, "Independent pixel-center disk oracle for the integral device radius-four result of the promoted scale-two contract."),
                "uniformly-scaled-translated-round-cap-stroke" to ComparisonPolicy(0, 100.0, 1, "Independent pixel-center disk oracle for the integral device radius-four result after scale and translation."),
                "uniformly-scaled-vertical-round-cap-stroke" to ComparisonPolicy(0, 100.0, 1, "Independent pixel-center disk oracle for the integral device radius-four vertical result of the promoted scale-two contract."),
                ...
                "diagonal-butt-miter-stroke" to ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent pixel-center finite-segment oracle."),
                "diagonal-square-miter-stroke" to ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent pixel-center stroke oracle with tangent-aligned cap extension."),
                "scaled-butt-miter-stroke" to ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent transformed device-space stroke oracle."),
                "scaled-translated-butt-miter-stroke" to ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent translated device-space stroke oracle."),
                "scaled-translated-diagonal-butt-miter-stroke" to ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent transformed finite-segment oracle."),
                "scaled-translated-diagonal-square-miter-stroke" to ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent transformed tangent-extended stroke oracle."),
                "horizontal-butt-miter-stroke" to ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent finite-segment pixel-center oracle."),
                ...
                "horizontal-dashed-butt-miter-stroke" to ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent pixel-center dashed-stroke oracle."),
                "vertical-dashed-butt-miter-stroke" to ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent pixel-center vertical dashed-stroke oracle."),
                "reverse-horizontal-dashed-butt-miter-stroke" to ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent pixel-center oracle evaluated along the source path direction."),
                "reverse-vertical-dashed-butt-miter-stroke" to ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent pixel-center oracle evaluated along the reverse vertical source path direction."),
                "phase-shifted-vertical-dashed-butt-miter-stroke" to ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent phase-aware vertical dashed-stroke oracle."),
                "scissored-vertical-dashed-butt-miter-stroke" to ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent vertical dashed-stroke oracle intersected with the integral device scissor."),
                "translated-vertical-dashed-butt-miter-stroke" to ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent translated vertical dashed-stroke oracle."),
                ...
                "scissored-phase-shifted-horizontal-dashed-butt-miter-stroke" to ComparisonPolicy(0, 100.0, 1, "Exact transparent RGBA8 output from an independent phase-aware dashed-stroke oracle intersected with the integral device scissor."),
                ...
                "clip-path-local-radial-matrix-square-stroke" to ComparisonPolicy(1, 100.0, 1, "Independent device-space clip, square stroke coverage, translated local-matrix radial sampling and linear-light interpolation."),
                ...
                "clip-path-sweep-square-stroke" to ComparisonPolicy(1, 100.0, 1, "Independent pixel-center winding clip, square stroke distance and full-turn linear-light sweep interpolation."),
                "clip-path-local-sweep-matrix-stroke" to ComparisonPolicy(1, 100.0, 1, "Independent device-space clip/stroke coverage with translated local-matrix full-turn sweep sampling and linear-light interpolation."),
                "clip-path-sweep-square-stroke-even-odd-hole" to ComparisonPolicy(1, 100.0, 1, "Independent pixel-center EvenOdd rectangle XOR, square stroke distance and full-turn linear-light sweep interpolation."),
                ...
                "clip-path-sweep-butt-stroke-inverse-winding" to ComparisonPolicy(1, 100.0, 1, "Independent pixel-center inverse Winding triangle membership, butt stroke distance and full-turn linear-light sweep interpolation."),
                "clip-path-sweep-square-stroke-right-angle-winding" to ComparisonPolicy(1, 100.0, 1, "Independent right-angle device-space Winding triangle, square stroke distance and quarter-turn-adjusted linear-light sweep interpolation."),
                "clip-path-sweep-butt-stroke-winding" to ComparisonPolicy(1, 100.0, 1, "Independent pixel-center Winding triangle membership, butt stroke distance and full-turn linear-light sweep interpolation."),
                "clip-path-linear-gradient-square-stroke-winding" to ComparisonPolicy(0, 100.0, 1, "Exact opaque RGBA8 output from independent pixel-center Winding triangle, square stroke coverage and clamp linear-gradient interpolation."),
                "clip-path-linear-gradient-butt-stroke-winding" to ComparisonPolicy(0, 100.0, 1, "Exact opaque RGBA8 output from independent pixel-center Winding triangle, butt stroke coverage and clamp linear-gradient interpolation."),
                "clip-path-linear-gradient-scaled-translated-butt-stroke-winding" to ComparisonPolicy(0, 100.0, 1, "Exact opaque RGBA8 output from independent transformed device-space Winding triangle, butt stroke coverage and inverse-transformed clamp linear-gradient interpolation."),
                "clip-path-linear-gradient-butt-stroke-winding-difference" to ComparisonPolicy(0, 100.0, 1, "Exact opaque RGBA8 output from independent inverse pixel-center Winding triangle, butt stroke coverage and clamp linear-gradient interpolation."),
                "clip-path-linear-gradient-butt-stroke-even-odd-hole" to ComparisonPolicy(0, 100.0, 1, "Exact opaque RGBA8 output from independent pixel-center EvenOdd rectangle XOR, butt stroke coverage and clamp linear-gradient interpolation."),
                "clip-path-linear-gradient-butt-stroke-inverse-winding" to ComparisonPolicy(0, 100.0, 1, "Exact opaque RGBA8 output from independent inverse Winding triangle, butt stroke coverage and clamp linear-gradient interpolation."),
                "clip-path-linear-gradient-right-angle-butt-stroke-winding" to ComparisonPolicy(0, 100.0, 1, "Exact opaque RGBA8 output from independent right-angle device-space Winding triangle, butt stroke coverage and vertical clamp linear-gradient interpolation."),
                "clip-path-linear-gradient-right-angle-square-stroke-winding" to ComparisonPolicy(0, 100.0, 1, "Exact opaque RGBA8 output from independent right-angle device-space Winding triangle, square stroke coverage and vertical clamp linear-gradient interpolation."),
                ...
                "clip-path-right-angle-diagonal-butt-stroke-winding" to ComparisonPolicy(0, 100.0, 1, "Exact opaque RGBA8 output from independent right-angle device-space Winding triangle and butt stroke coverage."),
                "clip-path-right-angle-diagonal-square-stroke-winding" to ComparisonPolicy(0, 100.0, 1, "Exact opaque RGBA8 output from independent right-angle device-space Winding triangle and square stroke coverage."),
    ...
    fun `public surface programs record only the requested Canvas operations`() {
        ...
        val verticalRoundCapStroke = assertIs<DisplayOp.DrawPath>(ops("vertical-round-cap-stroke").single())
        assertEquals(RectF32.ofLTRB(16f, 6f, 16f, 26f), verticalRoundCapStroke.path.computeBounds())
        assertFalse(PathMeasure(verticalRoundCapStroke.path).isClosed)
        assertEquals(
            Paint.stroke(ColorARGB.Red, 4f).copy(antiAlias = false, strokeCap = StrokeCap.ROUND),
            verticalRoundCapStroke.paint,
        )
        assertEquals(Matrix3x3F32.Identity, verticalRoundCapStroke.transform)
        assertEquals(ClipStack.WideOpen, verticalRoundCapStroke.clip)

        val quarterTurnRoundCapStroke = assertIs<DisplayOp.DrawPath>(ops("quarter-turn-round-cap-stroke").single { it is DisplayOp.DrawPath })
        assertEquals(RectF32.ofLTRB(4f, 8f, 16f, 8f), quarterTurnRoundCapStroke.path.computeBounds())
        assertFalse(PathMeasure(quarterTurnRoundCapStroke.path).isClosed)
        assertEquals(
            Paint.stroke(ColorARGB.Red, 4f).copy(antiAlias = false, strokeCap = StrokeCap.ROUND),
            quarterTurnRoundCapStroke.paint,
        )
        assertEquals(Matrix3x3F32(sx = 0f, kx = -1f, tx = 20f, sy = 0f, ky = 1f, ty = 4f), quarterTurnRoundCapStroke.transform)
        assertEquals(ClipStack.WideOpen, quarterTurnRoundCapStroke.clip)

        val halfTurnRoundCapStroke = assertIs<DisplayOp.DrawPath>(ops("half-turn-round-cap-stroke").single { it is DisplayOp.DrawPath })
        assertEquals(RectF32.ofLTRB(8f, 4f, 8f, 16f), halfTurnRoundCapStroke.path.computeBounds())
        assertFalse(PathMeasure(halfTurnRoundCapStroke.path).isClosed)
        assertEquals(
            Paint.stroke(ColorARGB.Red, 4f).copy(antiAlias = false, strokeCap = StrokeCap.ROUND),
            halfTurnRoundCapStroke.paint,
        )
        assertEquals(Matrix3x3F32.translation(28f, 24f) * Matrix3x3F32.rotation(180f), halfTurnRoundCapStroke.transform)
        assertEquals(ClipStack.WideOpen, halfTurnRoundCapStroke.clip)

        val negativeQuarterTurnRoundCapStroke = assertIs<DisplayOp.DrawPath>(ops("negative-quarter-turn-round-cap-stroke").single { it is DisplayOp.DrawPath })
        assertEquals(RectF32.ofLTRB(4f, 8f, 16f, 8f), negativeQuarterTurnRoundCapStroke.path.computeBounds())
        assertFalse(PathMeasure(negativeQuarterTurnRoundCapStroke.path).isClosed)
        assertEquals(
            Paint.stroke(ColorARGB.Red, 4f).copy(antiAlias = false, strokeCap = StrokeCap.ROUND),
            negativeQuarterTurnRoundCapStroke.paint,
        )
        assertEquals(Matrix3x3F32.translation(12f, 24f) * Matrix3x3F32.rotation(-90f), negativeQuarterTurnRoundCapStroke.transform)
        assertEquals(ClipStack.WideOpen, negativeQuarterTurnRoundCapStroke.clip)

        val scissoredVerticalRoundCapStroke = assertIs<DisplayOp.DrawPath>(ops("scissored-vertical-round-cap-stroke").single { it is DisplayOp.DrawPath })
        assertEquals(RectF32.ofLTRB(16f, 6f, 16f, 26f), scissoredVerticalRoundCapStroke.path.computeBounds())
        assertFalse(PathMeasure(scissoredVerticalRoundCapStroke.path).isClosed)
        assertEquals(
            Paint.stroke(ColorARGB.Red, 4f).copy(antiAlias = false, strokeCap = StrokeCap.ROUND),
            scissoredVerticalRoundCapStroke.paint,
        )
        assertEquals(Matrix3x3F32.Identity, scissoredVerticalRoundCapStroke.transform)
        assertEquals(
            ClipStack.DeviceRect(RectF32.ofLTRB(14f, 5f, 18f, 22f), false),
            scissoredVerticalRoundCapStroke.clip,
        )

        val reverseVerticalRoundCapStroke = assertIs<DisplayOp.DrawPath>(ops("reverse-vertical-round-cap-stroke").single())
        assertEquals(RectF32.ofLTRB(16f, 6f, 16f, 26f), reverseVerticalRoundCapStroke.path.computeBounds())
        assertFalse(PathMeasure(reverseVerticalRoundCapStroke.path).isClosed)
        assertEquals(
            Paint.stroke(ColorARGB.Red, 4f).copy(antiAlias = false, strokeCap = StrokeCap.ROUND),
            reverseVerticalRoundCapStroke.paint,
        )
        ...
        assertFalse(PathMeasure(reverseHorizontalRoundCapStroke.path).isClosed)
        assertEquals(
            Paint.stroke(ColorARGB.Red, 4f).copy(antiAlias = false, strokeCap = StrokeCap.ROUND),
            reverseHorizontalRoundCapStroke.paint,
        )
        assertEquals(Matrix3x3F32.Identity, reverseHorizontalRoundCapStroke.transform)
        assertEquals(ClipStack.WideOpen, reverseHorizontalRoundCapStroke.clip)

        val translatedReverseHorizontalRoundCapStroke = assertIs<DisplayOp.DrawPath>(ops("translated-reverse-horizontal-round-cap-stroke").single { it is DisplayOp.DrawPath })
        assertEquals(RectF32.ofLTRB(6f, 16f, 26f, 16f), translatedReverseHorizontalRoundCapStroke.path.computeBounds())
        assertFalse(PathMeasure(translatedReverseHorizontalRoundCapStroke.path).isClosed)
        assertEquals(
            Paint.stroke(ColorARGB.Red, 4f).copy(antiAlias = false, strokeCap = StrokeCap.ROUND),
            translatedReverseHorizontalRoundCapStroke.paint,
        )
        assertEquals(Matrix3x3F32.translation(3f, 2f), translatedReverseHorizontalRoundCapStroke.transform)
        assertEquals(ClipStack.WideOpen, translatedReverseHorizontalRoundCapStroke.clip)

        val scissoredReverseHorizontalRoundCapStroke = assertIs<DisplayOp.DrawPath>(ops("scissored-reverse-horizontal-round-cap-stroke").single { it is DisplayOp.DrawPath })
        assertEquals(RectF32.ofLTRB(6f, 16f, 26f, 16f), scissoredReverseHorizontalRoundCapStroke.path.computeBounds())
        assertFalse(PathMeasure(scissoredReverseHorizontalRoundCapStroke.path).isClosed)
        assertEquals(
            Paint.stroke(ColorARGB.Red, 4f).copy(antiAlias = false, strokeCap = StrokeCap.ROUND),
            scissoredReverseHorizontalRoundCapStroke.paint,
        )
        assertEquals(Matrix3x3F32.Identity, scissoredReverseHorizontalRoundCapStroke.transform)
        assertEquals(
            ClipStack.DeviceRect(RectF32.ofLTRB(24f, 15f, 27f, 18f), false),
            scissoredReverseHorizontalRoundCapStroke.clip,
        )

        val translatedScissoredReverseHorizontalRoundCapStroke = assertIs<DisplayOp.DrawPath>(ops("translated-scissored-reverse-horizontal-round-cap-stroke").single { it is DisplayOp.DrawPath })
        assertEquals(RectF32.ofLTRB(6f, 16f, 26f, 16f), translatedScissoredReverseHorizontalRoundCapStroke.path.computeBounds())
        assertFalse(PathMeasure(translatedScissoredReverseHorizontalRoundCapStroke.path).isClosed)
        assertEquals(
            Paint.stroke(ColorARGB.Red, 4f).copy(antiAlias = false, strokeCap = StrokeCap.ROUND),
            translatedScissoredReverseHorizontalRoundCapStroke.paint,
        )
        assertEquals(Matrix3x3F32.translation(3f, 2f), translatedScissoredReverseHorizontalRoundCapStroke.transform)
        assertEquals(
            ClipStack.DeviceRect(RectF32.ofLTRB(28f, 17f, 30f, 20f), false),
            translatedScissoredReverseHorizontalRoundCapStroke.clip,
        )

        val translatedReverseVerticalRoundCapStroke = assertIs<DisplayOp.DrawPath>(ops("translated-reverse-vertical-round-cap-stroke").single { it is DisplayOp.DrawPath })
        assertEquals(RectF32.ofLTRB(16f, 6f, 16f, 26f), translatedReverseVerticalRoundCapStroke.path.computeBounds())
        assertFalse(PathMeasure(translatedReverseVerticalRoundCapStroke.path).isClosed)
        assertEquals(
            Paint.stroke(ColorARGB.Red, 4f).copy(antiAlias = false, strokeCap = StrokeCap.ROUND),
            translatedReverseVerticalRoundCapStroke.paint,
        )
        assertEquals(Matrix3x3F32.translation(2f, 3f), translatedReverseVerticalRoundCapStroke.transform)
        assertEquals(ClipStack.WideOpen, translatedReverseVerticalRoundCapStroke.clip)

        val translatedScissoredReverseVerticalRoundCapStroke = assertIs<DisplayOp.DrawPath>(ops("translated-scissored-reverse-vertical-round-cap-stroke").single { it is DisplayOp.DrawPath })
        assertEquals(RectF32.ofLTRB(16f, 6f, 16f, 26f), translatedScissoredReverseVerticalRoundCapStroke.path.computeBounds())
        assertFalse(PathMeasure(translatedScissoredReverseVerticalRoundCapStroke.path).isClosed)
        assertEquals(
            Paint.stroke(ColorARGB.Red, 4f).copy(antiAlias = false, strokeCap = StrokeCap.ROUND),
            translatedScissoredReverseVerticalRoundCapStroke.paint,
        )
        assertEquals(Matrix3x3F32.translation(2f, 3f), translatedScissoredReverseVerticalRoundCapStroke.transform)
        assertEquals(
            ClipStack.DeviceRect(RectF32.ofLTRB(17f, 28f, 20f, 30f), false),
            translatedScissoredReverseVerticalRoundCapStroke.clip,
        )

        val uniformlyScaledRoundCapStroke = assertIs<DisplayOp.DrawPath>(ops("uniformly-scaled-round-cap-stroke").single { it is DisplayOp.DrawPath })
        assertEquals(RectF32.ofLTRB(8f, 16f, 24f, 16f), uniformlyScaledRoundCapStroke.path.computeBounds())
        assertFalse(PathMeasure(uniformlyScaledRoundCapStroke.path).isClosed)
        assertEquals(
            Paint.stroke(ColorARGB.Red, 4f).copy(antiAlias = false, strokeCap = StrokeCap.ROUND),
            uniformlyScaledRoundCapStroke.paint,
        )
        assertEquals(Matrix3x3F32.scaling(2f, 2f), uniformlyScaledRoundCapStroke.transform)
        assertEquals(ClipStack.WideOpen, uniformlyScaledRoundCapStroke.clip)

        val uniformlyScaledTranslatedRoundCapStroke = assertIs<DisplayOp.DrawPath>(ops("uniformly-scaled-translated-round-cap-stroke").single { it is DisplayOp.DrawPath })
        assertEquals(RectF32.ofLTRB(8f, 16f, 24f, 16f), uniformlyScaledTranslatedRoundCapStroke.path.computeBounds())
        assertFalse(PathMeasure(uniformlyScaledTranslatedRoundCapStroke.path).isClosed)
        assertEquals(
            Paint.stroke(ColorARGB.Red, 4f).copy(antiAlias = false, strokeCap = StrokeCap.ROUND),
            uniformlyScaledTranslatedRoundCapStroke.paint,
        )
        assertEquals(
            Matrix3x3F32.translation(4f, 6f) * Matrix3x3F32.scaling(2f, 2f),
            uniformlyScaledTranslatedRoundCapStroke.transform,
        )
        assertEquals(ClipStack.WideOpen, uniformlyScaledTranslatedRoundCapStroke.clip)

        val uniformlyScaledVerticalRoundCapStroke = assertIs<DisplayOp.DrawPath>(ops("uniformly-scaled-vertical-round-cap-stroke").single { it is DisplayOp.DrawPath })
        assertEquals(RectF32.ofLTRB(16f, 8f, 16f, 24f), uniformlyScaledVerticalRoundCapStroke.path.computeBounds())
        assertFalse(PathMeasure(uniformlyScaledVerticalRoundCapStroke.path).isClosed)
        assertEquals(
            Paint.stroke(ColorARGB.Red, 4f).copy(antiAlias = false, strokeCap = StrokeCap.ROUND),
            uniformlyScaledVerticalRoundCapStroke.paint,
        )
        assertEquals(Matrix3x3F32.scaling(2f, 2f), uniformlyScaledVerticalRoundCapStroke.transform)
        assertEquals(ClipStack.WideOpen, uniformlyScaledVerticalRoundCapStroke.clip)

        val uniformlyScaledTranslatedVerticalRoundCapStroke = assertIs<DisplayOp.DrawPath>(ops("uniformly-scaled-translated-vertical-round-cap-stroke").single { it is DisplayOp.DrawPath })
        assertEquals(RectF32.ofLTRB(16f, 8f, 16f, 24f), uniformlyScaledTranslatedVerticalRoundCapStroke.path.computeBounds())
        assertFalse(PathMeasure(uniformlyScaledTranslatedVerticalRoundCapStroke.path).isClosed)
        assertEquals(
            Paint.stroke(ColorARGB.Red, 4f).copy(antiAlias = false, strokeCap = StrokeCap.ROUND),
            uniformlyScaledTranslatedVerticalRoundCapStroke.paint,
        )
        assertEquals(
            Matrix3x3F32.translation(4f, 6f) * Matrix3x3F32.scaling(2f, 2f),
            uniformlyScaledTranslatedVerticalRoundCapStroke.transform,
        )
        assertEquals(ClipStack.WideOpen, uniformlyScaledTranslatedVerticalRoundCapStroke.clip)

        val uniformlyScaledReverseRoundCapStroke = assertIs<DisplayOp.DrawPath>(ops("uniformly-scaled-reverse-round-cap-stroke").single { it is DisplayOp.DrawPath })
        assertEquals(RectF32.ofLTRB(8f, 16f, 24f, 16f), uniformlyScaledReverseRoundCapStroke.path.computeBounds())
        assertFalse(PathMeasure(uniformlyScaledReverseRoundCapStroke.path).isClosed)
        assertEquals(
            Paint.stroke(ColorARGB.Red, 4f).copy(antiAlias = false, strokeCap = StrokeCap.ROUND),
            uniformlyScaledReverseRoundCapStroke.paint,
        )
        assertEquals(Matrix3x3F32.scaling(2f, 2f), uniformlyScaledReverseRoundCapStroke.transform)
        assertEquals(ClipStack.WideOpen, uniformlyScaledReverseRoundCapStroke.clip)

        val uniformlyScaledTranslatedReverseRoundCapStroke = assertIs<DisplayOp.DrawPath>(ops("uniformly-scaled-translated-reverse-round-cap-stroke").single { it is DisplayOp.DrawPath })
        assertEquals(RectF32.ofLTRB(8f, 16f, 24f, 16f), uniformlyScaledTranslatedReverseRoundCapStroke.path.computeBounds())
        assertFalse(PathMeasure(uniformlyScaledTranslatedReverseRoundCapStroke.path).isClosed)
        assertEquals(
            Paint.stroke(ColorARGB.Red, 4f).copy(antiAlias = false, strokeCap = StrokeCap.ROUND),
            uniformlyScaledTranslatedReverseRoundCapStroke.paint,
        )
        assertEquals(
            Matrix3x3F32.translation(4f, 6f) * Matrix3x3F32.scaling(2f, 2f),
        ...
        assertFalse(PathMeasure(dashedStroke.path).isClosed)
        assertEquals(
        ...
        assertEquals(Matrix3x3F32.Identity, dashedStroke.transform)
        assertEquals(ClipStack.WideOpen, dashedStroke.clip)

        val verticalDashedStroke = assertIs<DisplayOp.DrawPath>(ops("vertical-dashed-butt-miter-stroke").single())
        assertEquals(RectF32.ofLTRB(16f, 4f, 16f, 28f), verticalDashedStroke.path.computeBounds())
        assertFalse(PathMeasure(verticalDashedStroke.path).isClosed)
        assertEquals(dashedStroke.paint, verticalDashedStroke.paint)
        assertEquals(Matrix3x3F32.Identity, verticalDashedStroke.transform)
        assertEquals(ClipStack.WideOpen, verticalDashedStroke.clip)

        val reverseDashedStroke = assertIs<DisplayOp.DrawPath>(ops("reverse-horizontal-dashed-butt-miter-stroke").single())
        assertEquals(RectF32.ofLTRB(4f, 16f, 28f, 16f), reverseDashedStroke.path.computeBounds())
        assertFalse(PathMeasure(reverseDashedStroke.path).isClosed)
        assertEquals(dashedStroke.paint, reverseDashedStroke.paint)
        assertEquals(Matrix3x3F32.Identity, reverseDashedStroke.transform)
        assertEquals(ClipStack.WideOpen, reverseDashedStroke.clip)

        val reverseVerticalDashedStroke = assertIs<DisplayOp.DrawPath>(ops("reverse-vertical-dashed-butt-miter-stroke").single())
        assertEquals(RectF32.ofLTRB(16f, 4f, 16f, 28f), reverseVerticalDashedStroke.path.computeBounds())
        assertFalse(PathMeasure(reverseVerticalDashedStroke.path).isClosed)
        assertEquals(dashedStroke.paint, reverseVerticalDashedStroke.paint)
        assertEquals(Matrix3x3F32.Identity, reverseVerticalDashedStroke.transform)
        assertEquals(ClipStack.WideOpen, reverseVerticalDashedStroke.clip)

        val phaseShiftedVerticalDashedStroke = assertIs<DisplayOp.DrawPath>(ops("phase-shifted-vertical-dashed-butt-miter-stroke").single())
        assertEquals(RectF32.ofLTRB(16f, 4f, 16f, 28f), phaseShiftedVerticalDashedStroke.path.computeBounds())
        assertFalse(PathMeasure(phaseShiftedVerticalDashedStroke.path).isClosed)
        assertEquals(
            PathEffect.Dash(floatArrayOf(8f, 4f), phase = 4f),
            phaseShiftedVerticalDashedStroke.paint.pathEffect,
        )
        assertEquals(Matrix3x3F32.Identity, phaseShiftedVerticalDashedStroke.transform)
        assertEquals(ClipStack.WideOpen, phaseShiftedVerticalDashedStroke.clip)

        val scissoredVerticalDashedStroke = assertIs<DisplayOp.DrawPath>(ops("scissored-vertical-dashed-butt-miter-stroke").single { it is DisplayOp.DrawPath })
        assertEquals(RectF32.ofLTRB(16f, 4f, 16f, 28f), scissoredVerticalDashedStroke.path.computeBounds())
        assertEquals(
            ClipStack.DeviceRect(RectF32.ofLTRB(14f, 8f, 19f, 20f), false),
            scissoredVerticalDashedStroke.clip,
        )
        assertEquals(dashedStroke.paint, scissoredVerticalDashedStroke.paint)

        val translatedVerticalDashedStroke = assertIs<DisplayOp.DrawPath>(ops("translated-vertical-dashed-butt-miter-stroke").single { it is DisplayOp.DrawPath })
        assertEquals(RectF32.ofLTRB(16f, 4f, 16f, 28f), translatedVerticalDashedStroke.path.computeBounds())
        assertEquals(Matrix3x3F32.translation(3f, 2f), translatedVerticalDashedStroke.transform)
        assertEquals(ClipStack.WideOpen, translatedVerticalDashedStroke.clip)
        assertEquals(dashedStroke.paint, translatedVerticalDashedStroke.paint)

        val uniformlyScaledHorizontalDashedStroke = assertIs<DisplayOp.DrawPath>(ops("uniformly-scaled-horizontal-dashed-butt-miter-stroke").single { it is DisplayOp.DrawPath })
        assertEquals(RectF32.ofLTRB(4f, 8f, 14f, 8f), uniformlyScaledHorizontalDashedStroke.path.computeBounds())
        assertEquals(Matrix3x3F32.scaling(2f, 2f), uniformlyScaledHorizontalDashedStroke.transform)
        assertEquals(ClipStack.WideOpen, uniformlyScaledHorizontalDashedStroke.clip)
        assertEquals(dashedStroke.paint, uniformlyScaledHorizontalDashedStroke.paint)

        val uniformlyScaledVerticalDashedStroke = assertIs<DisplayOp.DrawPath>(ops("uniformly-scaled-vertical-dashed-butt-miter-stroke").single { it is DisplayOp.DrawPath })
        assertEquals(RectF32.ofLTRB(8f, 4f, 8f, 14f), uniformlyScaledVerticalDashedStroke.path.computeBounds())
        assertEquals(Matrix3x3F32.scaling(2f, 2f), uniformlyScaledVerticalDashedStroke.transform)
        assertEquals(ClipStack.WideOpen, uniformlyScaledVerticalDashedStroke.clip)
        assertEquals(dashedStroke.paint, uniformlyScaledVerticalDashedStroke.paint)

        val uniformlyScaledTranslatedHorizontalDashedStroke = assertIs<DisplayOp.DrawPath>(ops("uniformly-scaled-translated-horizontal-dashed-butt-miter-stroke").single { it is DisplayOp.DrawPath })
        assertEquals(RectF32.ofLTRB(4f, 4f, 14f, 4f), uniformlyScaledTranslatedHorizontalDashedStroke.path.computeBounds())
        assertEquals(
            Matrix3x3F32.translation(2f, 4f) * Matrix3x3F32.scaling(2f, 2f),
            uniformlyScaledTranslatedHorizontalDashedStroke.transform,
        )
        ...
        assertEquals(
            ClipStack.DeviceRect(RectF32.ofLTRB(8f, 14f, 20f, 19f), false),
            scissoredDashedStroke.clip,
        )
        assertEquals(dashedStroke.paint, scissoredDashedStroke.paint)
        val translatedDashedStroke = assertIs<DisplayOp.DrawPath>(
            ops("translated-horizontal-dashed-butt-miter-stroke").single { it is DisplayOp.DrawPath },
        )
        assertEquals(RectF32.ofLTRB(4f, 16f, 28f, 16f), translatedDashedStroke.path.computeBounds())
        assertEquals(Matrix3x3F32.translation(3f, 2f), translatedDashedStroke.transform)
        assertEquals(dashedStroke.paint, translatedDashedStroke.paint)
        assertEquals(ClipStack.WideOpen, translatedDashedStroke.clip)
        val phaseShiftedDashedStroke = assertIs<DisplayOp.DrawPath>(
            ops("phase-shifted-horizontal-dashed-butt-miter-stroke").single { it is DisplayOp.DrawPath },
        )
        assertEquals(dashedStroke.path.computeBounds(), phaseShiftedDashedStroke.path.computeBounds())
        assertEquals(
            PathEffect.Dash(floatArrayOf(8f, 4f), phase = 4f),
            phaseShiftedDashedStroke.paint.pathEffect,
        )
        assertEquals(ClipStack.WideOpen, phaseShiftedDashedStroke.clip)
        val scissoredPhaseShiftedDashedStroke = assertIs<DisplayOp.DrawPath>(
            ops("scissored-phase-shifted-horizontal-dashed-butt-miter-stroke").single { it is DisplayOp.DrawPath },
        )
        assertEquals(dashedStroke.path.computeBounds(), scissoredPhaseShiftedDashedStroke.path.computeBounds())
        assertEquals(
            PathEffect.Dash(floatArrayOf(8f, 4f), phase = 4f),
            scissoredPhaseShiftedDashedStroke.paint.pathEffect,
        )
        assertEquals(
            ClipStack.DeviceRect(RectF32.ofLTRB(8f, 14f, 20f, 19f), false),
            scissoredPhaseShiftedDashedStroke.clip,
        )
        assertEquals(
            listOf(
                DisplayOp.DrawRect(
