...
class GpuEvidenceCatalogTest {
    ...
    @Test
    fun `catalog separates one hundred twenty-three public surface renders from nine refusals`() {
        ...
        assertEquals(
            List(123) { "kanvas.surface.render" },
            GpuEvidenceCatalog.renderCases.map { assertIs<KanvasSurfaceProgram>(it.program).routeId },
        )
        assertEquals(123, GpuEvidenceCatalog.renderCases.size)
        assertEquals(132, GpuEvidenceCatalog.cases.size)
