...
class GpuEvidenceCatalogTest {
    ...
    @Test
    fun `catalog separates one hundred thirty-six public surface renders from nine refusals`() {
        ...
        assertEquals(
            List(136) { "kanvas.surface.render" },
            GpuEvidenceCatalog.renderCases.map { assertIs<KanvasSurfaceProgram>(it.program).routeId },
        )
        assertEquals(136, GpuEvidenceCatalog.renderCases.size)
        assertEquals(145, GpuEvidenceCatalog.cases.size)
