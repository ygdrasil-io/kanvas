...
class GpuEvidenceCatalogTest {
    ...
    @Test
    fun `catalog separates one hundred thirty-seven public surface renders from nine refusals`() {
        ...
        assertEquals(
            List(137) { "kanvas.surface.render" },
            GpuEvidenceCatalog.renderCases.map { assertIs<KanvasSurfaceProgram>(it.program).routeId },
        )
        assertEquals(137, GpuEvidenceCatalog.renderCases.size)
        assertEquals(146, GpuEvidenceCatalog.cases.size)
