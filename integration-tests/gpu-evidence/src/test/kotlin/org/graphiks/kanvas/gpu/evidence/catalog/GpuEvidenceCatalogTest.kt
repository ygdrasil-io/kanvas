...
class GpuEvidenceCatalogTest {
    ...
    @Test
    fun `catalog separates ninety two public surface renders from nine refusals`() {
        ...
        assertEquals(
            listOf(
                ...
                "sweep-gradient-partial-angle", "affine-solid-rect", "basic-primitives-valid-alpha", "basic-primitives-out-of-bounds", "basic-primitives-points", "fractional-aa-rect-overlap", "affine-path-clip-color", "scissored-radial-gradient", "repeat-gradient-refusal", "gradient-stroke-refusal", "linear-gradient-three-stop-stroke-rect", "radial-gradient-two-stop-stroke-rect",
                "scaled-solid-rrect",
                "solid-drrect-hole",
        ...
        assertEquals(
            List(92) { "kanvas.surface.render" },
            GpuEvidenceCatalog.renderCases.map { assertIs<KanvasSurfaceProgram>(it.program).routeId },
        )
        assertEquals(92, GpuEvidenceCatalog.renderCases.size)
        assertEquals(101, GpuEvidenceCatalog.cases.size)
        ...
        listOf("linear-gradient-lanes", "linear-gradient-three-stops", "radial-swatch", "radial-gradient-three-stops", "sweep-disk", "sweep-gradient-three-stops", "sweep-gradient-partial-angle", "scissored-radial-gradient", "repeat-gradient-refusal", "gradient-stroke-refusal", "linear-gradient-three-stop-stroke-rect", "radial-gradient-two-stop-stroke-rect").forEach { id ->
            val evidenceCase = assertNotNull(cases.firstOrNull { it.descriptor.id.value == id })
            assertEquals(64, evidenceCase.descriptor.width)
            assertEquals(64, evidenceCase.descriptor.height)
            assertIs<EvidenceExpectation.ShouldRender>(evidenceCase.descriptor.expectation)
        ...
        assertEquals(
            ...
            listOf("linear-gradient-lanes", "linear-gradient-three-stops", "radial-swatch", "radial-gradient-three-stops", "sweep-disk", "sweep-gradient-three-stops", "sweep-gradient-partial-angle", "scissored-radial-gradient", "repeat-gradient-refusal", "gradient-stroke-refusal", "linear-gradient-three-stop-stroke-rect", "radial-gradient-two-stop-stroke-rect").associateWith { id ->
