...
class GpuEvidenceCatalogTest {
    ...
    @Test
    fun `catalog separates one hundred twenty-four public surface renders from nine refusals`() {
        ...
        assertEquals(
            List(124) { "kanvas.surface.render" },
            GpuEvidenceCatalog.renderCases.map { assertIs<KanvasSurfaceProgram>(it.program).routeId },
        )
        assertEquals(124, GpuEvidenceCatalog.renderCases.size)
        assertEquals(133, GpuEvidenceCatalog.cases.size)
