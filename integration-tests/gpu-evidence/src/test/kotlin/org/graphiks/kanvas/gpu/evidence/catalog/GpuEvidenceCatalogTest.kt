...
class GpuEvidenceCatalogTest {
    ...
    @Test
    fun `catalog separates one hundred fifty-one public surface renders from thirteen refusals`() {
        ...
        assertEquals(164, GpuEvidenceCatalog.cases.size)
