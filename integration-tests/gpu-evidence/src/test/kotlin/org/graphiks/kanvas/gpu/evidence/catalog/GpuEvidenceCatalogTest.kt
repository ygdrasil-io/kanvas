...
class GpuEvidenceCatalogTest {
    ...
    @Test
    fun `catalog separates one hundred fourteen public surface renders from nine refusals`() {
        ...
        assertEquals(
            List(114) { "kanvas.surface.render" },
            GpuEvidenceCatalog.renderCases.map { assertIs<KanvasSurfaceProgram>(it.program).routeId },
        )
        assertEquals(114, GpuEvidenceCatalog.renderCases.size)
        assertEquals(123, GpuEvidenceCatalog.cases.size)
