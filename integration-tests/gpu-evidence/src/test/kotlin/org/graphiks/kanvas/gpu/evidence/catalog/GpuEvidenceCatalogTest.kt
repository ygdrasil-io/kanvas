...
class GpuEvidenceCatalogTest {
    ...
    @Test
    fun `catalog separates one hundred thirty-five public surface renders from nine refusals`() {
        ...
        assertEquals(
            List(135) { "kanvas.surface.render" },
            GpuEvidenceCatalog.renderCases.map { assertIs<KanvasSurfaceProgram>(it.program).routeId },
        )
        assertEquals(135, GpuEvidenceCatalog.renderCases.size)
        assertEquals(144, GpuEvidenceCatalog.cases.size)
