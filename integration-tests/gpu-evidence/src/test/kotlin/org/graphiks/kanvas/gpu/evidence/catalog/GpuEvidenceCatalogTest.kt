...
class GpuEvidenceCatalogTest {
    ...
    @Test
    fun `catalog separates one hundred forty-one public surface renders from nine refusals`() {
        ...
        assertEquals(
            List(141) { "kanvas.surface.render" },
            GpuEvidenceCatalog.renderCases.map { assertIs<KanvasSurfaceProgram>(it.program).routeId },
        )
        assertEquals(141, GpuEvidenceCatalog.renderCases.size)
        assertEquals(150, GpuEvidenceCatalog.cases.size)
