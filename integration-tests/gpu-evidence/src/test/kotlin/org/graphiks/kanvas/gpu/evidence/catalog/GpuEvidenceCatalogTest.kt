...
class GpuEvidenceCatalogTest {
    ...
    @Test
    fun `catalog separates one hundred twenty-two public surface renders from nine refusals`() {
        ...
        assertEquals(
            List(122) { "kanvas.surface.render" },
            GpuEvidenceCatalog.renderCases.map { assertIs<KanvasSurfaceProgram>(it.program).routeId },
        )
        assertEquals(122, GpuEvidenceCatalog.renderCases.size)
        assertEquals(131, GpuEvidenceCatalog.cases.size)
