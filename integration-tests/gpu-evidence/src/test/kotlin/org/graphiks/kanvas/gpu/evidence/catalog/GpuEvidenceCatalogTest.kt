...
class GpuEvidenceCatalogTest {
    ...
    @Test
    fun `catalog separates one hundred forty-two public surface renders from nine refusals`() {
        ...
        assertEquals(
            List(142) { "kanvas.surface.render" },
            GpuEvidenceCatalog.renderCases.map { assertIs<KanvasSurfaceProgram>(it.program).routeId },
        )
        assertEquals(142, GpuEvidenceCatalog.renderCases.size)
        assertEquals(151, GpuEvidenceCatalog.cases.size)
