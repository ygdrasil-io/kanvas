...
class GpuEvidenceCatalogTest {
    ...
    @Test
    fun `catalog separates one hundred fifty-one public surface renders from eleven refusals`() {
        ...
        assertEquals(
            List(151) { "kanvas.surface.render" },
        ...
        assertEquals(162, GpuEvidenceCatalog.cases.size)
