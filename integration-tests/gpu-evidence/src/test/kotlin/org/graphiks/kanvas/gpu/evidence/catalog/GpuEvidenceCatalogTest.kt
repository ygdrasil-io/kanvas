...
class GpuEvidenceCatalogTest {
    ...
    @Test
    fun `catalog separates one hundred forty public surface renders from nine refusals`() {
        ...
        assertEquals(
            List(140) { "kanvas.surface.render" },
            GpuEvidenceCatalog.renderCases.map { assertIs<KanvasSurfaceProgram>(it.program).routeId },
        )
        assertEquals(140, GpuEvidenceCatalog.renderCases.size)
        assertEquals(149, GpuEvidenceCatalog.cases.size)
