...
class RuntimeEffectRefusalMatrixTest {
    ...
    fun runtimeEffectChildAndSourceShapesProduceRefuseRequiredRows() {
        ...
        assertEquals(
            listOf(
                ...
                "runtime-effect:nonclaim arbitrarySkSL=false arbitraryWGSL=false children=false unsupportedPlacementSupport=false productActivation=true",
            ),
            report.dumpLines(),
        )
    }
    ...
    fun refusalMatrixDoesNotPromoteUnregisteredDescriptorAnchors() {
        ...
        assertEquals(
            listOf(
                "runtime-effect-refusal row=gpu-renderer.runtime-effect-refusals category=source shape=dynamic-sksl descriptor=runtime.simple.color@unregistered routeKind=RefuseDiagnostic classification=RefuseRequired reason=unsupported.runtime_effect.unregistered_descriptor productActivation=true facts=descriptorMatches=0,sourceKind=SkSL",
    ...
    fun refusalMatrixDoesNotPromoteDescriptorCollisions() {
        ...
        assertEquals(
            listOf(
                "runtime-effect-refusal row=gpu-renderer.runtime-effect-refusals category=source shape=dynamic-sksl descriptor=runtime.simple.color@collision routeKind=RefuseDiagnostic classification=RefuseRequired reason=unsupported.runtime_effect.descriptor_collision productActivation=true facts=descriptorMatches=2,sourceKind=SkSL",
