...
const val RadialGradientWgsl: String = """
fn compute_t_radial(pos: vec4f, center: vec2f, radius: f32) -> f32 {
    if (radius <= 0.0) {
        return -1.0e30;
    }
    let d = pos.xy - center;
...
fn radial_gradient_clamp(pos: vec4f, center: vec2f, radius: f32, count: u32, positions: ptr<function, array<vec4f, 16>>, colors: ptr<function, array<vec4f, 16>>) -> vec4f {
