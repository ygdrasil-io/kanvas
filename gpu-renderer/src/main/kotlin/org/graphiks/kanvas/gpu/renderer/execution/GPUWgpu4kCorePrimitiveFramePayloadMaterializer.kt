...
internal class GPUWgpu4kCorePrimitiveFramePayloadMaterializer(
    ...
    private fun packW4aSessionGeometry(scratch: W4aSessionScratchV1): GPUCorePrimitiveFrameGeometryArena {
        ...
        val slices = scratch.draws.mapIndexed { drawIndex, draw ->
            val bounds = draw.copyDeviceBounds()
            val vertexOffset = Math.multiplyExact(drawIndex, 8)
            vertices[vertexOffset] = bounds.left
            vertices[vertexOffset + 1] = bounds.top
            vertices[vertexOffset + 2] = bounds.right
            vertices[vertexOffset + 3] = bounds.top
            vertices[vertexOffset + 4] = bounds.right
            vertices[vertexOffset + 5] = bounds.bottom
            vertices[vertexOffset + 6] = bounds.left
            vertices[vertexOffset + 7] = bounds.bottom
