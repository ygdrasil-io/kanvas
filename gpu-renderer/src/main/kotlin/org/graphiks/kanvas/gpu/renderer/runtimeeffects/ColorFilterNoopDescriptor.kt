...
import org.graphiks.kanvas.gpu.renderer.wgsl.ColorFilterNoopEntryPoint
import org.graphiks.kanvas.gpu.renderer.wgsl.ColorFilterNoopSourceHash

object ColorFilterNoopDescriptor {
    val effectId: GPURuntimeEffectID = GPURuntimeEffectID("runtime.color_filter_noop")
    ...
    val uniformSchema: GPURuntimeEffectUniformSchema = GPURuntimeEffectUniformSchema(
        schemaHash = "schema:color_filter_noop:v1",
        fields = emptyList(),
    ...
    val resources: GPURuntimeEffectResourcePlan = GPURuntimeEffectResourcePlan(
        ...
        bindingPlanHash = "binding:color_filter_noop:v1",
    )

    val wgslPlan: GPURuntimeEffectWGSLPlan = GPURuntimeEffectWGSLPlan(
        moduleHash = "module:color_filter_noop:v1",
        entryPoint = ColorFilterNoopEntryPoint,
        reflectionHash = "reflection:color_filter_noop:v1",
    )
