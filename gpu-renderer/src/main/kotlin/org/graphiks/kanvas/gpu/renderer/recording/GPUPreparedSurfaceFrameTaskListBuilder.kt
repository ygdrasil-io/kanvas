...
class GPUPreparedSurfaceFrameTaskListBuilder(
    ...
    /**
     * Merges a materialized saveLayer command stream into a recorded frame task list so the
     * composite scheduling evidence rides with the executable frame.
     */
...
private fun preparedSurfaceTargetColorInterpretation(
    ...
    GPUColorFormat.BGRA8Unorm -> GPUColorInterpretation.EncodedPremulSrgb
        ...
        "Prepared ColorGlyph destination snapshots require RGBA8Unorm, RGBA8UnormSrgb, or BGRA8Unorm.",
    )
}
