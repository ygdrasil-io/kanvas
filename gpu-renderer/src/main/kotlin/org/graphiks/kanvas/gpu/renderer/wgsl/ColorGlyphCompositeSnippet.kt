 ...
 * rects and colors are supplied via the uniform block; the GPU runtime packs
 * them before the draw. Layers beyond [maxLayers] are not iterated (the route
 * planner refuses such plans).
 *
