...
tasks.withType<Test> {
    ...
    System.getProperty("kanvas.webgpu.strokeCapJoin.experimentalRender")?.let {
        systemProperty("kanvas.webgpu.strokeCapJoin.experimentalRender", it)
    }
    ...
    System.getProperty("kanvas.webgpu.m60F16LowLevelExactMaskProbeFor443.enabled")?.let {
        systemProperty("kanvas.webgpu.m60F16LowLevelExactMaskProbeFor443.enabled", it)
    }
    System.getProperty("kanvas.webgpu.m60F16RuntimeMaskPackingVsLowLevelProbeFor444.enabled")?.let {
        systemProperty("kanvas.webgpu.m60F16RuntimeMaskPackingVsLowLevelProbeFor444.enabled", it)
    }
    ...
    System.getProperty("kanvas.webgpu.m60F16ProductionCoverStencilVsDiagnosticTextureFor456.enabled")?.let {
        systemProperty("kanvas.webgpu.m60F16ProductionCoverStencilVsDiagnosticTextureFor456.enabled", it)
    }
    System.getProperty("kanvas.webgpu.m60F16ProductionBoundCoverStencilDiagnosticFor457.enabled")?.let {
        systemProperty("kanvas.webgpu.m60F16ProductionBoundCoverStencilDiagnosticFor457.enabled", it)
    }
    System.getProperty("kanvas.webgpu.m60F16ProductionCoverStateVsShaderEmissionFor458.enabled")?.let {
        systemProperty("kanvas.webgpu.m60F16ProductionCoverStateVsShaderEmissionFor458.enabled", it)
    }
