...
public object WebGpuSink {
    public data class DrawWithM60F16FragmentLaneDiagnosticSnapshotResult(
        ...
        val stencilRenderPassSplitBoundarySnapshot:
        ...
        val productionBoundCoverStencilDiagnosticFor457Snapshot:
            SkWebGpuDevice.M60F16ProductionBoundCoverStencilDiagnosticFor457Snapshot,
        val productionCoverStateVsShaderEmissionFor458Snapshot:
            SkWebGpuDevice.M60F16ProductionCoverStateVsShaderEmissionFor458Snapshot,
        val productionCoverColorAttachmentAcceptanceFor459Snapshot:
        ...
        val aaStencilCoverShaderReturnStorageZeroCauseSnapshot:
            SkWebGpuDevice.M60F16AaStencilCoverShaderReturnStorageZeroCauseSnapshot,
        val aaStencilCoverFinalWgslDiagnosticSnapshot:
        ...
        val runtimeIntegerLaneMaskProbeFor445Snapshot:
            SkWebGpuDevice.M60F16RuntimeIntegerLaneMaskProbeFor445Snapshot,
    )
    ...
    public fun drawWithM60F16FragmentLaneDiagnosticSnapshot(
        ...
        SkWebGpuDevice(
            ...
            return DrawWithM60F16FragmentLaneDiagnosticSnapshotResult(
                ...
                stencilRenderPassSplitBoundarySnapshot =
                ...
                productionBoundCoverStencilDiagnosticFor457Snapshot =
                    device.m60F16ProductionBoundCoverStencilDiagnosticFor457Snapshot(),
                productionCoverStateVsShaderEmissionFor458Snapshot =
                    device.m60F16ProductionCoverStateVsShaderEmissionFor458Snapshot(),
                productionCoverColorAttachmentAcceptanceFor459Snapshot =
                    device.m60F16ProductionCoverColorAttachmentAcceptanceFor459Snapshot(),
                ...
                aaStencilCoverShaderReturnStorageZeroCauseSnapshot =
                    device.m60F16AaStencilCoverShaderReturnStorageZeroCauseSnapshot(),
                ...
                runtimeIntegerLaneMaskProbeFor445Snapshot =
                    device.m60F16RuntimeIntegerLaneMaskProbeFor445Snapshot(),
            )
        }
    }
