...
struct Uniforms {
    ...
    colorFilterKindMode: vec4f,  // offset 624 : (kind, blendMode, _, _)
    colorFilterParam0:   vec4f,  // offset 640
    colorFilterParam1:   vec4f,  // offset 656
    colorFilterParam2:   vec4f,  // offset 672
    colorFilterParam3:   vec4f,  // offset 688
    colorFilterBias:     vec4f,  // offset 704
};
...
fn fs_clamp(@builtin(position) pos: vec4f) -> @location(0) vec4f {
    ...
    return c * s.in_cone * clip_cov(pos.xy);
}
