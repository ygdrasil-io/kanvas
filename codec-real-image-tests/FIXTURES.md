...
| --- | --- | --- | --- | --- | --- |
| `codec-real-images/png/mandrill_64.png` | Skia upstream | `kanvas-legacy/src/test/resources/images/mandrill_64.png`; lineage copied from Skia image resources in repo history | Skia license | Copied into `codec-real-image-tests`; kept at 64x64 to stay small | RGB PNG with ICC coverage |
| `codec-real-images/png/mandrill_128_icc.png` | Skia upstream | `kanvas-legacy/src/test/resources/images/mandrill_128.png`; original import from `/resources/images/mandrill_128.png` in upstream Skia checkout | Skia license | Copied into codec corpus and kept as ICC-bearing 128x128 PNG | RGB PNG with ICC profile |
| `codec-real-images/png/color_wheel.png` | Skia upstream | `kanvas-legacy/src/test/resources/images/color_wheel.png`; lineage copied from Skia image resources in repo history | Skia license | Copied into codec corpus as reduced RGBA fixture | Alpha PNG coverage |
| `codec-real-images/png/ducky_rgba_icc.png` | Skia upstream | `kanvas-legacy/src/test/resources/images/ducky.png`; original import from `/resources/images/ducky.png` in upstream Skia checkout | Skia license | Copied into codec corpus and retained with ICC metadata | RGBA PNG with ICC profile |
...
| `codec-real-images/gif/box.gif` | Skia upstream | `kanvas-legacy/src/test/resources/images/box.gif`; lineage copied from Skia image resources in repo history | Skia license | Copied into codec corpus unchanged | Static GIF |
| `codec-real-images/gif/test640x479.gif` | Skia upstream | `kanvas-legacy/src/test/resources/images/test640x479.gif`; lineage copied from Skia image resources in repo history | Skia license | Copied into codec corpus unchanged | Animated GIF frame/delay coverage |
