#!/usr/bin/env python3
"""Validate the M90-PAA-3G-REF ScaledStrokesGM evidence gate."""
...
PARENT_TICKET = "M90-PAA-3G"
FALLBACK_REASON = "coverage.scaled-stroke.row-specific-artifacts-required"

GATE = ROOT / "reports/wgsl-pipeline/scenes/generated/m90-scaledstrokes-row-specific-evidence-gate.json"
REPORT = ROOT / "reports/wgsl-pipeline/2026-06-08-m90-scaledstrokes-evidence-gate.md"
INTAKE = ROOT / "reports/wgsl-pipeline/m90-path-aa-scaledstrokes-evidence-intake/summary.json"
ROUTE_CPU = ROOT / "reports/wgsl-pipeline/m90-path-aa-route-diagnostics/routes/skia-gm-scaledstrokes/route-cpu.json"
ROUTE_GPU = ROOT / "reports/wgsl-pipeline/m90-path-aa-route-diagnostics/routes/skia-gm-scaledstrokes/route-gpu.json"

EXPECTED_INTAKE_REQUIRED_EVIDENCE = [
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-scaledstrokes/skia.png",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-scaledstrokes/route-cpu.json",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-scaledstrokes/route-gpu.json",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-scaledstrokes/cpu.png",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-scaledstrokes/gpu.png",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-scaledstrokes/cpu-diff.png",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-scaledstrokes/gpu-diff.png",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-scaledstrokes/stats.json",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-scaledstrokes/cpu-performance.json",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-scaledstrokes/gpu-performance.json",
]
EXPECTED_REQUIRED_EVIDENCE = EXPECTED_INTAKE_REQUIRED_EVIDENCE
EXPECTED_HISTORICAL_SIGNALS = [
    "skia-integration-tests/src/test/kotlin/org/skia/tests/ScaledStrokesTest.kt",
    "skia-integration-tests/src/main/kotlin/org/skia/tests/ScaledStrokesGM.kt",
    "gpu-raster/src/test/kotlin/org/skia/gpu/webgpu/ScaledStrokesWebGpuTest.kt",
    "gpu-raster/src/test/kotlin/org/skia/gpu/webgpu/crossbackend/ScaledStrokesCrossBackendTest.kt",
    "gpu-raster/test-similarity-scores-webgpu.properties#ScaledStrokesGM=96.49",
    "skia-integration-tests/test-similarity-scores.properties#ScaledStrokesGM=96.02783203125",
    "cpu-raster/test-similarity-scores.properties#ScaledStrokesGM=96.02783203125",
    "kanvas-skia/test-similarity-scores.properties#ScaledStrokesGM=96.05859375",
]
...
ALLOWED_STATUS_PATHS = {
    "build.gradle.kts",
    "scripts/validate_m90_scaledstrokes_evidence_gate.py",
    "reports/wgsl-pipeline/2026-06-08-m90-scaledstrokes-evidence-gate.md",
...
def validate_intake() -> None:
    ...
    require(intake.get("classification") == "path-aa-scaledstrokes-evidence-intake-no-new-rendering-support", "intake classification changed")
...
def validate_routes() -> None:
    expected_routes = {
        "CPU": "cpu.path.scaled-stroke.expected-unsupported",
        "WebGPU": "webgpu.path.scaled-stroke.expected-unsupported",
    }
...
def validate_report() -> None:
    require_text(
        ...
        [
            ...
            "GPU score `96.49`",
            "CPU score\n`96.02783203125`",
            "cpu-raster mirror `96.02783203125`",
            "kanvas-skia mirror\n`96.05859375`",
...
def main() -> None:
    ...
    print(f"validated {TICKET} ScaledStrokesGM evidence gate")
