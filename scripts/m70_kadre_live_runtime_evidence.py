#!/usr/bin/env python3
"""Generate M70/M71 Kadre live runtime PM evidence."""
...
def status_from_demo(native_demo: dict[str, Any]) -> tuple[str, str]:
    ...
    if (
        ...
        return "native-runnable", "m71.kadre-autonomous-demo-presented-frames"
    if (
        ...
        return "degraded", "m71.kadre-autonomous-present-call-completed-timeout-only"
