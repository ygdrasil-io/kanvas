...
ACTIVATION_DECISION_REF = ".upstream/target/skia-like-realtime-renderer-target.md"
...
def build_manifest_entry(fields: dict[str, str], rows: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "pmPackageCommand": "rtk ./gradlew --no-daemon :gpu-renderer:gpuRendererR6FirstRoutePmEvidenceBundle",
