...
REQUIRED_FONT_FAMILY_GATES = {
    ...
    "svg-glyphs": [
        "svg-animation-refusal",
        "svg-defs-symbol-use-radial-gradient",
        "svg-embedded-text-refusal",
        "svg-external-resource-refusal",
        "svg-filter-refusal",
        "svg-foreign-object-refusal",
        "svg-gradient-stop-budget-refusal",
        "svg-gradient-transform-clip",
        "svg-malformed-document-refusal",
        "svg-malformed-path-data-refusal",
        "svg-network-reference-refusal",
        "svg-path-command-budget-refusal",
        "svg-script-refusal",
        "svg-static-path",
        "svg-unsupported-css-selector-refusal",
