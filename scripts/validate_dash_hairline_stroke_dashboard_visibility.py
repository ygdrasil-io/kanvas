...
EXPECTED_PROJECTED = {
    "baselineRowsFromPr1569": 105,
    "addedRows": 9,
    "total": 114,
    "pass": 70,
    "expectedUnsupported": 44,
    "inventoryDerived": 66,
}
EXPECTED_CHANGED = {
    "build.gradle.kts",
...
def validate_generated_projection() -> None:
    ...
    if DASHBOARD.is_file():
        ...
        overlap = sorted(dashboard_ids.intersection(EXPECTED_ROWS))
        require(not overlap, f"selected rows already visible before projection: {overlap}")
