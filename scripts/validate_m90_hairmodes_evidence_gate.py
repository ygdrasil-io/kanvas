#!/usr/bin/env python3
"""Validate the M90-PAA-3F-REF HairModesGM evidence gate."""
...
PARENT_TICKET = "M90-PAA-3F"
FALLBACK_REASON = "coverage.hairmode.row-specific-artifacts-required"

GATE = ROOT / "reports/wgsl-pipeline/scenes/generated/m90-hairmodes-row-specific-evidence-gate.json"
REPORT = ROOT / "reports/wgsl-pipeline/2026-06-08-m90-hairmodes-evidence-gate.md"
INTAKE = ROOT / "reports/wgsl-pipeline/m90-path-aa-hairmodes-evidence-intake/summary.json"
ROUTE_CPU = ROOT / "reports/wgsl-pipeline/m90-path-aa-route-diagnostics/routes/skia-gm-hairmodes/route-cpu.json"
ROUTE_GPU = ROOT / "reports/wgsl-pipeline/m90-path-aa-route-diagnostics/routes/skia-gm-hairmodes/route-gpu.json"
...
EXPECTED_REQUIRED_EVIDENCE = [
    f"reports/wgsl-pipeline/scenes/artifacts/skia-gm-hairmodes/{name}"
    for name in REQUIRED_ARTIFACTS
]
EXPECTED_INTAKE_REQUIRED_EVIDENCE = [
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-hairmodes/skia.png",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-hairmodes/route-cpu.json",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-hairmodes/route-gpu.json",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-hairmodes/cpu.png",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-hairmodes/gpu.png",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-hairmodes/cpu-diff.png",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-hairmodes/gpu-diff.png",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-hairmodes/stats.json",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-hairmodes/cpu-performance.json",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-hairmodes/gpu-performance.json",
]
EXPECTED_HISTORICAL_SIGNALS = [
    "skia-integration-tests/src/test/kotlin/org/skia/tests/Round13Test.kt",
    "skia-integration-tests/src/main/kotlin/org/skia/tests/HairModesGM.kt",
    "skia-integration-tests/test-similarity-scores.properties#HairModesGM=72.19368489583333",
    "cpu-raster/test-similarity-scores.properties#HairModesGM=72.19368489583333",
    "kanvas-skia/test-similarity-scores.properties#HairModesGM=72.19368489583333",
]
...
ALLOWED_STATUS_PATHS = {
    "build.gradle.kts",
    "scripts/validate_m90_hairmodes_evidence_gate.py",
    "reports/wgsl-pipeline/2026-06-08-m90-hairmodes-evidence-gate.md",
...
def validate_intake() -> None:
    ...
    require(intake.get("classification") == "path-aa-hairmodes-evidence-intake-no-new-rendering-support", "intake classification changed")
...
def validate_routes() -> None:
    expected_routes = {
        "CPU": "cpu.path.hairmode.expected-unsupported",
        "WebGPU": "webgpu.path.hairmode.expected-unsupported",
    }
...
def validate_report() -> None:
    require_text(
        ...
        [
            ...
            "The intake records no WebGPU historical HairModes test",
...
def main() -> None:
    ...
    print(f"validated {TICKET} HairModesGM evidence gate")
