#!/usr/bin/env python3
"""Validate the M90-PAA-3I-REF DashCubicsGM evidence gate."""
...
PARENT_TICKET = "M90-PAA-3I"
FALLBACK_REASON = "coverage.dash-cubic.row-specific-artifacts-required"

GATE = ROOT / "reports/wgsl-pipeline/scenes/generated/m90-dashcubics-row-specific-evidence-gate.json"
REPORT = ROOT / "reports/wgsl-pipeline/2026-06-08-m90-dashcubics-evidence-gate.md"
INTAKE = ROOT / "reports/wgsl-pipeline/m90-path-aa-dashcubics-evidence-intake/summary.json"
ROUTE_CPU = ROOT / "reports/wgsl-pipeline/m90-path-aa-route-diagnostics/routes/skia-gm-dashcubics/route-cpu.json"
ROUTE_GPU = ROOT / "reports/wgsl-pipeline/m90-path-aa-route-diagnostics/routes/skia-gm-dashcubics/route-gpu.json"

EXPECTED_REQUIRED_EVIDENCE = [
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-dashcubics/skia.png",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-dashcubics/route-cpu.json",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-dashcubics/route-gpu.json",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-dashcubics/cpu.png",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-dashcubics/gpu.png",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-dashcubics/cpu-diff.png",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-dashcubics/gpu-diff.png",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-dashcubics/stats.json",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-dashcubics/cpu-performance.json",
    "reports/wgsl-pipeline/scenes/artifacts/skia-gm-dashcubics/gpu-performance.json",
]
EXPECTED_HISTORICAL_SIGNALS = [
    "skia-integration-tests/src/test/kotlin/org/skia/tests/DashCubicsTest.kt",
    "skia-integration-tests/src/main/kotlin/org/skia/tests/DashCubicsGM.kt",
    "gpu-raster/src/test/kotlin/org/skia/gpu/webgpu/crossbackend/DashCubicsCrossBackendTest.kt",
    "gpu-raster/test-similarity-scores-webgpu.properties#DashCubicsGM-gpu=92.69; DashCubicsGM-raster=91.07",
    "skia-integration-tests/test-similarity-scores.properties#DashCubicsGM=89.86897880539499",
    "cpu-raster/test-similarity-scores.properties#DashCubicsGM=89.86897880539499",
    "kanvas-skia/test-similarity-scores.properties#DashCubicsGM=89.86897880539499",
]
...
ALLOWED_STATUS_PATHS = {
    "build.gradle.kts",
    "scripts/validate_m90_dashcubics_evidence_gate.py",
    "reports/wgsl-pipeline/2026-06-08-m90-dashcubics-evidence-gate.md",
...
def validate_intake() -> None:
    ...
    require(intake.get("classification") == "path-aa-dashcubics-evidence-intake-no-new-rendering-support", "intake classification changed")
...
def validate_routes() -> None:
    expected_routes = {
        "CPU": "cpu.path.dash-cubic.expected-unsupported",
        "WebGPU": "webgpu.path.dash-cubic.expected-unsupported",
    }
...
def validate_report() -> None:
    require_text(
        ...
        [
            ...
            "GPU score `DashCubicsGM-gpu=92.69; DashCubicsGM-raster=91.07`",
            "CPU score\n`89.86897880539499`",
            "cpu-raster mirror `89.86897880539499`",
            "kanvas-skia\nmirror `89.86897880539499`",
            "no\nstandalone WebGPU historical DashCubics test",
...
def main() -> None:
    ...
    print(f"validated {TICKET} DashCubicsGM evidence gate")
