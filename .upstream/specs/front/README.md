...
| F3 | PM demo/report workflow is repeatable through the dashboard and focused headless validators. | `03-demo-reporting-workflow.md` |
...
| F5 | Dashboard and focused evidence can be archived independently. | `03-demo-reporting-workflow.md` |
...
Changes that alter release gate behavior or focused evidence should also run:
