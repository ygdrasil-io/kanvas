...
| [KFONT-M12-004 - Add glyph artifact and cache metrics](KFONT-M12-004-add-glyph-artifact-and-cache-metrics.md) | `review` | `P1` | `tracked-gap` | `telemetry` | `KFONT-M12-001`, `KFONT-M9-006`, `KFONT-M10-010` | `dftext` |
