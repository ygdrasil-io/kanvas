...
- [x] Grapheme, bidi, and script runs preserve cluster boundaries.
- [x] Cluster safety regressions cover target shaping and emoji prerequisites.
...
| [KFONT-M5-005 - Add cluster safety regression suite](KFONT-M5-005-add-cluster-safety-regression-suite.md) | `done` | `P0` | `fixture-gated` | `unicode` | `KFONT-M5-002`, `KFONT-M5-003`, `KFONT-M5-004` | `scaledemoji` |
