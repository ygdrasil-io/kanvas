...
| [KFONT-M7-003 - Add variable-axis-aware fallback](KFONT-M7-003-add-variable-axis-aware-fallback.md) | `review` | `P1` | `tracked-gap` | `fallback` | `KFONT-M7-001`, `KFONT-M7-002`, `KFONT-M3-003`, `KFONT-M4-005` | - |
| [KFONT-M7-004 - Add cluster-safe fallback segmentation tests](KFONT-M7-004-add-cluster-safe-fallback-segmentation-tests.md) | `review` | `P0` | `fixture-gated` | `fallback` | `KFONT-M5-005`, `KFONT-M7-002`, `KFONT-M6-001` | `scaledemoji` |
