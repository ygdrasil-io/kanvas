...
|---|---|---|---|---|---|---|
| [KFONT-M2-001 - Normalize SFNT/TTC parser entry points](KFONT-M2-001-normalize-sfnt-ttc-parser-entry-points.md) | `done` | `P0` | `tracked-gap` | `font-sfnt` | `KFONT-M1-001`, `KFONT-M1-004` | - |
