...
- `KFONT-M8-005` now remains the active M8 closeout gate because explicit word/grapheme boundary query evidence and paragraph-owned bidi visual ordering evidence are still missing.
