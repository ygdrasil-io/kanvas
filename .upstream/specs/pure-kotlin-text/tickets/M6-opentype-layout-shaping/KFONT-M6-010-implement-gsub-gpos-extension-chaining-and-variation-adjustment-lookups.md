...
- `blocked` (2026-06-23): This ticket remains blocked because the full named advanced-lookup fixture family is still incomplete. Remaining missing fixtures are `gsub-chaining-context.otf`, `gsub-reverse-chaining.otf`, `gpos-contextual-positioning.otf`, `gpos-chaining-positioning.otf`, `gpos-extension-positioning.otf`, and `gpos-variation-device.otf`, and the required `variation-adjustment-trace.json` evidence is still absent. Keep the ticket `blocked` until those remaining fixture gates and trace families land without substituting unrelated robustness fonts for the named family.
