...
| [KFONT-M6-006 - Add script-specific default feature policy](KFONT-M6-006-add-script-specific-default-feature-policy.md) | `done` | `P0` | `tracked-gap` | `shaping` | `KFONT-M6-001`, `KFONT-M5-004` | - |
| [KFONT-M6-007 - Add Arabic shaping fixtures](KFONT-M6-007-add-arabic-shaping-fixtures.md) | `done` | `P0` | `fixture-gated` | `shaping` | `KFONT-M5-003`, `KFONT-M6-003`, `KFONT-M6-005`, `KFONT-M6-006` | - |
| [KFONT-M6-008 - Add Devanagari shaping fixtures](KFONT-M6-008-add-devanagari-shaping-fixtures.md) | `done` | `P0` | `fixture-gated` | `shaping` | `KFONT-M5-002`, `KFONT-M5-004`, `KFONT-M6-003`, `KFONT-M6-005`, `KFONT-M6-006` | - |
| [KFONT-M6-009 - Add Thai and CJK shaping boundaries](KFONT-M6-009-add-thai-and-cjk-shaping-boundaries.md) | `done` | `P1` | `fixture-gated` | `shaping` | `KFONT-M5-004`, `KFONT-M6-004`, `KFONT-M6-005`, `KFONT-M6-006` | - |
| [KFONT-M6-010 - Implement GSUB/GPOS extension, chaining and variation-adjustment lookups](KFONT-M6-010-implement-gsub-gpos-extension-chaining-and-variation-adjustment-lookups.md) | `done` | `P1` | `tracked-gap` | `shaping` | `KFONT-M6-003`, `KFONT-M6-004`, `KFONT-M6-005`, `KFONT-M4-005` | - |
...
- `KFONT-M6-010` now also vendors `FallbackPlus-Small.otf` from `simoncozens/test-fonts` under checked-in Apache-2.0 provenance as a bounded shaping source asset, but the exact advanced-lookup fixture family and `variation-adjustment-trace.json` gate remain open.
- 2026-06-23 resource-seed wave: the named Arabic, Devanagari, Thai/CJK, and advanced-lookup fixture resources are now checked in under reviewed provenance (`arabic-ticket-local-fixture-wave`, `devanagari-ticket-local-fixture-wave`, `thai-cjk-ticket-local-fixture-wave`, `advanced-lookup-ticket-local-fixture-wave`), but this wave is coordination evidence only and does not promote runtime, trace, or refusal-diagnostic closeout.
...
- 2026-06-23 resource-seed follow-up: `KFONT-M6-009` remains `blocked`, but it is now blocked on runtime/ticket-local dump refresh and paragraph/refusal diagnostics rather than on absent named Thai/CJK fixture files alone.
- 2026-06-23 resource-seed follow-up: `KFONT-M6-010` remains `blocked` after landing the remaining named advanced-lookup seed resources because live chaining/reverse-chaining/runtime GPOS assertions and a non-stub `variation-adjustment-trace.json` are still missing.
...
- 2026-06-23 compatible source intake: `FallbackPlus-Small.otf` is now checked in with Apache-2.0 provenance for future `KFONT-M6-010` fixture derivation, but this source intake does not by itself clear any of the named advanced-lookup fixture or trace gates.
