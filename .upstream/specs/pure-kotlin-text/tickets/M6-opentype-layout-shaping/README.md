...
| [KFONT-M6-008 - Add Devanagari shaping fixtures](KFONT-M6-008-add-devanagari-shaping-fixtures.md) | `review` | `P0` | `fixture-gated` | `shaping` | `KFONT-M5-002`, `KFONT-M5-004`, `KFONT-M6-003`, `KFONT-M6-005`, `KFONT-M6-006` | - |
...
- 2026-06-18 audit: `KFONT-M6-007` still awaits its own Arabic fixture-family evidence wave; `KFONT-M6-008` still needs syllable-plan evidence, the full required feature set, Devanagari-specific refusal fixtures/codes, and ticket-local trace dump families; `KFONT-M6-009` and `KFONT-M6-010` remain gated by their own named fixture families, required-script rows, or advanced lookup dependencies.
