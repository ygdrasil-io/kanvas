...
| [KGPU-M11-005 - Add destination-read copy and intermediate live materialization](KGPU-M11-005-add-destination-read-copy-and-intermediate-live-materialization.md) | `proposed` | `P1` | `TargetNative` | `GPUNative` | `false` | `true` | `destination-read` | `KGPU-M5-002`, `KGPU-M11-003`, `KGPU-M11-004` | `blend legacy` |
| [KGPU-M11-006 - Add saveLayer isolated target live materialization](KGPU-M11-006-add-savelayer-isolated-target-live-materialization.md) | `proposed` | `P1` | `TargetNative` | `GPUNative` | `false` | `true` | `layers-resources` | `KGPU-M5-001`, `KGPU-M11-003` | `saveLayer legacy` |
| [KGPU-M11-007 - Add bounded stencil-cover adapter-backed lane](KGPU-M11-007-add-bounded-stencil-cover-adapter-backed-lane.md) | `proposed` | `P1` | `TargetNative` | `GPUNative` | `false` | `true` | `geometry-passes` | `KGPU-M3-002`, `KGPU-M11-001`, `KGPU-M11-003` | `path fill legacy` |
| [KGPU-M11-008 - Add registered runtime-effect execution lane](KGPU-M11-008-add-registered-runtime-effect-execution-lane.md) | `proposed` | `P1` | `DependencyGated` | `GPUNative` | `false` | `true` | `runtime-effects` | `KGPU-M7-001`, `KGPU-M11-001`, `KGPU-M11-002` | `runtime-effect legacy` |
| [KGPU-M11-009 - Add paint dictionary and blend-plan execution boundary](KGPU-M11-009-add-paint-dictionary-and-blend-plan-execution-boundary.md) | `proposed` | `P1` | `ImplementationCandidate` | `GPUNative` | `false` | `true` | `paint-blend` | `KGPU-M7-003`, `KGPU-M11-002`, `KGPU-M11-005` | `blend legacy` |
