...
|---|---|---|---|---|---|---|---|---|---|
| [KGPU-M40-001 - Tile-deferred rendering](KGPU-M40-001-tile-deferred-rendering.md) | `proposed` | `P0` | `TargetNative` | `GPUNative` | `false` | `true` | `passes` | `KGPU-M1-001` | `legacy draw passes` |
| [KGPU-M40-002 - Multi-threaded recording](KGPU-M40-002-multithreaded-recording.md) | `proposed` | `P1` | `TargetNative` | `GPUNative` | `false` | `true` | `recording` | `KGPU-M1-001`, `KGPU-M40-001` | `legacy recording` |
| [KGPU-M40-003 - Hi-Z occlusion culling](KGPU-M40-003-hi-z-occlusion-culling.md) | `proposed` | `P1` | `TargetNative` | `GPUNative` | `false` | `true` | `analysis` | `KGPU-M1-001`, `KGPU-M40-001` | `legacy occlusion` |
