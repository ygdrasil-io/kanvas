...
- [`GFX-LIGHTING-BACKEND`](../GRAPHITE-ALGORITHM-REFERENCES.md#gfx-lighting-backend) — Study Graphite lighting filter normal estimation and Phong shading in fragment shader.
