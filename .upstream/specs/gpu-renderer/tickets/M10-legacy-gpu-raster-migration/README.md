...
|---|---|---|---|---|---|---|---|---|---|
| [KGPU-M10-001 - Inventory legacy `gpu-raster` route ownership](KGPU-M10-001-inventory-legacy-gpu-raster-route-ownership.md) | `proposed` | `P0` | `ImplementationCandidate` | `mixed` | `false` | `false` | `legacy-adapter` | `KGPU-M1-001` | `gpu-raster legacy` |
| [KGPU-M10-002 - Add per-family shadow parity migration gates](KGPU-M10-002-add-per-family-shadow-parity-migration-gates.md) | `proposed` | `P0` | `PolicyGated` | `mixed` | `false` | `true` | `migration-validation` | `KGPU-M10-001` | `gpu-raster legacy` |
| [KGPU-M10-003 - Retire legacy routes after promoted replacements](KGPU-M10-003-retire-legacy-routes-after-promoted-replacements.md) | `proposed` | `P1` | `PolicyGated` | `mixed` | `false` | `true` | `legacy-cleanup` | `KGPU-M10-002` | `gpu-raster legacy` |
| [KGPU-M10-004 - Add archived evidence hygiene for migrated routes](KGPU-M10-004-add-archived-evidence-hygiene-for-migrated-routes.md) | `proposed` | `P1` | `RefuseRequired` | `mixed` | `false` | `false` | `docs-evidence` | `KGPU-M10-001` | `archives` |
