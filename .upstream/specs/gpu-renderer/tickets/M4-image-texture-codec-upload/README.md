...
| [KGPU-M4-003 - Add codec provenance and dependency-gated refusals](KGPU-M4-003-add-codec-provenance-and-dependency-gated-refusals.md) | `proposed` | `P1` | `DependencyGated` | `RefuseDiagnostic` | `false` | `false` | `images-codecs` | `KGPU-M4-002` | `codec legacy` |
