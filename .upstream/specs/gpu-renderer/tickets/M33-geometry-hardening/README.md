...
| [KGPU-M33-003 - Perspective transform acceptance](KGPU-M33-003-perspective-transform-acceptance.md) | `review` | `P1` | `TargetNative` | `GPUNative` | `false` | `true` | `coordinates` | `KGPU-M1-001` | `legacy drawRect` |
