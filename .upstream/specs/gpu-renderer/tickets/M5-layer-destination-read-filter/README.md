...
| [KGPU-M5-002 - Add destination-read copy and intermediate strategy](KGPU-M5-002-add-destination-read-copy-and-intermediate-strategy.md) | `review` | `P0` | `TargetNative` | `GPUNative` | `false` | `true` | `destination-read` | `KGPU-M5-001` | `blend legacy` |
...
- KGPU-M5-002 is in `review` with contract-gate evidence for dumpable
  ...
  material-key exclusion, and stable refusals. It remains non-promoted pending
  independent review acceptance before any `done` transition or support claim.
  Evidence report:
