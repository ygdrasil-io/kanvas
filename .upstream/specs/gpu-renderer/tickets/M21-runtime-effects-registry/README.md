...
|---|---|---|---|---|---|---|---|---|---|
| [KGPU-M21-001 - Register SimpleRT: Kotlin CPU oracle + parser-validated WGSL + reflected uniforms](KGPU-M21-001-simple-rt-registration.md) | `proposed` | `P0` | `TargetNative` | `GPUNative` | `false` | `true` | `runtime-effects` | [KGPU-M12-010] | null |
