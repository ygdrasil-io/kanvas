...
|---|---|---|---|---|---|---|---|---|---|---|
| [KGPU-M31-001 - Default renderer activation — Kanvas as production path](KGPU-M31-001-production-activation.md) | `done` | `P0` | `ImplementationCandidate` | `GPUNative` | `true` | `true` | `product-validation` | [KGPU-M30-004] | null |
...
| [KGPU-M31-003 - Final PM evidence bundle — production-readiness sign-off](KGPU-M31-003-pm-evidence-bundle.md) | `done` | `P0` | `ImplementationCandidate` | `CPUReferenceOnly` | `false` | `true` | `product-validation` | [KGPU-M31-001] | null |
...
| [KGPU-M31-005 - SkCanvas-bridge ↔ legacy gpu-raster pixel/GM parity](KGPU-M31-005-bridge-pixel-parity.md) | `done` | `P0` | `ImplementationCandidate` | `CPUReferenceOnly` | `false` | `true` | `product-validation` | [KGPU-M30-003, KGPU-M31-003, KGPU-M31-006] | `gpu-raster-legacy-path` |
