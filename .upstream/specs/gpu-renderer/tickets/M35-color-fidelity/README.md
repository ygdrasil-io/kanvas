...
|---|---|---|---|---|---|---|---|---|---|
| [KGPU-M35-001 - HDR transfer functions (PQ, HLG, scRGB)](KGPU-M35-001-hdr-transfer-functions.md) | `ready` | `P0` | `TargetNative` | `GPUNative` | `false` | `true` | `color` | `KGPU-M1-001` | `legacy color transform` |
| [KGPU-M35-002 - Wide-gamut working spaces](KGPU-M35-002-wide-gamut-working-spaces.md) | `ready` | `P0` | `TargetNative` | `GPUNative` | `false` | `true` | `color` | `KGPU-M1-001` | `legacy color transform` |
...
| [KGPU-M35-004 - ICC profile parsing](KGPU-M35-004-icc-profile-parsing.md) | `ready` | `P1` | `TargetNative` | `GPUNative` | `false` | `true` | `color` | `KGPU-M1-001` | `legacy color transform` |
