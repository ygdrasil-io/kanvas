...
- `PipelineKey` axes must represent layout, shader code, resource topology or
  usage facts, or pipeline state, not concrete resource identity, residency, or
  arbitrary uniform values.
