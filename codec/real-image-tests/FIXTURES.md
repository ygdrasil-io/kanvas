...
| `codec-real-images/webp/stoplight.webp` | Skia upstream | Upstream Skia `resources/images/stoplight.webp` | Skia license | Copied into codec corpus unchanged | Animated WebP metadata and frame coverage |
