...
MVP readiness: approximately 98%.
...
| MVP release candidate | M35: final smoke, inventory, PM demo, limitations, and release notes | In Progress | 5% | 80% | Required CI, conformance, smoke, and full inventory gates are green; PM evidence package and closeout remain |
