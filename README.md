...
New target readiness is 67.75%, rounded for PM to approximately 70%, after the M73 Kadre replay-pack slice. This is intentionally lower
...
| PM/demo operability | 15% | 100% | PM bundle now includes M65 runtime smoke, M66 counters, M67 performance tiering, M68 Kadre bridge/demo evidence, M69 native Kadre present evidence, M70-A/B/C live-runtime/readback evidence, M71 autonomous frame-clock evidence, M72 single-scene replay evidence, and M73 replay-pack registry evidence. |
