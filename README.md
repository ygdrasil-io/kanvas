...
New target readiness starts at approximately 25%. This is intentionally lower
...
|---|---:|---:|---|
| Rendering feature breadth | 30% | 20% | Selected slices exist, but broad Path AA, filters, text, blend/color, and runtime-effect families remain incomplete. |
| Skia-like fidelity | 20% | 25% | Reference/CPU/GPU diffs exist for selected scenes; broad GM parity and diff burn-down remain ahead. |
...
| PM/demo operability | 15% | 35% | PM dashboard works; live demo packaging, hosted artifacts, and release-candidate workflow remain incomplete. |

Weighted PM readiness for the new target: **25%**.
...
| M62 | Text & Glyph Rendering V1 | Simple text renders through real font loading, glyph masks, and a WebGPU glyph atlas. |
