...
New target readiness is approximately 67% after the M72 Kadre single-scene replay slice. This is intentionally lower
...
| PM/demo operability | 15% | 100% | PM bundle now includes M65 runtime smoke, M66 counters, M67 performance tiering, M68 Kadre bridge/demo evidence, M69 native Kadre present evidence, M70-A/B/C live-runtime/readback evidence, M71 autonomous frame-clock evidence, and M72 single-scene replay evidence. |

Weighted PM readiness for the new target: **67%**.
