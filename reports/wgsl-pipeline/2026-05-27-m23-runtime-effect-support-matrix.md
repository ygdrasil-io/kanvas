...
Status counts: total=3; descriptor-backed=3; dispatch-only/missing-descriptor=0; CPU-only=0; GPU-backed=3.
...
| runtime.spiral_rt | -4648126568593740980 | kShader | rad_scale:kFloat, in_center:kFloat2, in_colors0:kFloat4, in_colors1:kFloat4 | - | 4 | supported:kotlin/spiral_rt | supported:wgsl/runtime_spiral_rt | descriptor-backed | none |
