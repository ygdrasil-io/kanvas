...
| native-callbacks.broadWebGpuCacheHitCallbacks | `unavailable` | frame.kadre-windowed | retired native-windowing surface; outside current runtime scope | .upstream/target/skia-like-realtime-renderer-target.md |
| native-callbacks.bindGroupCacheCallbacks | `unavailable` | frame.kadre-windowed | retired native-windowing surface; outside current runtime scope | .upstream/target/skia-like-realtime-renderer-target.md |
| native-callbacks.nativeResourceFreeCallbacks | `unavailable` | frame.kadre-windowed | retired native-windowing surface; outside current runtime scope | .upstream/target/skia-like-realtime-renderer-target.md |
| native-callbacks.adapterOwnedMemorySnapshots | `unavailable` | frame.kadre-windowed | retired native-windowing surface; outside current runtime scope | .upstream/target/skia-like-realtime-renderer-target.md |
