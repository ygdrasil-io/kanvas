...
- `gpu-renderer/src/main/kotlin/org/graphiks/kanvas/gpu/renderer/filters/GPUPreparedFilterDAGPlanner.kt` — node routes (`NativeRender`/`FoldedMaterial`/`Elided`), intermediate textures, execution order.
