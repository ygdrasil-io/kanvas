...
Remaining gate: per-script shaping fixture-family gates from `KFONT-M6-007`,
`KFONT-M6-008`, and `KFONT-M6-009` are still open. Keep this ticket in
...
Status: implemented and independently reviewed with bounded vendored-font evidence.
